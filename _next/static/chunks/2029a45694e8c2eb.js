(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 879339, e => {
    "use strict";
    class t extends Error {
        constructor(e, n = {}) {
            const r = n.cause instanceof t ? n.cause.details : n.cause ? .message ? n.cause.message : n.details,
                a = n.cause instanceof t && n.cause.docsPath || n.docsPath;
            super([e || "An error occurred.", "", ...n.metaMessages ? [...n.metaMessages, ""] : [], ...a ? [`Docs: https://abitype.dev${a}`] : [], ...r ? [`Details: ${r}`] : [], "Version: abitype@1.2.3"].join("\n")), Object.defineProperty(this, "details", {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: void 0
                ...
                writable: !0,
                value: "AbiTypeError"
            }), n.cause && (this.cause = n.cause), this.details = r, this.docsPath = a, this.metaMessages = n.metaMessages, this.shortMessage = e
        }
    }
    ...
    e.s(["InvalidAbiItemError", () => n, "UnknownSolidityTypeError", () => a, "UnknownTypeError", () => r])
}, 589513, e => {
    "use strict";
    var t = e.i(879339);
    class n extends t.BaseError {
    ...
    e.s(["InvalidAbiParameterError", () => n, "InvalidAbiParametersError", () => r, "InvalidAbiTypeParameterError", () => u, "InvalidFunctionModifierError", () => o, "InvalidModifierError", () => s, "InvalidParameterError", () => a, "SolidityProtectedKeywordError", () => i])
}, 459118, e => {
    "use strict";
    var t = e.i(879339);
    class n extends t.BaseError {
    ...
    e.s(["InvalidSignatureError", () => n, "InvalidStructSignatureError", () => a, "UnknownSignatureError", () => r])
}, 61460, e => {
    "use strict";
    var t = e.i(788035);
    ...
    let u = /^function (?<name>[a-zA-Z$_][a-zA-Z0-9$_]*)\((?<parameters>.*?)\)(?: (?<scope>external|public{1}))?(?: (?<stateMutability>pure|view|nonpayable|payable{1}))?(?: returns\s?\((?<returns>.*?)\))?$/;
    ...
    e.s(["eventModifiers", 0, T, "execConstructorSignature", () => m, "execErrorSignature", () => a, "execEventSignature", () => o, "execFallbackSignature", () => v, "execFunctionSignature", () => c, "execStructSignature", () => p, "functionModifiers", 0, I, "isConstructorSignature", () => y, "isErrorSignature", () => r, "isEventSignature", () => s, "isFallbackSignature", () => g, "isFunctionSignature", () => d, "isReceiveSignature", () => x, "isStructSignature", () => l, "modifiers", 0, E])
}, 902094, 88776, e => {
    "use strict";
    var t = e.i(788035),
        n = e.i(815373),
    ...
    function d(e, t = {}) {
        if ((0, s.isFunctionSignature)(e)) return function(e, t = {}) {
            let n = (0, s.execFunctionSignature)(e);
            if (!n) throw new a.InvalidSignatureError({
                signature: e,
                type: "function"
            });
            let r = b(n.parameters),
                i = [],
                o = r.length;
            for (let e = 0; e < o; e++) i.push(p(r[e], {
            ...
            if (n.returns) {
                let e = b(n.returns),
                    r = e.length;
                for (let n = 0; n < r; n++) u.push(p(e[n], {
                    modifiers: s.functionModifiers,
                    structs: t,
                    type: "function"
                }))
        ...
        if ((0, s.isEventSignature)(e)) return function(e, t = {}) {
        ...
        if ((0, s.isErrorSignature)(e)) return function(e, t = {}) {
        ...
        if ((0, s.isConstructorSignature)(e)) return function(e, t = {}) {
        ...
        if ((0, s.isFallbackSignature)(e)) {
            ...
            if (!t) throw new a.InvalidSignatureError({
                signature: n,
                type: "fallback"
            });
            return {
        ...
        if ((0, s.isReceiveSignature)(e)) return {
            type: "receive",
    ...
    let c = /^(?<type>[a-zA-Z$_][a-zA-Z0-9$_]*(?:\spayable)?)(?<array>(?:\[\d*?\])+?)?(?:\s(?<modifier>calldata|indexed|memory|storage{1}))?(?:\s(?<name>[a-zA-Z$_][a-zA-Z0-9$_]*))?$/,
        f = /^\((?<type>.+?)\)(?<array>(?:\[\d*?\])+?)?(?:\s(?<modifier>calldata|indexed|memory|storage{1}))?(?:\s(?<name>[a-zA-Z$_][a-zA-Z0-9$_]*))?$/,
        l = /^u?int$/;

    function p(e, a) {
        var i, o;
        let d, h = function(e, t, n) {
            let r = "";
            if (n)
        ...
        if (!v) throw new r.InvalidParameterError({
            param: e
        });
        if (v.name && ("address" === (i = v.name) || "bool" === i || "function" === i || "string" === i || "tuple" === i || t.bytesRegex.test(i) || t.integerRegex.test(i) || m.test(i))) throw new r.SolidityProtectedKeywordError({
            param: e,
            name: v.name
        });
        let w = v.name ? {
        ...
        } else if (v.type in E) d = "tuple", T = {
            components: E[v.type]
        };
        else if (l.test(v.type)) d = `${v.type}256`;
        else if ("address payable" === v.type) d = "address";
        else if (d = v.type, a ? .type !== "struct" && !y(d)) throw new n.UnknownSolidityTypeError({
            type: d
        });
        if (v.modifier) {
            if (!a ? .modifiers ? .has ? .(v.modifier)) throw new r.InvalidModifierError({
                param: e,
                type: a ? .type,
                modifier: v.modifier
            });
            if (s.functionModifiers.has(v.modifier) && (o = d, !v.array && "bytes" !== o && "string" !== o && "tuple" !== o)) throw new r.InvalidFunctionModifierError({
                param: e,
                type: a ? .type,
                modifier: v.modifier
            })
    ...
    function b(e, t = [], n = "", r = 0) {
        ...
        if ("" === n) return t;
        if (0 !== r) throw new o.InvalidParenthesisError({
            current: n,
            depth: r
        });
    ...
    function y(e) {
        return "address" === e || "bool" === e || "function" === e || "string" === e || t.bytesRegex.test(e) || t.integerRegex.test(e)
    }
    ...
    function h(e) {
        ...
        for (let t = 0; t < u; t++) {
            ...
            if (!u.length) throw new a.InvalidStructSignatureError({
                signature: n
            });
            o[r.name] = u
        }
            ...
            d[a] = function e(a = [], s = {}, o = new Set) {
                ...
                for (let c = 0; c < d; c++) {
                    ...
                    if (t.isTupleRegex.test(d.type)) u.push(d);
                        ...
                        if (!a ? .type) throw new r.InvalidAbiTypeParameterError({
                            abiParameter: d
                        });
                        let {
                            array: c,
                        ...
                        if (f in s) {
                            if (o.has(f)) throw new i.CircularReferenceError({
                                type: f
                            });
                            u.push({ ...d,
                                type: `tuple${c??""}`,
                        ...
                        else throw new n.UnknownTypeError({
                            type: f
                        })
                    }
                }
    ...
    e.s(["isSolidityType", () => y, "parseAbiParameter", () => p, "parseSignature", () => d, "splitParameters", () => b], 88776);
    ...
    e.s(["NegativeOffsetError", () => n, "PositionOutOfBoundsError", () => r, "RecursiveReadLimitExceededError", () => a], 493429);
    let i = {
        ...
        assertReadLimit() {
            if (this.recursiveReadCount >= this.recursiveReadLimit) throw new a({
    ...
    function s(e, {
        ...
        return n.bytes = e, n.dataView = new DataView(e.buffer ? ? e, e.byteOffset, e.byteLength), n.positionReadCount = new Map, n.recursiveReadLimit = t, n
    }
    ...
    function c(e, t) {
        let n = "string" == typeof t ? {
            ...
            r = n.to;
        return "number" === r ? p(e, n) : "bigint" === r ? f(e, n) : "boolean" === r ? l(e, n) : "string" === r ? b(e, n) : (0, d.bytesToHex)(e, n)
    }

    function f(e, t = {}) {
        void 0 !== t.size && (0, u.assertSize)(e, {
            size: t.size
        });
    ...
    function l(e, t = {}) {
        let n = e;
        if (void 0 !== t.size && ((0, u.assertSize)(n, {
                size: t.size
            }), n = (0, s.trim)(n)), n.length > 1 || n[0] > 1) throw new o.InvalidBytesBooleanError(n);
        return !!n[0]
    }
    ...
    function b(e, t = {}) {
        let n = e;
        return void 0 !== t.size && ((0, u.assertSize)(n, {
            size: t.size
        }), n = (0, s.trim)(n, {
            dir: "right"
        })), new TextDecoder().decode(n)
    }
    e.s(["bytesToBigInt", () => f, "bytesToBool", () => l, "bytesToNumber", () => p, "bytesToString", () => b, "fromBytes", () => c], 394125);
    var y = e.i(769936),
        m = e.i(704434);
    ...
    function h(e, o) {
        ...
        if (0 === (0, a.size)(u) && e.length > 0) throw new t.AbiDecodingZeroDataError;
        if ((0, a.size)(o) && 32 > (0, a.size)(o)) throw new t.AbiDecodingDataSizeTooSmallError({
        ...
        for (let r = 0; r < e.length; ++r) {
            ...
            let [o, u] = function e(r, a, {
                ...
                if ("tuple" === a.type) return function(t, n, {
                    staticPosition: r
                }) {
                    let a = 0 === n.components.length || n.components.some(({
                            name: e
                        }) => !e),
                        i = a ? [] : {},
                        s = 0;
                ...
                if ("address" === a.type) {
                    let e;
                    return e = r.readBytes(32), [(0, n.checksumAddress)((0, d.bytesToHex)((0, i.sliceBytes)(e, -20))), 32]
                }
                if ("bool" === a.type) return [l(r.readBytes(32), {
                    size: 32
                }), 32];
                if (a.type.startsWith("bytes")) return function(e, t, {
                    staticPosition: n
                }) {
                    ...
                    return [(0, d.bytesToHex)(e.readBytes(Number.parseInt(a, 10), 32)), 32]
                }(r, a, {
                    staticPosition: o
                });
                if (a.type.startsWith("uint") || a.type.startsWith("int")) {
                    var c, y;
                    let e, t, n;
                    return c = r, e = (y = a).type.startsWith("int"), t = Number.parseInt(y.type.split("int")[1] || "256", 10), n = c.readBytes(32), [t > 48 ? f(n, {
                        signed: e
                    }) : p(n, {
                        signed: e
                    }), 32]
                }
                if ("string" === a.type) return function(e, {
                    staticPosition: t
                }) {
    ...
    function o(e) {
        ...
        let c = [...o || [], t.solidityError, t.solidityPanic].find(e => "error" === e.type && d === (0, a.toFunctionSelector)((0, s.formatAbiItem)(e)));
        if (!c) throw new n.AbiErrorSignatureNotFoundError(d, {
            docsPath: "/docs/contract/decodeErrorResult"
        });
        return {
            abiItem: c,
            args: "inputs" in c && c.inputs && c.inputs.length > 0 ? (0, i.decodeAbiParameters)(c.inputs, (0, r.slice)(u, 4)) : void 0,
            errorName: c.name
        }
    }
    ...
    function d({
        ...
        if ("name" in e && "inputs" in e && e.inputs) return `${n?e.name:""}(${e.inputs.map((e,n)=>`${r&&e.name?`${e.name}: `:""}${"object"==typeof t[n]?(0,u.stringify)(t[n]):t[n]}`).join(", ")})`
    }
...
`), n.state && (r += "      state:\n", r += a(n.state)), n.stateDiff && (r += "      stateDiff:\n", r += a(n.stateDiff)), r
    ...
    e.s(["AccountStateConflictError", () => n, "StateAssignmentConflictError", () => r, "prettyStateOverride", () => i])
}, 393702, e => {
    "use strict";
    var t = e.i(285973),
        n = e.i(976486),
    ...
    class o extends r.BaseError {
        constructor({
            ...
            super("Cannot infer a transaction type from provided transaction.", {
                metaMessages: ["Provided Transaction:", "{", a(e), "}", "", "To infer the type, either provide:", "- a `type` to the Transaction, or", "- an EIP-1559 Transaction with `maxFeePerGas`, or", "- an EIP-2930 Transaction with `gasPrice` & `accessList`, or", "- an EIP-4844 Transaction with `blobs`, `blobVersionedHashes`, `sidecars`, or", "- an EIP-7702 Transaction with `authorizationList`, or", "- a Legacy Transaction with `gasPrice`"],
    ...
    class d extends r.BaseError {
        constructor({
            ...
            const r = Object.entries(e).map(([e, t]) => void 0 === t ? e : void 0).filter(Boolean);
            super(`Invalid serialized transaction of type "${n}" was provided.`, {
                metaMessages: [`Serialized Transaction: "${t}"`, r.length > 0 ? `Missing Attributes: ${r.join(", ")}` : ""].filter(Boolean),
                ...
                writable: !0,
                value: void 0
            }), this.serializedTransaction = t, this.type = n
        }
    }
    ...
    class f extends r.BaseError {
        constructor(e, {
            ...
            const y = a({
                ...
                from: r ? .address,
                to: p,
                value: void 0 !== b && `${(0,t.formatEther)(b)} ${s?.nativeCurrency?.symbol||"ETH"}`,
                data: o,
                gas: u,
    ...
    class l extends r.BaseError {
        constructor({
            ...
            let i = "Transaction";
            n && void 0 !== a && (i = `Transaction at block time "${n}" at index "${a}"`), e && void 0 !== a && (i = `Transaction at block hash "${e}" at index "${a}"`), t && void 0 !== a && (i = `Transaction at block number "${t}" at index "${a}"`), r && (i = `Transaction with hash "${r}"`), super(`${i} could not be found.`, {
    ...
    e.s(["FeeConflictError", () => i, "InvalidLegacyVError", () => s, "InvalidSerializableTransactionError", () => o, "InvalidSerializedTransactionError", () => d, "InvalidSerializedTransactionTypeError", () => u, "InvalidStorageKeySizeError", () => c, "TransactionExecutionError", () => f, "TransactionNotFoundError", () => l, "TransactionReceiptNotFoundError", () => p, "TransactionReceiptRevertedError", () => b, "WaitForTransactionReceiptTimeoutError", () => y, "prettyPrint", () => a])
}, 878023, e => {
    "use strict";
    var t = e.i(189991),
        n = e.i(727343),
    ...
    class b extends c.BaseError {
        constructor(e, {
            ...
            let v = (0, l.prettyPrint)({
                from: g ? .address,
                to: y,
                value: void 0 !== m && `${(0,o.formatEther)(m)} ${a?.nativeCurrency?.symbol||"ETH"}`,
                data: i,
                gas: s,
            ...
            h && (v += `
${(0,f.prettyStateOverride)(h)}`), super(e.shortMessage, {
                cause: e,
                docsPath: r,
    ...
    class y extends c.BaseError {
        constructor(e, {
            ...
            const c = (0, s.getAbiItem)({
                    abi: t,
                    args: n,
                    name: u
                }),
                f = c ? (0, i.formatAbiItemWithArgs)({
                    abiItem: c,
                    args: n,
                    includeFunctionName: !1,
                    includeName: !1
                }) : void 0,
                b = c ? (0, a.formatAbiItem)(c, {
                    includeName: !0
                }) : void 0,
                y = (0, l.prettyPrint)({
                    address: r && (0, p.getContractAddress)(r),
                    function: b,
                    args: f && "()" !== f && `${[...Array(u?.length??0).keys()].map(()=>" ").join("")}${f}`,
                    sender: d
                });
            super(e.shortMessage || `An unknown error occurred while executing the contract function "${u}".`, {
                cause: e,
                docsPath: o,
                metaMessages: [...e.metaMessages ? [...e.metaMessages, " "] : [], y && "Contract Call:", y].filter(Boolean),
                ...
                writable: !0,
                value: void 0
            }), this.abi = t, this.args = n, this.cause = e, this.contractAddress = r, this.functionName = u, this.sender = d
        }
    }
        ...
        constructor({
            ...
            if (t && "0x" !== t) try {
                ...
                if ("Error" === o) l = u[0];
                    ...
                    const e = s ? (0, a.formatAbiItem)(s, {
                            includeName: !0
                        }) : void 0,
                        t = s && u ? (0, i.formatAbiItemWithArgs)({
                            abiItem: s,
                            args: u,
                            includeFunctionName: !1,
                            includeName: !1
                        }) : void 0;
                    f = [e ? `Error: ${e}` : "", t && "()" !== t ? `       ${[...Array(o?.length??0).keys()].map(()=>" ").join("")}${t}` : ""]
                }
            } catch (e) {
                u = e
            } else o && (l = o);
            u instanceof d.AbiErrorSignatureNotFoundError && (p = u.signature, f = [`Unable to decode signature "${p}" as it was not found on the provided ABI.`, "Make sure you are using the correct ABI and that the error exists on it.", `You can look up the decoded signature here: https://4byte.sourcify.dev/?q=${p}.`]), super(l && "execution reverted" !== l || p ? [`The contract function "${s}" reverted with the following ${p?"signature":"reason"}:`, l || p].join("\n") : `The contract function "${s}" reverted.`, {
                cause: u,
                metaMessages: f,
                ...
                writable: !0,
                value: void 0
            }), this.data = c, this.raw = t, this.reason = l, this.signature = p
        }
    }
    ...
    e.s(["CallExecutionError", () => b, "ContractFunctionExecutionError", () => y, "ContractFunctionRevertedError", () => m, "ContractFunctionZeroDataError", () => h, "CounterfactualDeploymentFailedError", () => g, "RawContractError", () => v])
}, 467078, e => {
    "use strict";
    var t = e.i(569934),
        n = e.i(853532);
    ...
    function r(e, r) {
        let a = (e.details || "").toLowerCase(),
            i = e instanceof t.BaseError ? e.walk(e => e ? .code === n.ExecutionRevertedError.code) : e;
        return i instanceof t.BaseError ? new n.ExecutionRevertedError({
            cause: e,
            message: i.details
        }) : n.ExecutionRevertedError.nodeMessage.test(a) ? new n.ExecutionRevertedError({
            cause: e,
            message: e.details
        }) : n.FeeCapTooHighError.nodeMessage.test(a) ? new n.FeeCapTooHighError({
            cause: e,
            maxFeePerGas: r ? .maxFeePerGas
        }) : n.FeeCapTooLowError.nodeMessage.test(a) ? new n.FeeCapTooLowError({
            cause: e,
            maxFeePerGas: r ? .maxFeePerGas
        }) : n.NonceTooHighError.nodeMessage.test(a) ? new n.NonceTooHighError({
            cause: e,
            nonce: r ? .nonce
        }) : n.NonceTooLowError.nodeMessage.test(a) ? new n.NonceTooLowError({
            cause: e,
            nonce: r ? .nonce
        }) : n.NonceMaxValueError.nodeMessage.test(a) ? new n.NonceMaxValueError({
            cause: e,
            nonce: r ? .nonce
        }) : n.InsufficientFundsError.nodeMessage.test(a) ? new n.InsufficientFundsError({
            cause: e
        }) : n.IntrinsicGasTooHighError.nodeMessage.test(a) ? new n.IntrinsicGasTooHighError({
            cause: e,
            gas: r ? .gas
        }) : n.IntrinsicGasTooLowError.nodeMessage.test(a) ? new n.IntrinsicGasTooLowError({
            cause: e,
            gas: r ? .gas
        }) : n.TransactionTypeNotSupportedError.nodeMessage.test(a) ? new n.TransactionTypeNotSupportedError({
            cause: e
        }) : n.TipAboveFeeCapError.nodeMessage.test(a) ? new n.TipAboveFeeCapError({
            cause: e,
            maxFeePerGas: r ? .maxFeePerGas,
            maxPriorityFeePerGas: r ? .maxPriorityFeePerGas
        }) : new n.UnknownNodeError({
            cause: e
        })
    }
    e.s(["getNodeError", () => r])
    ...
    function t(e, {
        ...
        let n = {};
        return ! function t(r) {
            for (let a of Object.keys(r)) a in e && (n[a] = e[a]), r[a] && "object" == typeof r[a] && !Array.isArray(r[a]) && t(r[a])
        }(t(e || {})), n
    }
    e.s(["extract", () => t])
}, 445024, e => {
    ...
    function a(e, n) {
        let a = {};
        return void 0 !== e.authorizationList && (a.authorizationList = e.authorizationList.map(e => ({
            address: e.address,
        ...
        }))), void 0 !== e.accessList && (a.accessList = e.accessList), void 0 !== e.blobVersionedHashes && (a.blobVersionedHashes = e.blobVersionedHashes), void 0 !== e.blobs && ("string" != typeof e.blobs[0] ? a.blobs = e.blobs.map(e => (0, t.bytesToHex)(e)) : a.blobs = e.blobs), void 0 !== e.data && (a.data = e.data), e.account && (a.from = e.account.address), void 0 !== e.from && (a.from = e.from), void 0 !== e.gas && (a.gas = (0, t.numberToHex)(e.gas)), void 0 !== e.gasPrice && (a.gasPrice = (0, t.numberToHex)(e.gasPrice)), void 0 !== e.maxFeePerBlobGas && (a.maxFeePerBlobGas = (0, t.numberToHex)(e.maxFeePerBlobGas)), void 0 !== e.maxFeePerGas && (a.maxFeePerGas = (0, t.numberToHex)(e.maxFeePerGas)), void 0 !== e.maxPriorityFeePerGas && (a.maxPriorityFeePerGas = (0, t.numberToHex)(e.maxPriorityFeePerGas)), void 0 !== e.nonce && (a.nonce = (0, t.numberToHex)(e.nonce)), void 0 !== e.to && (a.to = e.to), void 0 !== e.type && (a.type = r[e.type]), void 0 !== e.value && (a.value = (0, t.numberToHex)(e.value)), a
    }
    let i = (0, n.defineFormatter)("transactionRequest", a);
    e.s(["defineTransactionRequest", 0, i, "formatTransactionRequest", () => a, "rpcTransactionType", 0, r])
}, 826051, e => {
    "use strict";
    var t = e.i(608861),
        n = e.i(587286),
    ...
    function s(e) {
        if (e && 0 !== e.length) return e.reduce((e, {
            ...
            if (66 !== t.length) throw new n.InvalidBytesLengthError({
                size: t.length,
                targetSize: 66,
                type: "hex"
            });
            if (66 !== r.length) throw new n.InvalidBytesLengthError({
                size: r.length,
                targetSize: 66,
                type: "hex"
            });
    ...
    function o(e) {
        ...
        for (let {
            ...
            if (n[o]) throw new r.AccountStateConflictError({
                address: o
            });
            n[o] = function(e) {
                let {
                ...
                if (void 0 !== u && (d.code = u), void 0 !== t && (d.balance = (0, i.numberToHex)(t)), void 0 !== n && (d.nonce = (0, i.numberToHex)(n)), void 0 !== a && (d.state = s(a)), void 0 !== o) {
    ...
    "use strict";
    e.s(["maxInt104", 0, 2 n ** (104 n - 1 n) - 1 n, "maxInt112", 0, 2 n ** (112 n - 1 n) - 1 n, "maxInt120", 0, 2 n ** (120 n - 1 n) - 1 n, "maxInt128", 0, 2 n ** (128 n - 1 n) - 1 n, "maxInt136", 0, 2 n ** (136 n - 1 n) - 1 n, "maxInt144", 0, 2 n ** (144 n - 1 n) - 1 n, "maxInt152", 0, 2 n ** (152 n - 1 n) - 1 n, "maxInt16", 0, 2 n ** (16 n - 1 n) - 1 n, "maxInt160", 0, 2 n ** (160 n - 1 n) - 1 n, "maxInt168", 0, 2 n ** (168 n - 1 n) - 1 n, "maxInt176", 0, 2 n ** (176 n - 1 n) - 1 n, "maxInt184", 0, 2 n ** (184 n - 1 n) - 1 n, "maxInt192", 0, 2 n ** (192 n - 1 n) - 1 n, "maxInt200", 0, 2 n ** (200 n - 1 n) - 1 n, "maxInt208", 0, 2 n ** (208 n - 1 n) - 1 n, "maxInt216", 0, 2 n ** (216 n - 1 n) - 1 n, "maxInt224", 0, 2 n ** (224 n - 1 n) - 1 n, "maxInt232", 0, 2 n ** (232 n - 1 n) - 1 n, "maxInt24", 0, 2 n ** (24 n - 1 n) - 1 n, "maxInt240", 0, 2 n ** (240 n - 1 n) - 1 n, "maxInt248", 0, 2 n ** (248 n - 1 n) - 1 n, "maxInt256", 0, 2 n ** (256 n - 1 n) - 1 n, "maxInt32", 0, 2 n ** (32 n - 1 n) - 1 n, "maxInt40", 0, 2 n ** (40 n - 1 n) - 1 n, "maxInt48", 0, 2 n ** (48 n - 1 n) - 1 n, "maxInt56", 0, 2 n ** (56 n - 1 n) - 1 n, "maxInt64", 0, 2 n ** (64 n - 1 n) - 1 n, "maxInt72", 0, 2 n ** (72 n - 1 n) - 1 n, "maxInt8", 0, 2 n ** (8 n - 1 n) - 1 n, "maxInt80", 0, 2 n ** (80 n - 1 n) - 1 n, "maxInt88", 0, 2 n ** (88 n - 1 n) - 1 n, "maxInt96", 0, 2 n ** (96 n - 1 n) - 1 n, "maxUint104", 0, 2 n ** 104 n - 1 n, "maxUint112", 0, 2 n ** 112 n - 1 n, "maxUint120", 0, 2 n ** 120 n - 1 n, "maxUint128", 0, 2 n ** 128 n - 1 n, "maxUint136", 0, 2 n ** 136 n - 1 n, "maxUint144", 0, 2 n ** 144 n - 1 n, "maxUint152", 0, 2 n ** 152 n - 1 n, "maxUint16", 0, 2 n ** 16 n - 1 n, "maxUint160", 0, 2 n ** 160 n - 1 n, "maxUint168", 0, 2 n ** 168 n - 1 n, "maxUint176", 0, 2 n ** 176 n - 1 n, "maxUint184", 0, 2 n ** 184 n - 1 n, "maxUint192", 0, 2 n ** 192 n - 1 n, "maxUint200", 0, 2 n ** 200 n - 1 n, "maxUint208", 0, 2 n ** 208 n - 1 n, "maxUint216", 0, 2 n ** 216 n - 1 n, "maxUint224", 0, 2 n ** 224 n - 1 n, "maxUint232", 0, 2 n ** 232 n - 1 n, "maxUint24", 0, 2 n ** 24 n - 1 n, "maxUint240", 0, 2 n ** 240 n - 1 n, "maxUint248", 0, 2 n ** 248 n - 1 n, "maxUint256", 0, 2 n ** 256 n - 1 n, "maxUint32", 0, 2 n ** 32 n - 1 n, "maxUint40", 0, 2 n ** 40 n - 1 n, "maxUint48", 0, 2 n ** 48 n - 1 n, "maxUint56", 0, 2 n ** 56 n - 1 n, "maxUint64", 0, 2 n ** 64 n - 1 n, "maxUint72", 0, 2 n ** 72 n - 1 n, "maxUint8", 0, 2 n ** 8 n - 1 n, "maxUint80", 0, 2 n ** 80 n - 1 n, "maxUint88", 0, 2 n ** 88 n - 1 n, "maxUint96", 0, 2 n ** 96 n - 1 n, "minInt104", 0, -(2 n ** (104 n - 1 n)), "minInt112", 0, -(2 n ** (112 n - 1 n)), "minInt120", 0, -(2 n ** (120 n - 1 n)), "minInt128", 0, -(2 n ** (128 n - 1 n)), "minInt136", 0, -(2 n ** (136 n - 1 n)), "minInt144", 0, -(2 n ** (144 n - 1 n)), "minInt152", 0, -(2 n ** (152 n - 1 n)), "minInt16", 0, -(2 n ** (16 n - 1 n)), "minInt160", 0, -(2 n ** (160 n - 1 n)), "minInt168", 0, -(2 n ** (168 n - 1 n)), "minInt176", 0, -(2 n ** (176 n - 1 n)), "minInt184", 0, -(2 n ** (184 n - 1 n)), "minInt192", 0, -(2 n ** (192 n - 1 n)), "minInt200", 0, -(2 n ** (200 n - 1 n)), "minInt208", 0, -(2 n ** (208 n - 1 n)), "minInt216", 0, -(2 n ** (216 n - 1 n)), "minInt224", 0, -(2 n ** (224 n - 1 n)), "minInt232", 0, -(2 n ** (232 n - 1 n)), "minInt24", 0, -(2 n ** (24 n - 1 n)), "minInt240", 0, -(2 n ** (240 n - 1 n)), "minInt248", 0, -(2 n ** (248 n - 1 n)), "minInt256", 0, -(2 n ** (256 n - 1 n)), "minInt32", 0, -(2 n ** (32 n - 1 n)), "minInt40", 0, -(2 n ** (40 n - 1 n)), "minInt48", 0, -(2 n ** (48 n - 1 n)), "minInt56", 0, -(2 n ** (56 n - 1 n)), "minInt64", 0, -(2 n ** (64 n - 1 n)), "minInt72", 0, -(2 n ** (72 n - 1 n)), "minInt8", 0, -(2 n ** (8 n - 1 n)), "minInt80", 0, -(2 n ** (80 n - 1 n)), "minInt88", 0, -(2 n ** (88 n - 1 n)), "minInt96", 0, -(2 n ** (96 n - 1 n))])
}, 353464, e => {
    "use strict";
    var t = e.i(189991),
        n = e.i(674768),
    ...
    function s(e) {
        let {
            ...
            to: d
        } = e, c = s ? (0, t.parseAccount)(s) : void 0;
        if (c && !(0, i.isAddress)(c.address)) throw new r.InvalidAddressError({
            address: c.address
        });
        if (d && !(0, i.isAddress)(d)) throw new r.InvalidAddressError({
            address: d
        });
        if (o && o > n.maxUint256) throw new a.FeeCapTooHighError({
            maxFeePerGas: o
        });
        if (u && o && u > o) throw new a.TipAboveFeeCapError({
            maxFeePerGas: o,
            maxPriorityFeePerGas: u
        })
    }
    ...
    function i(e) {
        ...
        if (o) {
            let e = (0, r.getAbiItem)({
                abi: i,
                args: s,
                name: o
            });
            if (!e) throw new t.AbiFunctionNotFoundError(o, {
                docsPath: a
            });
            d = e
        }
        if ("function" !== d.type) throw new t.AbiFunctionNotFoundError(void 0, {
            docsPath: a
        });
        if (!d.outputs) throw new t.AbiFunctionOutputsNotFoundError(d.name, {
            docsPath: a
        });
    ...
    class t extends Error {
        ...
        constructor(e, n = {}) {
            const r = (() => {
                    ...
                    return n.cause && "details" in n.cause && "string" == typeof n.cause.details ? n.cause.details : n.cause ? .message ? n.cause.message : n.details
                })(),
                a = n.cause instanceof t && n.cause.docsPath || n.docsPath,
            ...
            super([e || "An error occurred.", ...n.metaMessages ? ["", ...n.metaMessages] : [], ...r || a || o ? ["", r ? `Details: ${r}` : void 0, a ? `See: ${s}` : void 0, o ? `Version: ${u}` : void 0] : []].filter(e => "string" == typeof e).join("\n"), n.cause ? {
                cause: n.cause
                ...
                writable: !0,
                value: "BaseError"
            }), this.cause = n.cause, this.details = r, this.docs = s, this.docsOrigin = i, this.docsPath = a, this.shortMessage = e, this.showVersion = o, this.version = u
        }
        walk(e) {
    ...
    }), t.setStaticOptions(t.defaultStaticOptions), e.s(["BaseError", () => t], 602376), e.s(["assertEndOffset", () => i, "assertSize", () => r, "assertStartOffset", () => a, "charCodeToBase16", () => s, "pad", () => o, "trim", () => u], 931312);
    var n = e.i(759384);

    function r(e, t) {
        if (n.size(e) > t) throw new n.SizeOverflowError({
            givenSize: n.size(e),
            maxSize: t
        })
    }
    ...
    function a(e, t) {
        if ("number" == typeof t && t > 0 && t > n.size(e) - 1) throw new n.SliceOffsetOutOfBoundsError({
            offset: t,
            position: "start",
            size: n.size(e)
        })
    ...
    function i(e, t, r) {
        if ("number" == typeof t && "number" == typeof r && n.size(e) !== r - t) throw new n.SliceOffsetOutOfBoundsError({
            offset: r,
            position: "end",
            size: n.size(e)
        })
    ...
    function o(e, t = {}) {
        ...
        if (0 === a) return e;
        if (e.length > a) throw new n.SizeExceedsPaddingSizeError({
            size: e.length,
            targetSize: a,
            type: "Bytes"
        });
    ...
    e.s(["assertEndOffset", () => l, "assertSize", () => c, "assertStartOffset", () => f, "pad", () => p, "trim", () => b], 992239);
    var d = e.i(284251);

    function c(e, t) {
        if (d.size(e) > t) throw new d.SizeOverflowError({
            givenSize: d.size(e),
            maxSize: t
        })
    }
    ...
    function f(e, t) {
        if ("number" == typeof t && t > 0 && t > d.size(e) - 1) throw new d.SliceOffsetOutOfBoundsError({
            offset: t,
            position: "start",
            size: d.size(e)
        })
    ...
    function l(e, t, n) {
        if ("number" == typeof t && "number" == typeof n && d.size(e) !== n - t) throw new d.SliceOffsetOutOfBoundsError({
            offset: n,
            position: "end",
            size: d.size(e)
        })
    ...
    function p(e, t = {}) {
        ...
        if (0 === r) return e;
        let a = e.replace("0x", "");
        if (a.length > 2 * r) throw new d.SizeExceedsPaddingSizeError({
    ...
    function b(e, t = {}) {
        let {
            dir: n = "left"
        } = t, r = e.replace("0x", ""), a = 0;
        for (let e = 0; e < r.length - 1; e++)
            if ("0" === r["left" === n ? e : r.length - e - 1].toString()) a++;
            else break;
        return "0" === (r = "left" === n ? r.slice(a) : r.slice(0, r.length - a)) ? "0x" : "right" === n && r.length % 2 == 1 ? `0x${r}0` : `0x${r}`
    }
    ...
    "use strict";
    e.s(["SizeExceedsPaddingSizeError", () => $, "SizeOverflowError", () => I, "SliceOffsetOutOfBoundsError", () => P, "concat", () => u, "from", () => d, "fromHex", () => c, "fromString", () => f, "random", () => l, "size", () => p, "slice", () => b, "toBigInt", () => y, "toBoolean", () => m, "toNumber", () => h, "toString", () => g, "trimLeft", () => v, "trimRight", () => w, "validate", () => x]);
    var t = e.i(602376),
        n = e.i(284251),
        r = e.i(931312),
        a = e.i(992239),
    ...
    function d(e) {
        var t;
        return e instanceof Uint8Array ? e : "string" == typeof e ? c(e) : (t = e) instanceof Uint8Array ? t : new Uint8Array(t)
    }
    ...
    function c(e, i = {}) {
        ...
        for (let e = 0, n = 0; e < d; e++) {
            ...
            if (void 0 === a || void 0 === i) throw new t.BaseError(`Invalid byte sequence ("${u[n-2]}${u[n-1]}" in "${u}").`);
            f[e] = a << 4 | i
        }
        return f
    }
    ...
    function f(e, t = {}) {
        ...
        return "number" == typeof i ? (r.assertSize(s, i), n = s, a = i, r.pad(n, {
            dir: "right",
            size: a
        })) : s
    }
    ...
    function m(e, t = {}) {
        ...
        if (void 0 !== n && (r.assertSize(a, n), a = v(a)), a.length > 1 || a[0] > 1) throw new E(a);
        return !!a[0]
    }
    ...
    function x(e) {
        try {
            if (!(e instanceof Uint8Array) && (!e || "object" != typeof e || !("BYTES_PER_ELEMENT" in e) || 1 !== e.BYTES_PER_ELEMENT || "Uint8Array" !== e.constructor.name)) throw new T(e);
            return !0
        } catch {
            return !1
        }
    ...
    class T extends t.BaseError {
        constructor(e) {
            super(`Value \`${"object"==typeof e?i.stringify(e):e}\` of type \`${typeof e}\` is an invalid Bytes value.`, {
    ...
    "use strict";
    e.s(["IntegerOutOfRangeError", () => I, "InvalidLengthError", () => S, "SizeExceedsPaddingSizeError", () => M, "SizeOverflowError", () => A, "SliceOffsetOutOfBoundsError", () => B, "concat", () => u, "from", () => d, "fromBoolean", () => c, "fromBytes", () => f, "fromNumber", () => l, "fromString", () => p, "padLeft", () => b, "padRight", () => y, "random", () => m, "size", () => g, "slice", () => h, "toBigInt", () => w, "toNumber", () => x, "toString", () => E, "trimLeft", () => v, "validate", () => T]);
    var t = e.i(759384),
        n = e.i(602376),
        r = e.i(931312),
        a = e.i(992239),
    ...
    function c(e, t = {}) {
        let n = `0x${Number(e)}`;
        return "number" == typeof t.size ? (a.assertSize(n, t.size), b(n, t.size)) : n
    }
    ...
    function f(e, t = {}) {
        ...
        let r = `0x${n}`;
        return "number" == typeof t.size ? (a.assertSize(r, t.size), y(r, t.size)) : r
    }
    ...
    function l(e, t = {}) {
        let n, {
            ...
            i = BigInt(e);
        a ? n = r ? (1 n << 8 n * BigInt(a) - 1 n) - 1 n : 2 n ** (8 n * BigInt(a)) - 1 n : "number" == typeof e && (n = BigInt(Number.MAX_SAFE_INTEGER));
        let s = "bigint" == typeof n && r ? -n - 1 n : 0;
        if (n && i > n || i < s) {
    ...
    function w(e, t = {}) {
        ...
        let r = BigInt(e);
        if (!n) return r;
        let i = (1 n << 8 n * BigInt((e.length - 2) / 2)) - 1 n;
        return r <= i >> 1 n ? r : r - i - 1 n
    }
    ...
    function E(e, n = {}) {
        ...
        return a && (r.assertSize(i, a), i = t.trimRight(i)), new TextDecoder().decode(i)
    }
    ...
    function T(e, t = {}) {
        ...
        try {
            return ! function(e, t = {}) {
                ...
                if (n && !/^0x[0-9a-fA-F]*$/.test(e) || !e.startsWith("0x")) throw new $(e)
            }(e, {
                strict: n
            }), !0
        } catch {
    ...
    class I extends n.BaseError {
        constructor({
            ...
            super(`Number \`${a}\` is not in safe${r?` ${8*r}-bit`:""}${n?" signed":" unsigned"} integer range ${e?`(\`${t}\` to \`${e}\`)`:`(above \`${t}\`)`}`), Object.defineProperty(this, "name", {
                enumerable: !0,
                configurable: !0,
                writable: !0,
    ...
    class P extends n.BaseError {
        constructor(e) {
            super(`Value \`${"object"==typeof e?i.stringify(e):e}\` of type \`${typeof e}\` is an invalid hex type.`, {
    ...
    function r(e) {
        return { ..."bigint" == typeof e.baseFeePerGas && {
            ...
            ..."bigint" == typeof e.number && {
                number: t.fromNumber(e.number)
            },
            ..."bigint" == typeof e.prevRandao && {
                prevRandao: t.fromNumber(e.prevRandao)
            },
            ..."bigint" == typeof e.time && {
                time: t.fromNumber(e.time)
            },
            ...e.withdrawals && {
                withdrawals: e.withdrawals.map(n)
            }
        }
    }
    e.s(["toRpc", () => r], 944318)
    ...
    e.s(["addressResolverAbi", 0, [{
    ...
    }], "batchGatewayAbi", 0, n, "erc1155Abi", 0, [{
        inputs: [{
        ...
        stateMutability: "nonpayable",
        type: "function"
    }], "erc6492SignatureValidatorAbi", 0, [{
        inputs: [{
            name: "_signer",
            type: "address"
        }, {
        ...
        outputs: []
    }], "multicall3Abi", 0, t, "textResolverAbi", 0, [{
        name: "text",
        type: "function",
        stateMutability: "view",
        inputs: [{
    ...
    e.s(["ChainDoesNotSupportContract", () => n, "ChainMismatchError", () => r, "ChainNotFoundError", () => a, "ClientChainNotConfiguredError", () => i, "InvalidChainIdError", () => s])
}, 289169, e => {
    "use strict";
    var t = e.i(70204),
        n = e.i(147526),
    ...
    function i(e) {
        ...
        if (!u) throw new t.AbiConstructorNotFoundError({
            docsPath: a
        });
        if (!("inputs" in u) || !u.inputs || 0 === u.inputs.length) throw new t.AbiConstructorParamsNotFoundError({
            docsPath: a
        });
    ...
    function n({
        ...
        let a = n ? .contracts ? .[r];
        if (!a) throw new t.ChainDoesNotSupportContract({
            chain: n,
            contract: {
                name: r
            }
        });
        if (e && a.blockCreated && a.blockCreated > e) throw new t.ChainDoesNotSupportContract({
            blockNumber: e,
            chain: n,
            contract: {
                name: r,
    ...
    function a(e, {
        ...
        let s, o = (s = (0, r.getNodeError)(e, i)) instanceof n.UnknownNodeError ? e : s;
        return new t.CallExecutionError(o, {
            docsPath: a,
            ...i
        })
    }
    ...
    async function x(a, c) {
        let {
            ...
            stateOverride: D,
            ...H
        } = c, L = l ? (0, r.parseAccount)(l) : void 0;
        if (A && (M || O)) throw new o.BaseError("Cannot provide both `code` & `factory`/`factoryData` as parameters.");
        if (A && j) throw new o.BaseError("Cannot provide both `code` & `to` as parameters.");
        let G = A && B,
            _ = M && O && j && B,
            V = G || _,
            Z = G ? T({
                ...
                return (0, f.encodeDeployData)({
                    abi: (0, t.parseAbi)(["constructor(address, bytes, address, bytes)"]),
        ...
        try {
            ...
            let t = ("bigint" == typeof x ? (0, b.numberToHex)(x) : void 0) || I,
                ...
                d = (o || h.formatTransactionRequest)({ ...(0, m.extract)(H, {
                        format: o
                    }),
                    accessList: P,
                    account: L,
            ...
            if (g && function({
                    ...
                    return !(!t || t.startsWith(i.aggregate3Signature)) && !!n && !(Object.values(r).filter(e => void 0 !== e).length > 0)
                }({
                    request: d
                }) && !s && !r) try {
                return await E(a, { ...d,
                ...
                if (!(e instanceof u.ClientChainNotConfiguredError) && !(e instanceof u.ChainDoesNotSupportContract)) throw e
            }
            let f = (e = [d, t], s && r ? [...e, s, r] : s ? [...e, s] : r ? [...e, {}, r] : e),
                l = await a.request({
                    method: "eth_call",
                    params: f
                });
            ...
            if (!1 !== a.ccipRead && t ? .slice(0, 10) === r && j) return {
                data: await n(a, {
                    data: t,
                    to: j
                })
            };
            if (V && t ? .slice(0, 10) === "0x101bb98d") throw new d.CounterfactualDeploymentFailedError({
                factory: M
            });
            throw (0, y.getCallError)(i, { ...c,
                account: L,
                chain: a.chain
            })
        }
    ...
    async function E(e, t) {
        let {
            ...
            if (e.chain) return (0, p.getChainContractAddress)({
                blockNumber: o,
                chain: e.chain,
                contract: "multicall3"
            });
        ...
        if (!E) throw new d.RawContractError({
            data: x
        });
        return "0x" === x ? {
            data: void 0
