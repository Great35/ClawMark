(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 939426, 594734, 713764, 547160, 875740, e => {
    "use strict";
    var t = e.i(363625),
        a = e.i(975948),
        r = e.i(189991),
    ...
    class d extends p.BaseError {
        constructor({
            ...
            const r = a ? .replace("execution reverted: ", "") ? .replace("execution reverted", "");
    ...
    class F extends p.BaseError {
        constructor({
            ...
            super("Smart Account has already been deployed.", {
                cause: e,
                metaMessages: ["Remove the following properties and try again:", t && "`factory`", a && "`factoryData`", r && "`initCode`"].filter(Boolean),
    ...
    class J extends W.BaseError {
        constructor(e, {
            ...
            super(e.shortMessage, {
                cause: e,
                docsPath: r,
                metaMessages: [...e.metaMessages ? [...e.metaMessages, " "] : [], "Request Arguments:", w].filter(Boolean),
    ...
    class Q extends W.BaseError {
        constructor({
            ...
            super(`User Operation receipt with hash "${e}" could not be found. The User Operation may not have been processed yet.`, {
    ...
    class Y extends W.BaseError {
        constructor({
            ...
            super(`Timed out while waiting for User Operation with hash "${e}" to be confirmed.`, {
    ...
    function et(e, {
        ...
        return new J((() => {
            let a = function(e, t) {
                ...
                if (m.message.test(a)) return new m({
                    cause: e
                });
                if (y.message.test(a)) return new y({
                    cause: e
                });
                if (l.message.test(a)) return new l({
                    cause: e
                });
                if (f.message.test(a)) return new f({
                    cause: e
                });
                if (g.message.test(a)) return new g({
                    cause: e,
                    factory: t.factory,
                    factoryData: t.factoryData,
                    initCode: t.initCode
                });
                if (b.message.test(a)) return new b({
                    cause: e,
                    factory: t.factory,
                    factoryData: t.factoryData,
                    initCode: t.initCode
                });
                if (v.message.test(a)) return new v({
                    cause: e,
                    factory: t.factory,
                    factoryData: t.factoryData,
                    initCode: t.initCode,
                ...
                if (w.message.test(a)) return new w({
                    cause: e
                });
                if (x.message.test(a)) return new x({
                    cause: e
                });
                if (P.message.test(a)) return new P({
                    cause: e,
                    nonce: t.nonce
                });
                if (h.message.test(a)) return new h({
                    cause: e
                });
                if (G.message.test(a)) return new G({
                    cause: e
                });
                if (E.message.test(a)) return new E({
                    cause: e
                });
                if (D.message.test(a)) return new D({
                    cause: e
                });
                if (A.message.test(a)) return new A({
                    cause: e
                });
                if (B.message.test(a)) return new B({
                    cause: e
                });
                if (C.message.test(a)) return new C({
                    cause: e
                });
                if (T.message.test(a)) return new T({
                    cause: e
                });
                if (F.message.test(a)) return new F({
                    cause: e,
                ...
                if (k.message.test(a)) return new k({
                    cause: e
                });
                if (j.message.test(a)) return new j({
                    cause: e
                });
                if (M.message.test(a)) return new M({
                    cause: e
                ...
                if (q.message.test(a)) return new q({
                    cause: e
                });
                if (_.message.test(a)) return new _({
                    cause: e
                });
                let r = e.walk(e => ee.some(t => t.code === e.code));
                if (r) {
                    if (r.code === d.code) return new d({
                        cause: e,
                        data: r.data,
                        message: r.details
                    });
                    if (r.code === O.code) return new O({
                        cause: e
                    });
                    if (r.code === D.code) return new D({
                        cause: e
                    });
                    if (r.code === L.code) return new L({
                        cause: e
                    });
                    if (r.code === U.code) return new U({
                        cause: e
                    });
                    if (r.code === S.code) return new S({
                        cause: e
                    });
                    if (r.code === I.code) return new I({
                        cause: e
                    });
                    if (r.code === N.code) return new N({
                        cause: e
                    });
                    if (r.code === H.code) return new H({
                        cause: e
                    });
                    if (r.code === z.code) return new z({
                        cause: e
                    });
                    if (r.code === R.code) return new R({
                        cause: e
                    })
                }
                return new $({
            ...
            if (t && a instanceof d) {
                let e, r = (a.walk(t => {
                        if ("string" == typeof t.data || "string" == typeof t.data ? .revertData || !(t instanceof o.BaseError) && "string" == typeof t.message) {
                            let a = (t.data ? .revertData || t.data || t.message).match ? .(/(0x[A-Za-z0-9]*)/);
                            if (a) return e = a[1], !0
                        }
                        return !1
                    }), e),
                    n = t ? .filter(e => e.abi);
                if (r && n.length > 0) return function(e) {
                    let {
                        calls: t,
                        revertData: a
                    } = e, {
                        ...
                        return 1 === r.length ? r[0] : {
                            abi: [],
                            functionName: e.reduce((e, t) => `${e?`${e} | `:""}${t.functionName}`, ""),
                            args: void 0,
                            to: void 0
                        }
                    })(), o = "0x" === a ? new c.ContractFunctionZeroDataError({
                        functionName: n
    ...
    function en(e) {
        var t;
        let a = {};
        return void 0 !== e.callData && (a.callData = e.callData), void 0 !== e.callGasLimit && (a.callGasLimit = (0, ea.numberToHex)(e.callGasLimit)), void 0 !== e.factory && (a.factory = e.factory), void 0 !== e.factoryData && (a.factoryData = e.factoryData), void 0 !== e.initCode && (a.initCode = e.initCode), void 0 !== e.maxFeePerGas && (a.maxFeePerGas = (0, ea.numberToHex)(e.maxFeePerGas)), void 0 !== e.maxPriorityFeePerGas && (a.maxPriorityFeePerGas = (0, ea.numberToHex)(e.maxPriorityFeePerGas)), void 0 !== e.nonce && (a.nonce = (0, ea.numberToHex)(e.nonce)), void 0 !== e.paymaster && (a.paymaster = e.paymaster), void 0 !== e.paymasterAndData && (a.paymasterAndData = e.paymasterAndData || "0x"), void 0 !== e.paymasterData && (a.paymasterData = e.paymasterData), void 0 !== e.paymasterPostOpGasLimit && (a.paymasterPostOpGasLimit = (0, ea.numberToHex)(e.paymasterPostOpGasLimit)), void 0 !== e.paymasterSignature && (a.paymasterSignature = e.paymasterSignature), void 0 !== e.paymasterVerificationGasLimit && (a.paymasterVerificationGasLimit = (0, ea.numberToHex)(e.paymasterVerificationGasLimit)), void 0 !== e.preVerificationGas && (a.preVerificationGas = (0, ea.numberToHex)(e.preVerificationGas)), void 0 !== e.sender && (a.sender = e.sender), void 0 !== e.signature && (a.signature = e.signature), void 0 !== e.verificationGasLimit && (a.verificationGasLimit = (0, ea.numberToHex)(e.verificationGasLimit)), void 0 !== e.authorization && (a.eip7702Auth = {
            address: (t = e.authorization).address,
            chainId: (0, ea.numberToHex)(t.chainId),
            nonce: (0, ea.numberToHex)(t.nonce),
            r: t.r ? (0, ea.numberToHex)(BigInt(t.r), {
                size: 32
            }) : (0, er.pad)("0x", {
                size: 32
            }),
            s: t.s ? (0, ea.numberToHex)(BigInt(t.s), {
                size: 32
            }) : (0, er.pad)("0x", {
                size: 32
            }),
            yParity: t.yParity ? (0, ea.numberToHex)(t.yParity, {
                size: 1
            }) : (0, er.pad)("0x", {
                size: 32
            })
    ...
    async function ep(e, t) {
        let {
            ...
            }, r, (0, ea.numberToHex)(a), n]
        });
        return { ...u,
            ...o && {
                paymasterPostOpGasLimit: (0, eu.hexToBigInt)(o)
            },
            ...c && {
                paymasterVerificationGasLimit: (0, eu.hexToBigInt)(c)
            }
        }
    }
    ...
    let ed = ["factory", "fees", "gas", "paymaster", "nonce", "signature", "authorization"];
    async function ey(e, t) {
        let s, {
            account: o = e.account,
            dataSuffix: c = "string" == typeof e.dataSuffix ? e.dataSuffix : e.dataSuffix ? .value,
            parameters: u = ed,
            stateOverride: p
        } = t;
        ...
        let m = (0, r.parseAccount)(o),
            ...
            {
                getPaymasterStubData: l,
                getPaymasterData: f
            } = (() => {
                if (!0 === d) return {
                    getPaymasterStubData: t => (0, i.getAction)(e, em, "getPaymasterStubData")(t),
                    getPaymasterData: t => (0, i.getAction)(e, ep, "getPaymasterData")(t)
                };
                if ("object" == typeof d) {
                    let {
                        getPaymasterStubData: e,
                        getPaymasterData: t
                    } = d;
                    return {
            ...
            [v, w, x, h, P] = await Promise.all([(async () => t.calls ? m.encodeCalls(t.calls.map(e => e.abi ? {
                data: (0, eo.encodeFunctionData)(e),
                to: e.to,
                value: e.value
            } : e)) : t.callData)(), (async () => {
                if (!u.includes("factory")) return;
                if (t.initCode) return {
                    initCode: t.initCode
                };
                if (t.factory && t.factoryData) return {
                    factory: t.factory,
                    factoryData: t.factoryData
                };
                let {
                ...
                if (u.includes("fees")) {
                    if ("bigint" == typeof t.maxFeePerGas && "bigint" == typeof t.maxPriorityFeePerGas) return b;
                    ...
                    try {
                        let a = e.client ? ? e,
                            r = await (0, i.getAction)(a, es.estimateFeesPerGas, "estimateFeesPerGas")({
                                chain: a.chain,
                                type: "eip1559"
                            });
                        return {
                            maxFeePerGas: "bigint" == typeof t.maxFeePerGas ? t.maxFeePerGas : BigInt(2 n * r.maxFeePerGas),
                            maxPriorityFeePerGas: "bigint" == typeof t.maxPriorityFeePerGas ? t.maxPriorityFeePerGas : BigInt(2 n * r.maxPriorityFeePerGas)
                        }
                    } catch {
                        return
                    }
                ...
                if (u.includes("nonce")) return "bigint" == typeof t.nonce ? t.nonce : m.getNonce()
            })(), (async () => {
                if (u.includes("authorization")) {
                    if ("object" == typeof t.authorization) return t.authorization;
                    if (m.authorization && !await m.isDeployed()) return { ...await (0, ei.prepareAuthorization)(m.client, m.authorization),
        ...
        async function G() {
            return s || (e.chain ? e.chain.id : s = await (0, i.getAction)(e, a.getChainId, "getChainId")({}))
        }
        void 0 !== v && (b.callData = c ? (0, ec.concat)([v, c]) : v), void 0 !== w && (b = { ...b,
            ...w
        }), void 0 !== x && (b = { ...b,
            ...x
        }), void 0 !== h && (b.nonce = h), void 0 !== P && (b.authorization = P), u.includes("signature") && (void 0 !== t.signature ? b.signature = t.signature : b.signature = await m.getStubSignature(b)), "0.6" !== m.entryPoint.version || b.initCode || (b.initCode = "0x");
        let O = !1;
        ...
        if ("0.6" !== m.entryPoint.version || b.paymasterAndData || (b.paymasterAndData = "0x"), u.includes("gas")) {
            ...
            if (void 0 === b.callGasLimit || void 0 === b.preVerificationGas || void 0 === b.verificationGasLimit || b.paymaster && void 0 === b.paymasterPostOpGasLimit || b.paymaster && void 0 === b.paymasterVerificationGasLimit) {
                let t = await (0, i.getAction)(e, el, "estimateUserOperationGas")({
                    account: m,
                    callGasLimit: 0 n,
                    preVerificationGas: 0 n,
                    verificationGasLimit: 0 n,
                    stateOverride: p,
                    ...b.paymaster ? {
                        paymasterPostOpGasLimit: 0 n,
                        paymasterVerificationGasLimit: 0 n
                    } : {},
                    ...b
                });
                b = { ...b,
                    ...
                    verificationGasLimit: b.verificationGasLimit ? ? t.verificationGasLimit,
                    paymasterPostOpGasLimit: b.paymasterPostOpGasLimit ? ? t.paymasterPostOpGasLimit,
                    paymasterVerificationGasLimit: b.paymasterVerificationGasLimit ? ? t.paymasterVerificationGasLimit
                }
            }
        }
        ...
        return delete b.calls, delete b.parameters, delete b.paymasterContext, "string" != typeof b.paymaster && delete b.paymaster, b
    }
    async function el(e, t) {
        ...
        let u = a ? (0, r.parseAccount)(a) : void 0,
            ...
            m = u ? await (0, i.getAction)(e, ey, "prepareUserOperation")({ ...t,
                parameters: ["authorization", "factory", "nonce", "paymaster", "signature"]
            }) : t;
        try {
            var d;
            let t, a = [en(m), o ? ? u ? .entryPoint ? .address];
    ...
    async function ef(e, {
        ...
        return {
            ...
            transactionHash: o,
            userOperation: (a = { ...c
            }, c.callGasLimit && (a.callGasLimit = BigInt(c.callGasLimit)), c.maxFeePerGas && (a.maxFeePerGas = BigInt(c.maxFeePerGas)), c.maxPriorityFeePerGas && (a.maxPriorityFeePerGas = BigInt(c.maxPriorityFeePerGas)), c.nonce && (a.nonce = BigInt(c.nonce)), c.paymasterPostOpGasLimit && (a.paymasterPostOpGasLimit = BigInt(c.paymasterPostOpGasLimit)), c.paymasterVerificationGasLimit && (a.paymasterVerificationGasLimit = BigInt(c.paymasterVerificationGasLimit)), c.preVerificationGas && (a.preVerificationGas = BigInt(c.preVerificationGas)), c.verificationGasLimit && (a.verificationGasLimit = BigInt(c.verificationGasLimit)), a)
        }
    }
    var eg = e.i(856324),
        eb = e.i(839080);
    async function ev(e, {
        ...
        return a = { ...r
        }, r.actualGasCost && (a.actualGasCost = BigInt(r.actualGasCost)), r.actualGasUsed && (a.actualGasUsed = BigInt(r.actualGasUsed)), r.logs && (a.logs = r.logs.map(e => (0, eg.formatLog)(e))), r.receipt && (a.receipt = (0, eb.formatTransactionReceipt)(a.receipt)), a
    }
    ...
    function eG(e) {
        return {
            ...
            getSupportedEntryPoints: () => e.request({
            ...
            waitForUserOperationReceipt: t => (function(e, t) {
                let {
                    hash: a,
                    pollingInterval: r = e.pollingInterval,
                    retryCount: n,
                    timeout: s = 12e4
                } = t, o = 0, c = (0, eP.stringify)(["waitForUserOperationReceipt", e.uid, a]);
                return new Promise((t, u) => {
                    let p = (0, ex.observe)(c, {
                        resolve: t,
                        reject: u
                    }, t => {
                        let c = e => {
                            ...
                            u = s ? setTimeout(() => c(() => t.reject(new Y({
                                hash: a
                            }))), s) : void 0,
                            m = (0, eh.poll)(async () => {
                                n && o >= n && (clearTimeout(u), c(() => t.reject(new Y({
                                    hash: a
                                }))));
                                try {
                                    let r = await (0, i.getAction)(e, ev, "getUserOperationReceipt")({
                                        hash: a
                                    });
                                    clearTimeout(u), c(() => t.resolve(r))
                                } catch (e) {
                                    "UserOperationReceiptNotFoundError" !== e.name && (clearTimeout(u), c(() => t.reject(e)))
                                }
                                o++
                            }, {
                                emitOnBegin: !0,
    ...
    function eO(e) {
        ...
        return Object.assign((0, t.createClient)({ ...e,
    ...
    e.s(["entryPoint06Abi", 0, eE], 594734), e.s(["entryPoint06Address", 0, "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789"], 713764);
    var eD = e.i(704434),
        eA = e.i(831095),
        eB = e.i(995062);
    ...
    function eL(e, t = {}) {
        ...
        return a && ("0x7702" === n || "0x7702000000000000000000000000000000000000" === n) ? r ? (0, ec.concat)([r.address, i ? ? "0x"]) : "0x7702000000000000000000000000000000000000" : n ? (0, ec.concat)([n, i ? ? "0x"]) : "0x"
    }
    var eU = e.i(401319);
    ...
    function eF(e, t = {}) {
        ...
        } = e, l = (0, ec.concat)([(0, er.pad)((0, ea.numberToHex)(y || 0 n), {
            size: 16
        }), (0, er.pad)((0, ea.numberToHex)(a || 0 n), {
            size: 16
        })]), f = eL(e, t), g = (0, ec.concat)([(0, er.pad)((0, ea.numberToHex)(n || 0 n), {
            size: 16
        }), (0, er.pad)((0, ea.numberToHex)(i || 0 n), {
            size: 16
        })]), b = e.nonce ? ? 0 n;
        return {
            accountGasLimits: l,
            ...
            gasFees: g,
            nonce: b,
            paymasterAndData: s ? (0, ec.concat)([s, (0, er.pad)((0, ea.numberToHex)(p || 0 n), {
                size: 16
            }), (0, er.pad)((0, ea.numberToHex)(c || 0 n), {
                size: 16
            }), o || "0x", ...u ? t.forHash ? [eC] : [u, (0, er.pad)((0, ea.numberToHex)((0, eU.size)(u)), {
                size: 2
            }), eC] : []]) : "0x",
            preVerificationGas: e.preVerificationGas ? ? 0 n,
            sender: m,
            signature: d
        }
    }
    ...
    function eT(e) {
        ...
        if ("0.8" === r || "0.9" === r) return (0, eB.hashTypedData)(function(e) {
            let {
                chainId: t,
                entryPointAddress: a,
                userOperation: r
        ...
        let f = (() => {
            if ("0.6" === r) {
                ...
                return (0, eD.encodeAbiParameters)([{
                    ...
                    type: "bytes32"
                }], [y, p, (0, eA.keccak256)(e), (0, eA.keccak256)(s), o, l, d, c, u, (0, eA.keccak256)(m)])
            }
            if ("0.7" === r) {
                let e = eF(n, {
                    forHash: !0
                ...
                return (0, eD.encodeAbiParameters)([{
                    ...
                    type: "bytes32"
                }], [e.sender, e.nonce, (0, eA.keccak256)(e.initCode), (0, eA.keccak256)(e.callData), e.accountGasLimits, e.preVerificationGas, e.gasFees, (0, eA.keccak256)(e.paymasterAndData)])
            }
            throw Error(`entryPointVersion "${r}" not supported.`)
        })();
        return (0, eA.keccak256)((0, eD.encodeAbiParameters)([{
            type: "bytes32"
        }, {
            type: "address"
        }, {
    ...
    async function eH(e) {
        ...
        return { ...t,
            ...
            async getNonce(t) {
                let r = t ? .key ? ? BigInt(await a.consume({
                    address: s,
                    chainId: e.client.chain.id,
                    client: e.client
                }));
                return e.getNonce ? await e.getNonce({ ...t,
                    key: r
                }) : await (0, ej.readContract)(e.client, {
                    abi: (0, eI.parseAbi)(["function getNonce(address, uint192) pure returns (uint256)"]),
                    address: e.entryPoint.address,
                    functionName: "getNonce",
                    args: [s, r]
                })
            },
            isDeployed: async () => !!n || (n = !!await (0, i.getAction)(e.client, ek.getCode, "getCode")({
                address: s
            })),
            ...e.sign ? {
                async sign(t) {
                    let [{
                        factory: a,
                        factoryData: r
                    }, n] = await Promise.all([this.getFactoryArgs(), e.sign(t)]);
                    return a && r ? (0, eM.serializeErc6492Signature)({
                        address: a,
                        data: r,
                        signature: n
                    }) : n
            ...
            async signMessage(t) {
                let [{
                    factory: a,
                    factoryData: r
                }, n] = await Promise.all([this.getFactoryArgs(), e.signMessage(t)]);
                return a && r && "0x7702" !== a ? (0, eM.serializeErc6492Signature)({
                    address: a,
                    data: r,
                    signature: n
                }) : n
            ...
            async signTypedData(t) {
                let [{
                    factory: a,
                    factoryData: r
                }, n] = await Promise.all([this.getFactoryArgs(), e.signTypedData(t)]);
                return a && r && "0x7702" !== a ? (0, eM.serializeErc6492Signature)({
                    address: a,
                    data: r,
                    signature: n
