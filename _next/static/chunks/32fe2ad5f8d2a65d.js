(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 322066, e => {
    "use strict";
    let t = /"(?:_|\\u0{2}5[Ff]){2}(?:p|\\u0{2}70)(?:r|\\u0{2}72)(?:o|\\u0{2}6[Ff])(?:t|\\u0{2}74)(?:o|\\u0{2}6[Ff])(?:_|\\u0{2}5[Ff]){2}"\s*:/,
        r = /"(?:c|\\u0063)(?:o|\\u006[Ff])(?:n|\\u006[Ee])(?:s|\\u0073)(?:t|\\u0074)(?:r|\\u0072)(?:u|\\u0075)(?:c|\\u0063)(?:t|\\u0074)(?:o|\\u006[Ff])(?:r|\\u0072)"\s*:/,
    ...
    function o(e, s = {}) {
        ...
        let a = e.trim();
        if (a.length <= 9) switch (a.toLowerCase()) {
            case "true":
                return !0;
            case "false":
                return !1;
    ...
    function f(e) {
        return e ? h(e) : "u" < typeof document && "u" > typeof navigator && "ReactNative" === navigator.product ? new a : "u" > typeof navigator ? h(navigator.userAgent) : void 0 !== t.default && t.default.version ? new i(t.default.version.slice(1)) : null
    }
    ...
    function h(e) {
        ...
        f ? f.length < 3 && (f = r(r([], f, !0), function(e) {
    ...
    function g(e, t, r) {
        ...
        function a(e, t) {
            try {
                var r;
                (r = i[e](t)).value instanceof y ? Promise.resolve(r.value.v).then(c, l) : u(o[0][2], r)
            } catch (e) {
                u(o[0][3], e)
            }
        }
        ...
        function n(r) {
            t[r] = e[r] && function(t) {
                return new Promise(function(n, i) {
                    var o, s, a;
                    o = n, s = i, a = (t = e[r](t)).done, Promise.resolve(t.value).then(function(e) {
                        o({
                            value: e,
                            done: a
                        })
    ...
    e.s(["__assign", () => n, "__asyncDelegator", () => m, "__asyncGenerator", () => g, "__asyncValues", () => w, "__await", () => y, "__awaiter", () => c, "__classPrivateFieldGet", () => _, "__classPrivateFieldSet", () => O, "__createBinding", () => u, "__decorate", () => o, "__exportStar", () => f, "__extends", () => r, "__generator", () => l, "__importDefault", () => x, "__importStar", () => E, "__makeTemplateObject", () => v, "__metadata", () => a, "__param", () => s, "__read", () => d, "__rest", () => i, "__spread", () => p, "__spreadArrays", () => b, "__values", () => h])
}, 417459, (e, t, r) => {
    "use strict";
    ...
    let n = e.r(787267);
    n.__exportStar(e.r(497525), r), n.__exportStar(e.r(345382), r), n.__exportStar(e.r(663134), r), n.__exportStar(e.r(881927), r)
}, 36610, (e, t, r) => {
    "use strict";
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.getLocalStorage = r.getLocalStorageOrThrow = r.getCrypto = r.getCryptoOrThrow = r.getLocation = r.getLocationOrThrow = r.getNavigator = r.getNavigatorOrThrow = r.getDocument = r.getDocumentOrThrow = r.getFromWindowOrThrow = r.getFromWindow = void 0, r.getFromWindow = n, r.getFromWindowOrThrow = i, r.getDocumentOrThrow = function() {
        return i("document")
    ...
    class d extends f {
        constructor(e, t, r, n) {
            super(), this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = n, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = l(this.buffer)
        }
        update(e) {
            a(this);
            let {
    ...
    let p = BigInt(0x100000000 - 1),
        ...
        I = (e, t, r, n, i, o) => t + r + n + i + o + (e / 0x100000000 | 0) | 0,
        T = (e, t, r, n, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0),
        [B, P] = function(e, t = !1) {
    ...
    class U extends d {
        ...
        set(e, t, r, n, i, o, s, a, c, l, u, f, h, d, p, b) {
            this.Ah = 0 | e, this.Al = 0 | t, this.Bh = 0 | r, this.Bl = 0 | n, this.Ch = 0 | i, this.Cl = 0 | o, this.Dh = 0 | s, this.Dl = 0 | a, this.Eh = 0 | c, this.El = 0 | l, this.Fh = 0 | u, this.Fl = 0 | f, this.Gh = 0 | h, this.Gl = 0 | d, this.Hh = 0 | p, this.Hl = 0 | b
        }
        process(e, t) {
            for (let r = 0; r < 16; r++, t += 4) N[r] = e.getUint32(t), C[r] = e.getUint32(t += 4);
            for (let e = 16; e < 80; e++) {
                let t = 0 | N[e - 15],
                    r = 0 | C[e - 15],
                    ...
                    c = S(i, w(o, s, 19) ^ E(o, s, 61) ^ g(o, s, 6), C[e - 7], C[e - 16]),
            ...
            for (let e = 0; e < 80; e++) {
                let t = m(u, f, 14) ^ m(u, f, 18) ^ v(u, f, 41),
                    ...
                    k = r & i ^ r & s ^ i & s,
                    L = n & o ^ n & a ^ o & a;
                U = 0 | p, R = 0 | b, p = 0 | h, b = 0 | d, h = 0 | u, d = 0 | f, ({
                    h: u,
                    l: f
                } = x(0 | c, 0 | l, 0 | A, 0 | D)), c = 0 | s, l = 0 | a, s = 0 | i, a = 0 | o, i = 0 | r, o = 0 | n;
                let W = _(D, M, L);
                r = O(W, A, j, k), n = 0 | W
            }({
                h: r,
                l: n
            } = x(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)), ({
                h: i,
                l: o
            } = x(0 | this.Bh, 0 | this.Bl, 0 | i, 0 | o)), ({
                h: s,
                l: a
            } = x(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | a)), ({
                h: c,
                l: l
            } = x(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | l)), ({
                h: u,
                l: f
            } = x(0 | this.Eh, 0 | this.El, 0 | u, 0 | f)), ({
                h: h,
                l: d
            } = x(0 | this.Fh, 0 | this.Fl, 0 | h, 0 | d)), ({
                h: p,
                l: b
            } = x(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | b)), ({
                h: U,
                l: R
            } = x(0 | this.Hh, 0 | this.Hl, 0 | U, 0 | R)), this.set(r, n, i, o, s, a, c, l, u, f, h, d, p, b, U, R)
        }
        roundClean() {
            N.fill(0), C.fill(0)
        }
    ...
    let R = (n = () => new U, (t = e => n().update(u(e)).digest()).outputLen = (r = n()).outputLen, t.blockLen = r.blockLen, t.create = () => n(), t),
        D = BigInt(0),
        j = BigInt(1),
        M = BigInt(2);
    ...
    function X(e, t, r, n) {
        if (!(Z(t) && Z(r) && Z(n)) || !(r <= t) || !(t < n)) throw Error("expected valid " + e + ": " + r + " <= n < " + n + ", got " + t)
    }
    let Q = {
    ...
    let eh = ["create", "isValid", "is0", "neg", "inv", "sqrt", "sqr", "eql", "add", "sub", "mul", "pow", "div", "addN", "subN", "mulN", "sqrN"];
    ...
    function ep(e, t, r = !1, n = {}) {
        ...
        let a = Object.freeze({
            ...
            pow: (e, t) => (function(e, t, r) {
                ...
                let n = e.ONE,
                    i = t;
                for (; r > er;) r & en && (n = e.mul(n, i)), i = e.sqr(i), r >>= en;
                return n
            })(a, e, t),
            ...
            invertBatch: e => {
                let t, r, n;
                return t = Array(e.length), r = e.reduce((e, r, n) => a.is0(r) ? e : (t[n] = e, a.mul(e, r)), a.ONE), n = a.inv(r), e.reduceRight((e, r, n) => a.is0(r) ? e : (t[n] = a.mul(e, t[n]), a.mul(e, r)), n), t
            },
            cmov: (e, t, r) => r ? t : e,
    ...
    BigInt(0), BigInt(1);
    let eT = BigInt("57896044618658097711785492504343953926634992332820282019728792003956564819949"),
    ...
    let eC = BigInt(5),
        ...
        eD = function(e) {
            var t;
            let r, n = (ee(e.Fp, eh.reduce((e, t) => (e[t] = "function", e), {
                    ORDER: "bigint",
                    MASK: "bigint",
                    BYTES: "isSafeInteger",
                    BITS: "isSafeInteger"
                ...
                }), r = Object.freeze({ ...ed(e.n, e.nBitLength),
                    ...e,
                    p: e.Fp.ORDER
                }), ee(e, {
                    hash: "function",
                ...
                y = n.domain || ((e, t, r) => {
                    if (W("phflag", r), t.length || r) throw Error("Contexts/pre-hash are not supported");
                    return e
                });
            ...
            let w = et((e, t) => {
                ...
                v = et(e => {
                    ...
                    let {
                        ...
                        ez: s,
                        et: a
                    } = e, c = h(i * i), l = h(o * o), u = h(s * s), f = h(u * u), d = h(c * t);
                    if (h(u * h(d + l)) !== h(f + h(r * h(c * l)))) throw Error("bad point: equation left != right (1)");
                    if (h(i * o) !== h(s * a)) throw Error("bad point: equation left != right (2)");
                    return !0
                });
            class E {
                constructor(e, t, r, n) {
                    this.ex = e, this.ey = t, this.ez = r, this.et = n, g("x", e), g("y", t), g("z", r), g("t", n), Object.freeze(this)
                }
                get x() {
                ...
                equals(e) {
                    ...
                    let {
                        ...
                        ey: o,
                        ez: s
                    } = e, a = h(t * s), c = h(i * n), l = h(r * s), u = h(o * n);
                    return a === c && l === u
                }
                is0() {
                ...
                double() {
                    let {
                        ...
                        ey: r,
                        ez: i
                    } = this, o = h(t * t), s = h(r * r), a = h(eS * h(i * i)), c = h(e * o), l = t + r, u = h(h(l * l) - o - s), f = c + s, d = f - a, p = c - s, b = h(u * d), y = h(f * p), g = h(u * p);
                ...
                multiplyUnsafe(e, t = E.ZERO) {
                    return X("scalar", e, e_, o), e === e_ ? _ : this.is0() || e === eO ? this : O.wNAFCachedUnsafe(this, e, E.normalizeZ, t)
                }
                isSmallOrder() {
                ...
                static fromHex(e, t = !1) {
                    ...
                    let y = (b & eO) === eO,
                        g = (128 & c) != 0;
                    if (!t && b === e_ && g) throw Error("Point.fromHex: x=0 and x_0=1");
                    return g !== y && (b = h(-b)), E.fromAffine({
                        x: b,
                        y: l
                    })
                }
            ...
            E.BASE = new E(n.Gx, n.Gy, eO, h(n.Gx * n.Gy)), E.ZERO = new E(e_, eO, eO, e_);
            let {
                BASE: x,
                ZERO: _
            } = E, O = (t = 8 * l, {
                ...
                unsafeLadder(e, t, r = E.ZERO) {
                    let n = e;
                    for (; t > eb;) t & ey && (r = r.add(n)), n = n.double(), t >>= ey;
                    return r
                },
                ...
                wNAF(e, r, n) {
                    let {
                        windows: i,
                        windowSize: o
                    } = ew(e, t), s = E.ZERO, a = E.BASE, c = BigInt(2 ** e - 1), l = 2 ** e, u = BigInt(e);
                    for (let e = 0; e < i; e++) {
                        let t = e * o,
                            i = Number(n & c);
                        n >>= u, i > o && (i -= l, n += ey);
                ...
                wNAFUnsafe(e, r, n, i = E.ZERO) {
                    let {
                        windows: o,
                        windowSize: s
                    } = ew(e, t), a = BigInt(2 ** e - 1), c = 2 ** e, l = BigInt(e);
                    for (let e = 0; e < o; e++) {
                        let t = e * s;
                        if (n === eb) break;
                        let o = Number(n & a);
                        if (n >>= l, o > s && (o -= c, n += ey), 0 === o) continue;
            ...
            return x._setWindowSize(8), {
                ...
                sign: function(e, t, r = {}) {
                    ...
                    let {
                        ...
                        scalar: a,
                        pointBytes: c
                    } = S(t), l = A(r.context, n, e), u = x.multiply(l).toRawBytes(), f = el(l + A(r.context, u, c, e) * a, o);
                    return X("signature.s", f, e_, o), Y("result", G(u, J(f, i.BYTES)), 2 * i.BYTES)
                },
                verify: function(e, t, r, n = eI) {
                    let o, a, c, {
                        ...
                        f = i.BYTES;
                    e = Y("signature", e, 2 * f), t = Y("message", t), r = Y("publicKey", r, f), void 0 !== u && W("zip215", u), s && (t = s(t));
                    let h = K(e.slice(f, 2 * f));
                    try {
                        o = E.fromHex(r, u), a = E.fromHex(e.slice(0, f), u), c = x.multiplyUnsafe(h)
                    } catch {
                        return !1
                    }
                    if (!u && o.isSmallOrder()) return !1;
                    let d = A(l, a.toRawBytes(), o.toRawBytes(), t);
                    return a.add(o.multiplyUnsafe(d)).subtract(c).clearCofactor().equals(E.ZERO)
                },
                ExtendedPoint: E,
                utils: {
            ...
            uvRatio: function(e, t) {
                var r;
                let n, i, o, s, a, c, l, u, f, h, d, p, b, y, g = el(t * t * t, eT),
                    m = (r = e * el(g * g * t, eT), n = BigInt(10), i = BigInt(20), o = BigInt(40), s = BigInt(80), c = eu(a = r * r % eT * r % eT, eN, eT) * a % eT, l = eu(c, eP, eT) * r % eT, u = eu(l, eC, eT) * l % eT, f = eu(u, n, eT) * u % eT, h = eu(f, i, eT) * f % eT, d = eu(h, o, eT) * h % eT, p = eu(d, s, eT) * d % eT, b = eu(p, s, eT) * d % eT, y = eu(b, n, eT) * u % eT, {
                        pow_p_5_8: eu(y, eN, eT) * r % eT,
                        b2: a
                    }).pow_p_5_8,
                    w = el(e * g * m, eT),
                    v = el(t * w * w, eT),
                    ...
                    O = v === el(-e, eT),
                    S = v === el(-e * eB, eT);
                return _ && (w = E), (O || S) && (w = x), (el(w, eT) & en) === en && (w = el(-w, eT)), {
                    isValid: _ || O,
                    value: w
                }
            }
    ...
    function ez(e = 0) {
        return null != globalThis.Buffer && null != globalThis.Buffer.allocUnsafe ? eW(globalThis.Buffer.allocUnsafe(e)) : new Uint8Array(e)
    }
    ...
    var eH = function(e, t) {
        ...
        function f(e) {
            ...
            if (" " !== e[0]) {
                ...
                for (var o = (e.length - t) * l + 1 >>> 0, s = new Uint8Array(o); e[t];) {
                    ...
                    if (255 === u) return;
                    for (var f = 0, h = o - 1;
                        (0 !== u || f < i) && -1 !== h; h--, f++) u += a * s[h] >>> 0, s[h] = u % 256 >>> 0, u = u / 256 >>> 0;
        ...
        return {
            encode: function(t) {
                ...
                for (var s = (o - i) * u + 1 >>> 0, l = new Uint8Array(s); i !== o;) {
                    for (var f = t[i], h = 0, d = s - 1;
                        (0 !== f || h < n) && -1 !== d; d--, h++) f += 256 * l[d] >>> 0, l[d] = f % a >>> 0, f = f / a >>> 0;
    ...
    class eY {
        constructor(e, t, r, n) {
            this.name = e, this.prefix = t, this.baseEncode = r, this.baseDecode = n, this.encoder = new eq(e, t, r), this.decoder = new eK(e, t, n)
        }
        encode(e) {
    ...
    class tc {
        ...
        digest(e) {
            if (e instanceof Uint8Array) {
                let t = this.encode(e);
                return t instanceof Uint8Array ? to(this.code, t) : t.then(e => to(this.code, e))
            }
            throw Error("Unknown type, must be binary type")
        }
    }
    ...
    let tp = td("utf8", "u", e => "u" + new TextDecoder("utf8").decode(e), e => new TextEncoder().encode(e.substring(1))),
        tb = td("ascii", "a", e => {
            let t = "a";
    ...
    function tm(e, t = "utf8") {
        let r = ty[t];
        if (!r) throw Error(`Unsupported encoding "${t}"`);
        return ("utf8" === t || "utf-8" === t) && null != globalThis.Buffer && null != globalThis.Buffer.from ? eW(globalThis.Buffer.from(e, "utf-8")) : r.decoder.decode(`${r.prefix}${e}`)
    }
    ...
    e.s(["decodeJWT", () => tx, "encodeIss", () => tE, "generateKeyPair", () => t_, "signJWT", () => tO])
}, 18531, 281223, e => {
    "use strict";
    let t = function(e, t) {
            if (e.length >= 255) throw TypeError("Alphabet too long");
    ...
    e.s(["coerce", () => s, "empty", () => r, "equals", () => o, "fromHex", () => i, "fromString", () => c, "isBinary", () => a, "toHex", () => n, "toString", () => l], 723472);
    class u {
        constructor(e, t, r) {
            this.name = e, this.prefix = t, this.baseEncode = r
        }
    ...
    class p {
        constructor(e, t, r, n) {
            this.name = e, this.prefix = t, this.baseEncode = r, this.baseDecode = n, this.encoder = new u(e, t, r), this.decoder = new f(e, t, n)
        }
        encode(e) {
            return this.encoder.encode(e)
        }
    ...
    e.s(["base32", 0, B, "base32hex", 0, U, "base32hexpad", 0, D, "base32hexpadupper", 0, j, "base32hexupper", 0, R, "base32pad", 0, N, "base32padupper", 0, C, "base32upper", 0, P, "base32z", 0, M], 874676);
    var k = e.i(874676);
    let L = y({
            prefix: "k",
            name: "base36",
    ...
    e.s(["base64", 0, q, "base64pad", 0, K, "base64url", 0, $, "base64urlpad", 0, J], 428667);
    var Y = e.i(428667);
    let G = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"),
    ...
    function er(e, t) {
        var r, n = 0,
            ...
            s = e.length;
        do {
            if (o >= s) throw er.bytes = 0, RangeError("Could not decode varint");
            r = e[o++], n += i < 28 ? (127 & r) << i : (127 & r) * Math.pow(2, i), i += 7
        } while (r >= 128) return er.bytes = o - t, n
    }
    ...
    let es = (e, t) => {
        ...
        ec = (e, t) => e === t || e.code === t.code && e.size === t.size && o(e.bytes, t.bytes);
    class el {
        constructor(e, t, r, n) {
            this.code = e, this.size = t, this.digest = r, this.bytes = n
        }
    }
    e.s(["Digest", () => el, "create", 0, es, "decode", 0, ea, "equals", 0, ec], 241823);
    let eu = ({
        name: e,
        code: t,
        encode: r
    ...
    class ef {
        ...
        digest(e) {
            if (e instanceof Uint8Array) {
                let t = this.encode(e);
                return t instanceof Uint8Array ? es(this.code, t) : t.then(e => es(this.code, e))
            }
            throw Error("Unknown type, must be binary type")
        }
    }
    ...
    e.i(373173);
    e.s(["code", 0, 85, "decode", 0, e => s(e), "encode", 0, e => s(e), "name", 0, "raw"], 25968), e.i(25968);
    let eb = new TextEncoder,
        ey = new TextDecoder;
    e.s(["code", 0, 512, "decode", 0, e => JSON.parse(ey.decode(e)), "encode", 0, e => eb.encode(JSON.stringify(e)), "name", 0, "json"], 167008), e.i(167008);
    class eg {
        constructor(e, t, r, n) {
        ...
        toV0() {
            if (0 === this.version) return this; {
                ...
                if (t.code !== ex) throw Error("Cannot convert non sha2-256 multihash CID to CIDv0");
        ...
        equals(e) {
            return e && this.code === e.code && this.version === e.version && ec(this.multihash, e.multihash)
        }
        toString(e) {
            let {
                bytes: t,
        ...
        static create(e, t, r) {
            ...
            switch (e) {
                case 0:
                    ...
                    throw Error(`Version 0 CID must use dag-pb (code: ${eE}) block encoding`);
                case 1:
                    {
        ...
        static decodeFirst(e) {
            ...
            return [0 === t.version ? eg.createV0(o) : eg.createV1(t.codec, o), e.subarray(t.size)]
        }
    ...
    let em = (e, t) => {
        ...
        ew = (e, t, r) => {
            ...
            if (n !== F.prefix) throw Error(`Cannot string encode V0 in ${r.name} encoding`);
            let i = t.get(n);
            if (null != i) return i; {
...
`;
    ...
    class a extends i {
        constructor(e) {
            super(e), this.events = new t.EventEmitter, this.interval = o, this.interval = e ? .interval || o
        }
        static async init(e) {
            let t = new a(e);
        ...
        async initialize() {
            this.intervalRef = setInterval(() => this.pulse(), (0, r.toMiliseconds)(this.interval))
        }
        pulse() {
    ...
    function c(e = {}) {
        let f, h = {
            ...
            p = (e, t) => h.mountpoints.filter(r => r.startsWith(e) || t && e.startsWith(r)).map(t => ({
            ...
            b = (e, t) => {
                if (h.watching)
                    for (let r of (t = s(t), h.watchListeners)) r(e, t)
            },
            y = async () => {
                if (!h.watching)
                    for (let e in h.watching = !0, h.mounts) h.unwatch[e] = await l(h.mounts[e], b, e)
            },
            g = async () => {
                if (h.watching) {
            ...
            w = {
                ...
                getItems: (e, r = {}) => m(e, r, e => e.driver.getItems ? n(e.driver.getItems, e.items.map(e => ({
                    key: e.relativeKey,
                    options: e.options
                })), r).then(r => r.map(r => ({
                    key: function(...e) {
                ...
                }))) : Promise.all(e.items.map(r => n(e.driver.getItem, r.relativeKey, r.options).then(e => ({
                    key: r.key,
                    value: (0, t.default)(e)
                }))))),
                getItemRaw(e, t = {}) {
                    ...
                    return a.getItemRaw ? n(a.getItemRaw, i, t) : n(a.getItem, i, t).then(e => {
                        var t;
                        return "string" == typeof e && e.startsWith(o) ? (t = e.slice(o.length), globalThis.Buffer ? r.Buffer.from(t, "base64") : Uint8Array.from(globalThis.atob(t), e => e.codePointAt(0))) : e
                    })
                },
                async setItem(e, t, r = {}) {
                    ...
                    a.setItem && (await n(a.setItem, o, i(t), r), a.watch || b("update", e))
                },
                async setItems(e, t) {
                    await m(e, t, async e => {
                        if (e.driver.setItems) return n(e.driver.setItems, e.items.map(e => ({
                            key: e.relativeKey,
                            value: i(e.value),
                            options: e.options
                        })), t);
                        e.driver.setItem && await Promise.all(e.items.map(t => n(e.driver.setItem, t.relativeKey, i(t.value), t.options)))
                    })
                },
                async setItemRaw(e, t, i = {}) {
                    ...
                    if (c.setItemRaw) await n(c.setItemRaw, a, t, i);
                        ...
                        var l;
                        if (!c.setItem) return;
                        await n(c.setItem, a, "string" == typeof t ? t : o + (l = t, globalThis.Buffer ? r.Buffer.from(l).toString("base64") : globalThis.btoa(String.fromCodePoint(...l))), i)
                    }
                    c.watch || b("update", e)
                },
                async removeItem(e, t = {}) {
                    ...
                    i.removeItem && (await n(i.removeItem, r, t), (t.removeMeta || t.removeMata) && await n(i.removeItem, r + "$", t), i.watch || b("remove", e))
                },
                async getMeta(e, r = {}) {
                    "boolean" == typeof r && (r = {
                        nativeOnly: r
                    ...
                    let {
                        relativeKey: i,
                        driver: o
                    } = d(e = s(e)), a = Object.create(null);
                    if (o.getMeta && Object.assign(a, await n(o.getMeta, i, r)), !r.nativeOnly) {
                        let e = await n(o.getItem, i + "$", r).then(e => (0, t.default)(e));
                ...
                async getKeys(e, t = {}) {
                    let r = p(e = a(e), !0),
                        ...
                        c = !0;
                    for (let e of r) {
                        for (let r of (e.driver.flags ? .maxDepth || (c = !1), await n(e.driver.getKeys, e.relativeBase, t))) {
                    ...
                    return o.filter(r => {
                        ...
                        return (!l || function(e, t) {
                            ...
                            return r <= t
                        }(r, t.maxDepth)) && ((n = e) ? r.startsWith(n) && "$" !== r[r.length - 1] : "$" !== r[r.length - 1])
                    })
                },
                async clear(e, t = {}) {
                    e = a(e), await Promise.all(p(e, !1).map(async e => e.driver.clear ? n(e.driver.clear, e.relativeBase, t) : e.driver.removeItem ? Promise.all((await e.driver.getKeys(e.relativeBase || "", t)).map(r => e.driver.removeItem(r, t))) : void 0))
                },
                async dispose() {
                    await Promise.all(Object.values(h.mounts).map(e => u(e)))
                },
                watch: async e => (await y(), h.watchListeners.push(e), async () => {
                    h.watchListeners = h.watchListeners.filter(t => t !== e), 0 === h.watchListeners.length && await g()
                }),
                async unwatch() {
                    h.watchListeners = [], await g()
                },
                mount(e, t) {
                    if ((e = a(e)) && h.mounts[e]) throw Error(`already mounted at ${e}`);
                    return e && (h.mountpoints.push(e), h.mountpoints.sort((e, t) => t.length - e.length)), h.mounts[e] = t, h.watching && Promise.resolve(l(t, b, e)).then(t => {
                        h.unwatch[e] = t
                    }).catch(console.error), w
                },
                async unmount(e, t = !0) {
                    (e = a(e)) && h.mounts[e] && (h.watching && e in h.unwatch && (h.unwatch[e] ? .(), delete h.unwatch[e]), t && await u(h.mounts[e]), h.mountpoints = h.mountpoints.filter(t => t !== e), delete h.mounts[e])
                },
                getMount(e = "") {
                    let t = d(e = s(e) + ":");
                    return {
                ...
                getMounts: (e = "", t = {}) => p(e = s(e), t.parents).map(e => ({
                    driver: e.driver,
                    base: e.mountpoint
                })),
    ...
    class i {
        constructor() {
            this.indexedDb = (0, t.createStorage)({
                driver: ((e = {}) => {
                    let t, n = e.base && e.base.length > 0 ? `${e.base}:` : "";
                    return e.dbName && e.storeName && (t = (0, r.createStore)(e.dbName, e.storeName)), {
                        name: "idb-keyval",
                        options: e,
                        hasItem: async e => !(typeof await (0, r.get)(n + e, t) > "u"),
    ...
    var o = "u" > typeof globalThis ? globalThis : "u" > typeof window ? window : e.g,
        s = {
            exports: {}
        };
    ...
    }), "u" > typeof o && o.localStorage ? s.exports = o.localStorage : "u" > typeof window && window.localStorage ? s.exports = window.localStorage : s.exports = new c;
    class l {
        constructor() {
    ...
    t.exports = function(e, t, r) {
        ...
        var c = t.length;
        if (0 === c) return e;
        for (var l = "", u = 0, f = -1, h = e && e.length || 0, d = 0; d < h;) {
            if (37 === e.charCodeAt(d) && d + 1 < h) {
                switch (f = f > -1 ? f : 0, e.charCodeAt(d + 1)) {
                    case 100:
                    case 102:
                        if (u >= c || null == t[u]) break;
                        f < d && (l += e.slice(f, d)), l += Number(t[u]), f = d + 2, d++;
                        break;
                    case 105:
                        if (u >= c || null == t[u]) break;
                        f < d && (l += e.slice(f, d)), l += Math.floor(Number(t[u])), f = d + 2, d++;
                        break;
                    case 79:
                    case 111:
                    case 106:
                    ...
                    case 115:
                        if (u >= c) break;
                        f < d && (l += e.slice(f, d)), l += String(t[u]), f = d + 2, d++;
                        break;
                    case 37:
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.isBrowserCryptoAvailable = r.getSubtleCrypto = r.getBrowerCrypto = void 0, r.getBrowerCrypto = n, r.getSubtleCrypto = i, r.isBrowserCryptoAvailable = function() {
        return !!n() && !!i()
    }
}, 431443, (e, t, r) => {
    "use strict";
    ...
    function o() {
        return void 0 !== n.default && void 0 !== n.default.versions && void 0 !== n.default.versions.node
    }
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.isBrowser = r.isNode = r.isReactNative = void 0, r.isReactNative = i, r.isNode = o, r.isBrowser = function() {
        return !i() && !o()
    }
}, 438005, (e, t, r) => {
    "use strict";
    ...
    var n = "u" > typeof globalThis && globalThis || "u" > typeof self && self || e.g,
        i = function() {
            function e() {
    ...
    (function(t) {
        ...
        function b() {
            return this.bodyUsed = !1, this._initBody = function(e) {
                if (this.bodyUsed = this.bodyUsed, this._bodyInit = e, e)
                    ...
                    var t;
                    n.arrayBuffer && n.blob && (t = e) && DataView.prototype.isPrototypeOf(t) ? (this._bodyArrayBuffer = p(e.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer])) : n.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(e) || s(e)) ? this._bodyArrayBuffer = p(e) : this._bodyText = e = Object.prototype.toString.call(e)
                ...
                var e, t, r, n, i, o = f(this);
                if (o) return o;
                if (this._bodyBlob) return e = this._bodyBlob, r = h(t = new FileReader), i = (n = /charset=([A-Za-z0-9_-]+)/.exec(e.type)) ? n[1] : "utf-8", t.readAsText(e, i), r;
        ...
        function g(e, t) {
            ...
            if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new u(t.headers)), this.method = (i = (n = t.method || this.method || "GET").toUpperCase(), y.indexOf(i) > -1 ? i : n), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
                    if ("AbortController" in r) return new AbortController().signal
                }(), this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && o) throw TypeError("Body not allowed for GET or HEAD requests");
        ...
        function w(e, t) {
            if (!(this instanceof w)) throw TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');
            ...
            this.ok = this.status >= 200 && this.status < 300, this.statusText = void 0 === t.statusText ? "" : "" + t.statusText, this.headers = new u(t.headers), this.url = t.url || "", this._initBody(e)
        }
        ...
        function E(e, i) {
            return new Promise(function(o, s) {
                var l = new g(e, i);
                if (l.signal && l.signal.aborted) return s(new t.DOMException("Aborted", "AbortError"));
                ...
                if (f.onload = function() {
                        ...
                        0 === l.url.indexOf("file://") && (f.status < 200 || f.status > 599) ? r.status = 200 : r.status = f.status, r.url = "responseURL" in f ? f.responseURL : r.headers.get("X-Request-URL");
                    ...
                    }, f.open(l.method, function(e) {
                        try {
                            return "" === e && r.location.href ? r.location.href : e
                        } catch (t) {
                            return e
                        }
                    }(l.url), !0), "include" === l.credentials ? f.withCredentials = !0 : "omit" === l.credentials && (f.withCredentials = !1), "responseType" in f && (n.blob ? f.responseType = "blob" : n.arrayBuffer && (f.responseType = "arraybuffer")), i && "object" == typeof i.headers && !(i.headers instanceof u || r.Headers && i.headers instanceof r.Headers)) {
                    var d = [];
                ...
                l.signal && (l.signal.addEventListener("abort", h), f.onreadystatechange = function() {
                    4 === f.readyState && l.signal.removeEventListener("abort", h)
                }), f.send(void 0 === l._bodyInit ? null : l._bodyInit)
            })
        }
        E.polyfill = !0, r.fetch || (r.fetch = E, r.Headers = u, r.Request = g, r.Response = w), t.Headers = u, t.Request = g, t.Response = w, t.fetch = E, Object.defineProperty(t, "__esModule", {
            value: !0
        })
...
}, 501365, 329193, 850967, 424047, 112324, 98418, e => {
    "use strict";
    var t = e.i(219298);
    ...
    function d(e, t, a) {
        ...
        return {
            id: e,
            jsonrpc: "2.0",
            error: (c = t, l = a, void 0 === c ? s(r) : ("string" == typeof c && (c = Object.assign(Object.assign({}, s(n)), {
                message: c
            })), void 0 !== l && (c.data = l), u = c.code, i.includes(u) && (f = c.code, c = (h = Object.values(o).find(e => e.code === f)) || o[n]), c))
        }
    }
    c.isNode, e.s(["formatJsonRpcError", () => d, "formatJsonRpcRequest", () => f, "formatJsonRpcResult", () => h, "getBigIntRpcId", () => u, "payloadId", () => l], 329193);
    class p {}
    class b extends p {
        constructor() {
            super()
    ...
    e.s(["isJsonRpcError", () => O, "isJsonRpcRequest", () => E, "isJsonRpcResponse", () => x, "isJsonRpcResult", () => _], 850967), e.s([], 424047);
    class S extends y {
        constructor(e) {
        ...
        async request(e, t) {
            return this.requestStrict(f(e.method, e.params || [], e.id || u().toString()), t)
        }
        ...
        onPayload(e) {
            this.events.emit("payload", e), x(e) ? this.events.emit(`${e.id}`, e) : this.events.emit("message", {
                type: e.method,
                data: e.params
            })
        }
    ...
    var A = e.i(31794);
    let I = e => e.split("?")[0],
        T = "u" > typeof WebSocket ? WebSocket : "u" > typeof e.g.WebSocket ? e.g.WebSocket : "u" > typeof window && "u" > typeof window.WebSocket ? window.WebSocket : "u" > typeof self && "u" > typeof self.WebSocket ? self.WebSocket : e.r(756823);
    class B {
        constructor(e) {
            if (this.url = e, this.events = new t.EventEmitter, this.registering = !1, !w(e)) throw Error(`Provided URL is not compatible with WebSocket connection: ${e}`);
            this.url = e
        }
        get connected() {
        ...
        register(t = this.url) {
            if (!w(t)) throw Error(`Provided URL is not compatible with WebSocket connection: ${t}`);
            if (this.registering) {
            ...
            return this.url = t, this.registering = !0, new Promise((r, n) => {
                let i = (0, c.isReactNative)() ? void 0 : {
                        rejectUnauthorized: !RegExp("wss?://localhost(:d{2,5})?").test(t)
                    },
                    o = new T(t, [], i);
                "u" > typeof WebSocket || "u" > typeof e.g.WebSocket || "u" > typeof window && "u" > typeof window.WebSocket || "u" > typeof self && "u" > typeof self.WebSocket ? o.onerror = e => {
        ...
        onPayload(e) {
            ...
            let t = "string" == typeof e.data ? (0, A.safeJsonParse)(e.data) : e.data;
        ...
        emitError(e) {
            let t = this.parseError(Error(e ? .message || `WebSocket connection failed for host: ${I(this.url)}`));
    ...
    var P = e.i(320502),
        ...
        k = (e, t) => {
            ...
            if (R)
                for (var r of R(t)) j.call(t, r) && M(e, r, t[r]);
            return e
        };
    let L = {
        headers: {
    ...
    class W {
        ...
        async send(e) {
            ...
            try {
                let t, r, n = (0, A.safeJsonStringify)(e),
                    i = await (await (0, P.default)(this.url, (t = k({}, L), r = {
                        body: n
                    }, C(t, U(r))))).json();
                this.onPayload({
                    data: i
        ...
        async register(e = this.url) {
            ...
            try {
                if (!this.disableProviderPing) {
                    let t, r, n = (0, A.safeJsonStringify)({
                        id: 1,
                        jsonrpc: "2.0",
                        method: "test",
                        params: []
                    });
                    await (0, P.default)(e, (t = k({}, L), r = {
                        body: n
                    }, C(t, U(r))))
                }
                this.onOpen()
