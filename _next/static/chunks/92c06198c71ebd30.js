(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 507220, (t, e, r) => {
    e.exports = function() {
        return "function" == typeof Promise && Promise.prototype && Promise.prototype.then
    }
}, 87201, (t, e, r) => {
    let n, o = [0, 26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532, 581, 655, 733, 815, 901, 991, 1085, 1156, 1258, 1364, 1474, 1588, 1706, 1828, 1921, 2051, 2185, 2323, 2465, 2611, 2761, 2876, 3034, 3196, 3362, 3532, 3706];
    ...
    r.getRowColCoords = function(t) {
        ...
        let e = [],
            ...
            o = n.length;
        for (let t = 0; t < o; t++)
            for (let r = 0; r < o; r++)(0 !== t || 0 !== r) && (0 !== t || r !== o - 1) && (t !== o - 1 || 0 !== r) && e.push([n[t], n[r]]);
        return e
    }
}, 814002, (t, e, r) => {
    let n = t.r(87201).getSymbolSize;
    ...
    r.isValid = function(t) {
        ...
        for (let u = 0; u < e; u++) {
            ...
            for (let s = 0; s < e; s++) {
                let e = t.get(u, s);
                e === i ? n++ : (n >= 5 && (r += 3 + (n - 5)), i = e, n = 1), (e = t.get(s, u)) === a ? o++ : (o >= 5 && (r += 3 + (o - 5)), a = e, o = 1)
            }
        ...
        for (let i = 0; i < e; i++) {
            n = o = 0;
            for (let a = 0; a < e; a++) n = n << 1 & 2047 | t.get(i, a), a >= 10 && (1488 === n || 93 === n) && r++, o = o << 1 & 2047 | t.get(a, i), a >= 10 && (1488 === o || 93 === o) && r++
        }
        return 40 * r
        ...
        let n = e.size;
        for (let o = 0; o < n; o++)
            for (let i = 0; i < n; i++) e.isReserved(i, o) || e.xor(i, o, function(t, e, n) {
                switch (t) {
    ...
    r.KANJI = RegExp(o, "g"), r.BYTE_KANJI = RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), r.BYTE = RegExp(i, "g"), r.NUMERIC = RegExp(n, "g"), r.ALPHANUMERIC = RegExp("[A-Z $%*+\\-./:]+", "g");
    let a = RegExp("^" + o + "$"),
        u = RegExp("^" + n + "$"),
        s = RegExp("^[A-Z0-9 $%*+\\-./:]+$");
            ...
            if (t.length > 1) {
                for (let e = 1; e <= 40; e++)
                    if (function(t, e) {
                        ...
                        }(t, e) <= r.getCapacity(e, o, a.MIXED)) return e;
                return
            }
    ...
    var n = {
        single_source_shortest_paths: function(t, e, r) {
            ...
            for (g.push(e, 0); !g.empty();)
                for (a in i = (o = g.pop()).value, u = o.cost, s = t[i] || {}) s.hasOwnProperty(a) && (l = u + s[a], h = c[a], (void 0 === c[a] || h > l) && (c[a] = l, g.push(a, l), f[a] = i));
            if (void 0 !== r && void 0 === c[r]) throw Error("Could not find a path from " + e + " to " + r + ".");
            return f
        },
    ...
    function g(t) {
        let e, r, o = c(s.NUMERIC, n.NUMERIC, t),
            i = c(s.ALPHANUMERIC, n.ALPHANUMERIC, t);
        return l.isKanjiModeEnabled() ? (e = c(s.BYTE, n.BYTE, t), r = c(s.KANJI, n.KANJI, t)) : (e = c(s.BYTE_KANJI, n.BYTE, t), r = []), o.concat(i, e, r).sort(function(t, e) {
    ...
    function p(t, e) {
        let r, s = n.getBestModeForData(t);
                ...
                for (let a = 0; a < t.length; a++) {
                    ...
                    for (let t = 0; t < u.length; t++) {
                        ...
                        for (let t = 0; t < i.length; t++) {
                            let a = i[t];
                            r[a] && r[a].node.mode === l.mode ? (o[a][h] = d(r[a].lastCount + l.length, l.mode) - d(r[a].lastCount, l.mode), r[a].lastCount += l.length) : (r[a] && (r[a].lastCount = l.length), o[a][h] = d(l.length, l.mode) + 4 + n.getCharCountIndicator(l.mode, e))
                        }
                    }
                    i = s
                }
    ...
    r.create = function(t, e) {
        ...
        let E = o.M;
        return void 0 !== e && (E = o.from(e.errorCorrectionLevel, o.M), r = c.from(e.version), g = l.from(e.maskPattern), e.toSJISFunc && n.setToSJISFunction(e.toSJISFunc)),
            function(t, e, r, o) {
                let g;
                ...
                let y = function(t, e, r) {
                        ...
                        let a = (n.getSymbolTotalCodewords(t) - h.getTotalCodewordsCount(t, e)) * 8;
                        ...
                        return function(t, e, r) {
                            ...
                            for (let t = 0; t < s; t++) {
                                let e = t < c ? d : p;
                                w[t] = B.slice(y, y + e), A[t] = E.encode(w[t]), y += e, C = Math.max(C, e)
                            }
                ...
                }(w, y), isNaN(o) && (o = l.getBestMask(w, m.bind(null, w, r))), l.applyMask(o, w), m(w, r, o), {
                    modules: w,
                    version: e,
    ...
    r.getOptions = function(t) {
        ...
        for (let e = 0; e < u; e++)
            for (let r = 0; r < u; r++) {
                let h = (e * u + r) * 4,
                    f = n.color.light;
                e >= s && r >= s && e < u - s && r < u - s && (f = l[+!!i[Math.floor((e - s) / a) * o + Math.floor((r - s) / a)]]), t[h++] = f.r, t[h++] = f.g, t[h++] = f.b, t[h] = f.a
            }
    }
}, 563037, (t, e, r) => {
    let n = t.r(125950);
    r.render = function(t, e, r) {
        ...
        return n.qrToImageData(l.data, t, i), o = a, s.clearRect(0, 0, o.width, o.height), o.style || (o.style = {}), o.height = u, o.width = u, o.style.height = u + "px", o.style.width = u + "px", s.putImageData(l, 0, 0), a
    ...
    r.render = function(t, e, r) {
        let a = n.getOptions(e),
            ...
            s = t.modules.data,
            l = u + 2 * a.margin,
            h = a.color.light.a ? "<path " + o(a.color.light, "fill") + ' d="M0 0h' + l + "v" + l + 'H0z"/>' : "",
            f = "<path " + o(a.color.dark, "stroke") + ' d="' + function(t, e, r) {
                let n = "",
                    o = 0,
                    a = !1,
                    u = 0;
                for (let s = 0; s < t.length; s++) {
                    let l = Math.floor(s % e),
                        h = Math.floor(s / e);
                    l || a || (a = !0), t[s] ? (u++, s > 0 && l > 0 && t[s - 1] || (n += a ? i("M", l + r, .5 + h + r) : i("m", o, 0), o = 0, a = !1), l + 1 < e && t[s + 1] || (n += i("h", u), u = 0)) : o++
                }
                return n
            }(s, u, a.margin) + '"/>',
            c = '<svg xmlns="http://www.w3.org/2000/svg" ' + (a.width ? 'width="' + a.width + '" height="' + a.width + '" ' : "") + ('viewBox="0 0 ' + l + " ") + l + '" shape-rendering="crispEdges">' + h + f + "</svg>\n";
    ...
    r.create = o.create, r.toCanvas = u.bind(null, i.render), r.toDataURL = u.bind(null, i.renderToDataURL), r.toString = u.bind(null, function(t, e, r) {
        return a.render(t, r)
    })
}]);