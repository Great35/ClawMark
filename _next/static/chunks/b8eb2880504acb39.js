(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 964893, (e, t, r) => {
    ...
    function $(e, t, r, n) {
        ...
        return l.then(function() {
            ...
            E(l, t.id, t.bound), "__proto__" !== n && (r[n] = l), "" === n && null === u.value && (u.value = l), r[0] === h && "object" == typeof u.value && null !== u.value && u.value.$$typeof === h && (o = u.value, "3" === n) && (o.props = l), u.deps--, 0 === u.deps && null !== (l = u.chunk) && "blocked" === l.status && (o = l.value, l.status = "fulfilled", l.value = u.value, l.reason = null, null !== o && S(e, o, u.value, l))
        }, function(t) {
            if (!u.errored) {
                ...
                if (-1 < v) p = new Uint8Array(i.buffer, _, v - s), 98 === h ? J(e, o, v === g ? p : p.slice()) : function(e, t, r, n, l, u) {
                    ...
                    switch (l = o += t.decode(u), n) {
                        case 73:
                            ...
                            } else y ? C(s, y, g) : (y = new m("resolved_module", g, null), p.set(f, y));
                            break;
                        case 72:
    ...
    function b(e, t, r, n, a, l, u, o, i, c, f, d, h) {
        ...
        switch (n) {
            case 0:
                A = !1, M = void 0 === r || e - r.navigatedAt >= p.DYNAMIC_STALETIME_MS, N = !1;
                break;
            case 1:
                M = !1, A = !1, N = !1;
                break;
    ...
    function V(e, t) {
        let r = t._heapIndex; - 1 !== r && (0 === r ? q(e, t, 0) : H(e[r - 1 >>> 1], t) > 0 ? X(e, t, r) : q(e, t, r))
    }
    ...
    function q(e, t, r, n, a, l, o, i) {
        ...
        return e.status = 2, e.tree = t, e.metadata = s, e.staleAt = n, e.couldBeIntercepted = a, e.canonicalUrl = l, e.renderedSearch = o, e.isPPREnabled = i, X(e), e
    }
    ...
    async function Y(e, t, r) {
        ...
        try {
            let r, h, R = new URL(n + a, location.origin);
            if (r = await er(R, s), h = null !== r && r.redirected ? new URL(r.url) : R, !r || !r.ok || 204 === r.status || !r.body) return W(e, Date.now() + 1e4), null;
                ...
                ! function(e, t, r, n, a, l, i, s, f) {
                    ...
                    let R = y.tree,
                        ...
                        T = function e(t, r, n, a, l) {
                            ...
                            } else i = n, r.endsWith(b.PAGE_SEGMENT_KEY) ? (s = !0, o = b.PAGE_SEGMENT_KEY, f = (0, c.finalizePageVaryPath)(r, a, i), null === l.metadataVaryPath && (l.metadataVaryPath = (0, c.finalizeMetadataVaryPath)(r, a, i))) : (s = !1, o = d, f = (0, c.finalizeLayoutVaryPath)(r, i));
                            let h = null,
                                p = t[1];
                            for (let t in p) {
                                let n = p[t],
