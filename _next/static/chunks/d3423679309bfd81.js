(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 478492, (t, r, e) => {
    "use strict";
    ...
    function s(t, r, e, i, o) {
        if ("function" != typeof e) throw TypeError("The listener must be a function");
        var s = new f(e, i || t, o),
            h = n ? n + r : r;
    ...
    Object.create && (o.prototype = Object.create(null), new o().__proto__ || (n = !1)), u.prototype.eventNames = function() {
        ...
        for (r in t = this._events) i.call(t, r) && e.push(n ? r.slice(1) : r);
        ...
        if (a.fn) {
            ...
            var p, c = a.length;
            for (u = 0; u < c; u++) switch (a[u].once && this.removeListener(t, a[u].fn, void 0, !0), l) {
                case 1:
                ...
                default:
                    if (!h)
                        for (p = 1, h = Array(l - 1); p < l; p++) h[p - 1] = arguments[p];
        ...
        if (f.fn) f.fn !== r || i && !f.once || e && f.context !== e || h(this, o);
        else {
            for (var s = 0, u = [], a = f.length; s < a; s++)(f[s].fn !== r || i && !f[s].once || e && f[s].context !== e) && u.push(f[s]);
            u.length ? this._events[o] = 1 === u.length ? u[0] : u : h(this, o)
        }
        return this
    }, u.prototype.removeAllListeners = function(t) {
        var r;
        return t ? (r = n ? n + t : t, this._events[r] && h(this, r)) : (this._events = new o, this._eventsCount = 0), this
    }, u.prototype.off = u.prototype.removeListener, u.prototype.addListener = u.prototype.on, u.prefixed = n, u.EventEmitter = u, r.exports = u
}, 734582, (t, r, e) => {
    "use strict";
    e.byteLength = function(t) {
        ...
        var r, e, i = u(t),
            ...
            a = 0,
            l = s > 0 ? f - 4 : f;
        for (e = 0; e < l; e += 4) r = n[t.charCodeAt(e)] << 18 | n[t.charCodeAt(e + 1)] << 12 | n[t.charCodeAt(e + 2)] << 6 | n[t.charCodeAt(e + 3)], h[a++] = r >> 16 & 255, h[a++] = r >> 8 & 255, h[a++] = 255 & r;
        return 2 === s && (r = n[t.charCodeAt(e)] << 2 | n[t.charCodeAt(e + 1)] >> 4, h[a++] = 255 & r), 1 === s && (r = n[t.charCodeAt(e)] << 10 | n[t.charCodeAt(e + 1)] << 4 | n[t.charCodeAt(e + 2)] >> 2, h[a++] = r >> 8 & 255, h[a++] = 255 & r), h
    }, e.fromByteArray = function(t) {
        for (var r, e = t.length, n = e % 3, o = [], f = 0, s = e - n; f < s; f += 16383) o.push(function(t, r, e) {
            for (var n, o = [], f = r; f < e; f += 3) n = (t[f] << 16 & 0xff0000) + (t[f + 1] << 8 & 65280) + (255 & t[f + 2]), o.push(i[n >> 18 & 63] + i[n >> 12 & 63] + i[n >> 6 & 63] + i[63 & n]);
            return o.join("")
        }(t, f, f + 16383 > s ? s : f + 16383));
        return 1 === n ? o.push(i[(r = t[e - 1]) >> 2] + i[r << 4 & 63] + "==") : 2 === n && o.push(i[(r = (t[e - 2] << 8) + t[e - 1]) >> 10] + i[r >> 4 & 63] + i[r << 2 & 63] + "="), o.join("")
    };
    for (var i = [], n = [], o = "u" > typeof Uint8Array ? Uint8Array : Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = 0, h = f.length; s < h; ++s) i[s] = f[s], n[f.charCodeAt(s)] = s;
    ...
    e.read = function(t, r, e, i, n) {
        var o, f, s = 8 * n - i - 1,
            ...
            p = e ? -1 : 1,
            c = t[r + l];
        for (l += p, o = c & (1 << -a) - 1, c >>= -a, a += s; a > 0; o = 256 * o + t[r + l], l += p, a -= 8);
        for (f = o & (1 << -a) - 1, o >>= -a, a += i; a > 0; f = 256 * f + t[r + l], l += p, a -= 8);
        if (0 === o) o = 1 - u;
        else {
        ...
        var f, s, h, u = 8 * o - n - 1,
            ...
            y = i ? 1 : -1,
            m = +(r < 0 || 0 === r && 1 / r < 0);
        for (isNaN(r = Math.abs(r)) || r === 1 / 0 ? (s = +!!isNaN(r), f = a) : (f = Math.floor(Math.log(r) / Math.LN2), r * (h = Math.pow(2, -f)) < 1 && (f--, h *= 2), f + l >= 1 ? r += p / h : r += p * Math.pow(2, 1 - l), r * h >= 2 && (f++, h /= 2), f + l >= a ? (s = 0, f = a) : f + l >= 1 ? (s = (r * h - 1) * Math.pow(2, n), f += l) : (s = r * Math.pow(2, l - 1) * Math.pow(2, n), f = 0)); n >= 8; t[e + c] = 255 & s, c += y, s /= 256, n -= 8);
        for (f = f << n | s, u += n; u > 0; t[e + c] = 255 & f, c += y, f /= 256, u -= 8);
        t[e + c - y] |= 128 * m
    }
}, 843943, (t, r, e) => {
    "use strict";
    ...
    function h(t, r, e) {
        ...
        if (L(t, ArrayBuffer) || t && L(t.buffer, ArrayBuffer) || "u" > typeof SharedArrayBuffer && (L(t, SharedArrayBuffer) || t && L(t.buffer, SharedArrayBuffer))) return p(t, r, e);
    ...
    function p(t, r, e) {
        ...
        return Object.setPrototypeOf(i = void 0 === r && void 0 === e ? new Uint8Array(t) : void 0 === e ? new Uint8Array(t, r) : new Uint8Array(t, r, e), s.prototype), i
    }
    ...
    function m(t, r, e) {
        ...
        for (t || (t = "utf8");;) switch (t) {
            ...
            case "base64":
                var o, f, s;
                return o = this, f = r, s = e, 0 === f && s === o.length ? i.fromByteArray(o) : i.fromByteArray(o.slice(f, s));
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
    ...
    function g(t, r, e, i, n) {
        ...
        if ("string" == typeof e ? (i = e, e = 0) : e > 0x7fffffff ? e = 0x7fffffff : e < -0x80000000 && (e = -0x80000000), (o = e *= 1) != o && (e = n ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length)
            if (n) return -1;
            else e = t.length - 1;
        else if (e < 0)
            if (!n) return -1;
            else e = 0;
        if ("string" == typeof r && (r = s.from(r, i)), s.isBuffer(r)) return 0 === r.length ? -1 : v(t, r, e, i, n);
        if ("number" == typeof r) {
    ...
    function w(t, r, e) {
            ...
            if (n + f <= e) {
                ...
                switch (f) {
                    case 1:
                        ...
                        break;
                    case 2:
                        (192 & (e = t[n + 1])) == 128 && (h = (31 & r) << 6 | 63 & e) > 127 && (o = h);
                        break;
                    case 3:
                        e = t[n + 1], i = t[n + 2], (192 & e) == 128 && (192 & i) == 128 && (h = (15 & r) << 12 | (63 & e) << 6 | 63 & i) > 2047 && (h < 55296 || h > 57343) && (o = h);
                        break;
                    case 4:
                        e = t[n + 1], i = t[n + 2], s = t[n + 3], (192 & e) == 128 && (192 & i) == 128 && (192 & s) == 128 && (h = (15 & r) << 18 | (63 & e) << 12 | (63 & i) << 6 | 63 & s) > 65535 && h < 1114112 && (o = h)
                }
            }
            null === o ? (o = 65533, f = 1) : o > 65535 && (o -= 65536, i.push(o >>> 10 & 1023 | 55296), o = 56320 | 1023 & o), i.push(o), n += f
        }
        var o = i;
        let f = o.length;
        ...
        let s = "",
            h = 0;
        for (; h < f;) s += String.fromCharCode.apply(String, o.slice(h, h += 4096));
        return s
    }
    ...
    function E(t, r, e, i, o) {
        return r *= 1, e >>>= 0, o || _(t, r, e, 4, 34028234663852886e22, -34028234663852886e22), n.write(t, r, e, i, 23, 4), e + 4
    }

    function B(t, r, e, i, o) {
        return r *= 1, e >>>= 0, o || _(t, r, e, 8, 17976931348623157e292, -17976931348623157e292), n.write(t, r, e, i, 52, 8), e + 8
    }
    e.Buffer = s, e.SlowBuffer = function(t) {
        ...
        if (L(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), L(r, Uint8Array) && (r = s.from(r, r.offset, r.byteLength)), !s.isBuffer(t) || !s.isBuffer(r)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
        if (t === r) return 0;
        let e = t.length,
            i = r.length;
        ...
        for (e = 0; e < t.length; ++e) {
            let r = t[e];
            if (L(r, Uint8Array)) n + r.length > i.length ? (s.isBuffer(r) || (r = s.from(r)), r.copy(i, n)) : Uint8Array.prototype.set.call(i, r, n);
        ...
        for (let r = 0; r < t; r += 8) d(this, r, r + 7), d(this, r + 1, r + 6), d(this, r + 2, r + 5), d(this, r + 3, r + 4);
        return this
    ...
    }, o && (s.prototype[o] = s.prototype.inspect), s.prototype.compare = function(t, r, e, i, n) {
        ...
        if (void 0 === r && (r = 0), void 0 === e && (e = t ? t.length : 0), void 0 === i && (i = 0), void 0 === n && (n = this.length), r < 0 || e > t.length || i < 0 || n > this.length) throw RangeError("out of range index");
        if (i >= n && r >= e) return 0;
        if (i >= n) return -1;
        if (r >= e) return 1;
        if (r >>>= 0, e >>>= 0, i >>>= 0, n >>>= 0, this === t) return 0;
        let o = n - i,
            f = e - r,
            h = Math.min(o, f),
            u = this.slice(i, n),
        ...
        else if (void 0 === e && "string" == typeof r) i = r, e = this.length, r = 0;
        else if (isFinite(r)) r >>>= 0, isFinite(e) ? (e >>>= 0, void 0 === i && (i = "utf8")) : (i = e, e = void 0);
        ...
        for (;;) switch (i) {
            ...
            case "utf16le":
            case "utf-16le":
                return a = r, l = e, k(function(t, r) {
                    let e, i, n = [];
                    for (let o = 0; o < t.length && !((r -= 2) < 0); ++o) i = (e = t.charCodeAt(o)) >> 8, n.push(e % 256), n.push(i);
                    return n
        ...
        let r = this[t],
            e = this[t + 7];
        return (void 0 === r || void 0 === e) && P(t, this.length - 8), (BigInt(this[t + 4] + 256 * this[t + 5] + 65536 * this[t + 6] + (e << 24)) << BigInt(32)) + BigInt(r + 256 * this[++t] + 65536 * this[++t] + 0x1000000 * this[++t])
    }), s.prototype.readBigInt64BE = F(function(t) {
        R(t >>>= 0, "offset");
        let r = this[t],
            e = this[t + 7];
        return (void 0 === r || void 0 === e) && P(t, this.length - 8), (BigInt((r << 24) + 65536 * this[++t] + 256 * this[++t] + this[++t]) << BigInt(32)) + BigInt(0x1000000 * this[++t] + 65536 * this[++t] + 256 * this[++t] + e)
    }), s.prototype.readFloatLE = function(t, r) {
        return t >>>= 0, r || b(t, 4, this.length), n.read(this, t, !0, 23, 4)
    }, s.prototype.readFloatBE = function(t, r) {
        return t >>>= 0, r || b(t, 4, this.length), n.read(this, t, !1, 23, 4)
    }, s.prototype.readDoubleLE = function(t, r) {
        return t >>>= 0, r || b(t, 8, this.length), n.read(this, t, !0, 52, 8)
    }, s.prototype.readDoubleBE = function(t, r) {
        return t >>>= 0, r || b(t, 8, this.length), n.read(this, t, !1, 52, 8)
    }, s.prototype.writeUintLE = s.prototype.writeUIntLE = function(t, r, e, i) {
        if (t *= 1, r >>>= 0, e >>>= 0, !i) {
        ...
        let n = 1,
            o = 0;
        for (this[r] = 255 & t; ++o < e && (n *= 256);) this[r + o] = t / n & 255;
        return r + e
    }, s.prototype.writeUintBE = s.prototype.writeUIntBE = function(t, r, e, i) {
        if (t *= 1, r >>>= 0, e >>>= 0, !i) {
            let i = Math.pow(2, 8 * e) - 1;
            M(this, t, r, e, i, 0)
        }
        ...
        let n = 0,
            o = 1,
            f = 0;
        for (this[r] = 255 & t; ++n < e && (o *= 256);) t < 0 && 0 === f && 0 !== this[r + n - 1] && (f = 1), this[r + n] = (t / o | 0) - f & 255;
        return r + e
        ...
        let n = e - 1,
            o = 1,
            f = 0;
        for (this[r + n] = 255 & t; --n >= 0 && (o *= 256);) t < 0 && 0 === f && 0 !== this[r + n + 1] && (f = 1), this[r + n] = (t / o | 0) - f & 255;
        return r + e
        ...
        return A(this, t, r, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
        ...
        if (e || (e = 0), i || 0 === i || (i = this.length), r >= t.length && (r = t.length), r || (r = 0), i > 0 && i < e && (i = e), i === e || 0 === t.length || 0 === this.length) return 0;
        ...
        let n = i - e;
        return this === t && "function" == typeof Uint8Array.prototype.copyWithin ? this.copyWithin(r, e, i) : Uint8Array.prototype.set.call(t, this.subarray(e, i), r), n
    }, s.prototype.fill = function(t, r, e, i) {
        let n;
        if ("string" == typeof t) {
            if ("string" == typeof r ? (i = r, r = 0, e = this.length) : "string" == typeof e && (i = e, e = this.length), void 0 !== i && "string" != typeof i) throw TypeError("encoding must be a string");
    ...
    function U(t, r, e, i, n, o) {
        if (t > e || t < r) {
            let i, n = "bigint" == typeof r ? "n" : "";
            throw i = o > 3 ? 0 === r || r === BigInt(0) ? `>= 0${n} and < 2${n} ** ${(o+1)*8}${n}` : `>= -(2${n} ** ${(o+1)*8-1}${n}) and < 2 ** ${(o+1)*8-1}${n}` : `>= ${r}${n} and <= ${e}${n}`, new S.ERR_OUT_OF_RANGE("value", i, t)
        }
        R(n, "offset"), (void 0 === i[n] || void 0 === i[n + o]) && P(n, i.length - (o + 1))
    }

    function R(t, r) {
        if ("number" != typeof t) throw new S.ERR_INVALID_ARG_TYPE(r, "number", t)
    }

    function P(t, r, e) {
        if (Math.floor(t) !== t) throw R(t, e), new S.ERR_OUT_OF_RANGE(e || "offset", "an integer", t);
    ...
    }, RangeError), I("ERR_INVALID_ARG_TYPE", function(t, r) {
        return `The "${t}" argument must be of type number. Received type ${typeof r}`
    }, TypeError), I("ERR_OUT_OF_RANGE", function(t, r, e) {
        let i = `The value of "${t}" is out of range.`,
            n = e;
        return Number.isInteger(e) && Math.abs(e) > 0x100000000 ? n = O(String(e)) : "bigint" == typeof e && (n = String(e), (e > BigInt(2) ** BigInt(32) || e < -(BigInt(2) ** BigInt(32))) && (n = O(n)), n += "n"), i += ` It must be ${r}. Received ${n}`
    }, RangeError);
    let T = /[^+/0-9A-Za-z-_]/g;
    ...
    function k(t, r, e, i) {
        let n;
        for (n = 0; n < i && !(n + e >= r.length) && !(n >= t.length); ++n) r[n + e] = t[n];
        return n
    }
    ...
    ! function(t, r) {
        ...
        try {
            a = "u" > typeof window && void 0 !== window.Buffer ? window.Buffer : void 0
        } catch (t) {}
        ...
        function s(t, r, i, n) {
            for (var o = 0, f = 0, s = Math.min(t.length, i), h = r; h < s; h++) {
                ...
                o *= n, f = u >= 49 ? u - 49 + 10 : u >= 17 ? u - 17 + 10 : u, e(u >= 0 && f < n, "Invalid character"), o += f
            }
            return o
        }
        ...
        if (n.isBN = function(t) {
                ...
                var n = 0;
                "-" === (t = t.toString().replace(/\s+/g, ""))[0] && (n++, this.negative = 1), n < t.length && (16 === r ? this._parseHex(t, n, i) : (this._parseBase(t, r, n), "le" === i && this._initArray(this.toArray(), r, i)))
            }, n.prototype._initNumber = function(t, r, i) {
                t < 0 && (this.negative = 1, t = -t), t < 0x4000000 ? (this.words = [0x3ffffff & t], this.length = 1) : t < 0x10000000000000 ? (this.words = [0x3ffffff & t, t / 0x4000000 & 0x3ffffff], this.length = 2) : (e(t < 0x20000000000000), this.words = [0x3ffffff & t, t / 0x4000000 & 0x3ffffff, 1], this.length = 3), "le" === i && this._initArray(this.toArray(), r, i)
                ...
                var s = 0;
                if ("be" === i)
                    for (f = t.length - 1, n = 0; f >= 0; f -= 3) o = t[f] | t[f - 1] << 8 | t[f - 2] << 16, this.words[n] |= o << s & 0x3ffffff, this.words[n + 1] = o >>> 26 - s & 0x3ffffff, (s += 24) >= 26 && (s -= 26, n++);
                else if ("le" === i)
                    for (f = 0, n = 0; f < t.length; f += 3) o = t[f] | t[f + 1] << 8 | t[f + 2] << 16, this.words[n] |= o << s & 0x3ffffff, this.words[n + 1] = o >>> 26 - s & 0x3ffffff, (s += 24) >= 26 && (s -= 26, n++);
                return this._strip()
            }, n.prototype._parseHex = function(t, r, e) {
                this.length = Math.ceil((t.length - r) / 6), this.words = Array(this.length);
                for (var i, n = 0; n < this.length; n++) this.words[n] = 0;
                var o = 0,
                    s = 0;
                if ("be" === e)
                    for (n = t.length - 1; n >= r; n -= 2) i = f(t, r, n) << o, this.words[s] |= 0x3ffffff & i, o >= 18 ? (o -= 18, s += 1, this.words[s] |= i >>> 26) : o += 8;
                else
                    for (n = (t.length - r) % 2 == 0 ? r + 1 : r; n < t.length; n += 2) i = f(t, r, n) << o, this.words[s] |= 0x3ffffff & i, o >= 18 ? (o -= 18, s += 1, this.words[s] |= i >>> 26) : o += 8;
                this._strip()
            }, n.prototype._parseBase = function(t, r, e) {
                this.words = [0], this.length = 1;
                for (var i = 0, n = 1; n <= 0x3ffffff; n *= r) i++;
                i--, n = n / r | 0;
                for (var o = t.length - e, f = o % i, h = Math.min(o, o - f) + e, u = 0, a = e; a < h; a += i) u = s(t, a, a + i, r), this.imuln(n), this.words[0] + u < 0x4000000 ? this.words[0] += u : this._iaddn(u);
                if (0 !== f) {
                    var l = 1;
                    for (u = s(t, a, t.length, r), a = 0; a < f; a++) l *= r;
                    this.imuln(l), this.words[0] + u < 0x4000000 ? this.words[0] += u : this._iaddn(u)
                }
                this._strip()
        ...
        function y(t, r, e) {
            ...
            e.words[0] = s;
            for (var u = 1; u < i; u++) {
                for (var a = h >>> 26, l = 0x3ffffff & h, p = Math.min(u, r.length - 1), c = Math.max(0, u - t.length + 1); c <= p; c++) {
                    var y = u - c | 0;
                    a += (f = (n = 0 | t.words[y]) * (o = 0 | r.words[c]) + l) / 0x4000000 | 0, l = 0x3ffffff & f
                }
                e.words[u] = 0 | l, h = 0 | a
            }
        ...
        n.prototype.toString = function(t, r) {
            if (r = 0 | r || 1, 16 === (t = t || 10) || "hex" === t) {
                for (var i = "", n = 0, o = 0, f = 0; f < this.length; f++) {
                    ...
                    o = s >>> 24 - n & 0xffffff, (n += 2) >= 26 && (n -= 26, f--), i = 0 !== o || f !== this.length - 1 ? l[6 - h.length] + h + i : h + i
                }
            ...
            var t = this.words[0];
            return 2 === this.length ? t += 0x4000000 * this.words[1] : 3 === this.length && 1 === this.words[2] ? t += 0x10000000000000 + 0x4000000 * this.words[1] : this.length > 2 && e(!1, "Number can only safely store up to 53 bits"), 0 !== this.negative ? -t : t
        }, n.prototype.toJSON = function() {
            return this.toString(16, 2)
        }, a && (n.prototype.toBuffer = function(t, r) {
            ...
            var n = this.byteLength(),
                o = i || Math.max(1, n);
            e(n <= o, "byte array longer than desired length"), e(o > 0, "Requested array length <= 0");
            ...
            for (var e = 0, i = 0, n = 0, o = 0; n < this.length; n++) {
                ...
                t[e++] = 255 & f, e < t.length && (t[e++] = f >> 8 & 255), e < t.length && (t[e++] = f >> 16 & 255), 6 === o ? (e < t.length && (t[e++] = f >> 24 & 255), i = 0, o = 0) : (i = f >>> 24, o += 2)
            }
            if (e < t.length)
            ...
            for (var e = t.length - 1, i = 0, n = 0, o = 0; n < this.length; n++) {
                var f = this.words[n] << o | i;
                t[e--] = 255 & f, e >= 0 && (t[e--] = f >> 8 & 255), e >= 0 && (t[e--] = f >> 16 & 255), 6 === o ? (e >= 0 && (t[e--] = f >> 24 & 255), i = 0, o = 0) : (i = f >>> 24, o += 2)
            }
            if (e >= 0)
                for (t[e--] = i; e >= 0;) t[e--] = 0
            ...
            var r = t,
                e = 0;
            return (8191 & r) == 0 && (e += 13, r >>>= 13), (127 & r) == 0 && (e += 7, r >>>= 7), (15 & r) == 0 && (e += 4, r >>>= 4), (3 & r) == 0 && (e += 2, r >>>= 2), (1 & r) == 0 && e++, e
            ...
            for (var r, e, i = 0; i < e.length; i++) this.words[i] = r.words[i] ^ e.words[i];
            if (this !== r)
            ...
            for (var n = 0; n < r; n++) this.words[n] = 0x3ffffff & ~this.words[n];
            ...
            var i = t / 26 | 0,
                n = t % 26;
            return this._expand(i + 1), r ? this.words[i] = this.words[i] | 1 << n : this.words[i] = this.words[i] & ~(1 << n), this._strip()
            ...
            for (var r, e, i, n = 0, o = 0; o < i.length; o++) r = (0 | e.words[o]) + (0 | i.words[o]) + n, this.words[o] = 0x3ffffff & r, n = r >>> 26;
            for (; 0 !== n && o < e.length; o++) r = (0 | e.words[o]) + n, this.words[o] = 0x3ffffff & r, n = r >>> 26;
            ...
            for (var o = 0, f = 0; f < e.length; f++) o = (i = (0 | r.words[f]) - (0 | e.words[f]) + o) >> 26, this.words[f] = 0x3ffffff & i;
            for (; 0 !== o && f < r.length; f++) o = (i = (0 | r.words[f]) + o) >> 26, this.words[f] = 0x3ffffff & i;
            if (0 === o && f < r.length && r !== this)
                for (; f < r.length; f++) this.words[f] = r.words[f];
            return this.length = Math.max(this.length, f), r !== this && (this.negative = 1), this._strip()
        ...
        var m = function(t, r, e) {
            var i, n, o, f = t.words,
                ...
                ty = 8191 & tc,
                tm = tc >>> 13;
            e.negative = t.negative ^ r.negative, e.length = 19, i = Math.imul(l, q);
            var td = (u + i | 0) + ((8191 & (n = (n = Math.imul(l, D)) + Math.imul(p, q) | 0)) << 13) | 0;
            u = ((o = Math.imul(p, D)) + (n >>> 13) | 0) + (td >>> 26) | 0, td &= 0x3ffffff, i = Math.imul(y, q), n = (n = Math.imul(y, D)) + Math.imul(m, q) | 0, o = Math.imul(m, D), i = i + Math.imul(l, G) | 0;
            var tg = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, z) | 0) + Math.imul(p, G) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, z) | 0) + (n >>> 13) | 0) + (tg >>> 26) | 0, tg &= 0x3ffffff, i = Math.imul(g, q), n = (n = Math.imul(g, D)) + Math.imul(v, q) | 0, o = Math.imul(v, D), i = i + Math.imul(y, G) | 0, n = (n = n + Math.imul(y, z) | 0) + Math.imul(m, G) | 0, o = o + Math.imul(m, z) | 0, i = i + Math.imul(l, V) | 0;
            var tv = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, J) | 0) + Math.imul(p, V) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, J) | 0) + (n >>> 13) | 0) + (tv >>> 26) | 0, tv &= 0x3ffffff, i = Math.imul(b, q), n = (n = Math.imul(b, D)) + Math.imul(M, q) | 0, o = Math.imul(M, D), i = i + Math.imul(g, G) | 0, n = (n = n + Math.imul(g, z) | 0) + Math.imul(v, G) | 0, o = o + Math.imul(v, z) | 0, i = i + Math.imul(y, V) | 0, n = (n = n + Math.imul(y, J) | 0) + Math.imul(m, V) | 0, o = o + Math.imul(m, J) | 0, i = i + Math.imul(l, H) | 0;
            var tw = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, K) | 0) + Math.imul(p, H) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, K) | 0) + (n >>> 13) | 0) + (tw >>> 26) | 0, tw &= 0x3ffffff, i = Math.imul(A, q), n = (n = Math.imul(A, D)) + Math.imul(_, q) | 0, o = Math.imul(_, D), i = i + Math.imul(b, G) | 0, n = (n = n + Math.imul(b, z) | 0) + Math.imul(M, G) | 0, o = o + Math.imul(M, z) | 0, i = i + Math.imul(g, V) | 0, n = (n = n + Math.imul(g, J) | 0) + Math.imul(v, V) | 0, o = o + Math.imul(v, J) | 0, i = i + Math.imul(y, H) | 0, n = (n = n + Math.imul(y, K) | 0) + Math.imul(m, H) | 0, o = o + Math.imul(m, K) | 0, i = i + Math.imul(l, Q) | 0;
            var tb = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, tt) | 0) + Math.imul(p, Q) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, tt) | 0) + (n >>> 13) | 0) + (tb >>> 26) | 0, tb &= 0x3ffffff, i = Math.imul(B, q), n = (n = Math.imul(B, D)) + Math.imul(S, q) | 0, o = Math.imul(S, D), i = i + Math.imul(A, G) | 0, n = (n = n + Math.imul(A, z) | 0) + Math.imul(_, G) | 0, o = o + Math.imul(_, z) | 0, i = i + Math.imul(b, V) | 0, n = (n = n + Math.imul(b, J) | 0) + Math.imul(M, V) | 0, o = o + Math.imul(M, J) | 0, i = i + Math.imul(g, H) | 0, n = (n = n + Math.imul(g, K) | 0) + Math.imul(v, H) | 0, o = o + Math.imul(v, K) | 0, i = i + Math.imul(y, Q) | 0, n = (n = n + Math.imul(y, tt) | 0) + Math.imul(m, Q) | 0, o = o + Math.imul(m, tt) | 0, i = i + Math.imul(l, te) | 0;
            var tM = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, ti) | 0) + Math.imul(p, te) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, ti) | 0) + (n >>> 13) | 0) + (tM >>> 26) | 0, tM &= 0x3ffffff, i = Math.imul(O, q), n = (n = Math.imul(O, D)) + Math.imul(U, q) | 0, o = Math.imul(U, D), i = i + Math.imul(B, G) | 0, n = (n = n + Math.imul(B, z) | 0) + Math.imul(S, G) | 0, o = o + Math.imul(S, z) | 0, i = i + Math.imul(A, V) | 0, n = (n = n + Math.imul(A, J) | 0) + Math.imul(_, V) | 0, o = o + Math.imul(_, J) | 0, i = i + Math.imul(b, H) | 0, n = (n = n + Math.imul(b, K) | 0) + Math.imul(M, H) | 0, o = o + Math.imul(M, K) | 0, i = i + Math.imul(g, Q) | 0, n = (n = n + Math.imul(g, tt) | 0) + Math.imul(v, Q) | 0, o = o + Math.imul(v, tt) | 0, i = i + Math.imul(y, te) | 0, n = (n = n + Math.imul(y, ti) | 0) + Math.imul(m, te) | 0, o = o + Math.imul(m, ti) | 0, i = i + Math.imul(l, to) | 0;
            var tx = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, tf) | 0) + Math.imul(p, to) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, tf) | 0) + (n >>> 13) | 0) + (tx >>> 26) | 0, tx &= 0x3ffffff, i = Math.imul(P, q), n = (n = Math.imul(P, D)) + Math.imul(T, q) | 0, o = Math.imul(T, D), i = i + Math.imul(O, G) | 0, n = (n = n + Math.imul(O, z) | 0) + Math.imul(U, G) | 0, o = o + Math.imul(U, z) | 0, i = i + Math.imul(B, V) | 0, n = (n = n + Math.imul(B, J) | 0) + Math.imul(S, V) | 0, o = o + Math.imul(S, J) | 0, i = i + Math.imul(A, H) | 0, n = (n = n + Math.imul(A, K) | 0) + Math.imul(_, H) | 0, o = o + Math.imul(_, K) | 0, i = i + Math.imul(b, Q) | 0, n = (n = n + Math.imul(b, tt) | 0) + Math.imul(M, Q) | 0, o = o + Math.imul(M, tt) | 0, i = i + Math.imul(g, te) | 0, n = (n = n + Math.imul(g, ti) | 0) + Math.imul(v, te) | 0, o = o + Math.imul(v, ti) | 0, i = i + Math.imul(y, to) | 0, n = (n = n + Math.imul(y, tf) | 0) + Math.imul(m, to) | 0, o = o + Math.imul(m, tf) | 0, i = i + Math.imul(l, th) | 0;
            var tA = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, tu) | 0) + Math.imul(p, th) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, tu) | 0) + (n >>> 13) | 0) + (tA >>> 26) | 0, tA &= 0x3ffffff, i = Math.imul(N, q), n = (n = Math.imul(N, D)) + Math.imul(k, q) | 0, o = Math.imul(k, D), i = i + Math.imul(P, G) | 0, n = (n = n + Math.imul(P, z) | 0) + Math.imul(T, G) | 0, o = o + Math.imul(T, z) | 0, i = i + Math.imul(O, V) | 0, n = (n = n + Math.imul(O, J) | 0) + Math.imul(U, V) | 0, o = o + Math.imul(U, J) | 0, i = i + Math.imul(B, H) | 0, n = (n = n + Math.imul(B, K) | 0) + Math.imul(S, H) | 0, o = o + Math.imul(S, K) | 0, i = i + Math.imul(A, Q) | 0, n = (n = n + Math.imul(A, tt) | 0) + Math.imul(_, Q) | 0, o = o + Math.imul(_, tt) | 0, i = i + Math.imul(b, te) | 0, n = (n = n + Math.imul(b, ti) | 0) + Math.imul(M, te) | 0, o = o + Math.imul(M, ti) | 0, i = i + Math.imul(g, to) | 0, n = (n = n + Math.imul(g, tf) | 0) + Math.imul(v, to) | 0, o = o + Math.imul(v, tf) | 0, i = i + Math.imul(y, th) | 0, n = (n = n + Math.imul(y, tu) | 0) + Math.imul(m, th) | 0, o = o + Math.imul(m, tu) | 0, i = i + Math.imul(l, tl) | 0;
            var t_ = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, tp) | 0) + Math.imul(p, tl) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, tp) | 0) + (n >>> 13) | 0) + (t_ >>> 26) | 0, t_ &= 0x3ffffff, i = Math.imul(C, q), n = (n = Math.imul(C, D)) + Math.imul(F, q) | 0, o = Math.imul(F, D), i = i + Math.imul(N, G) | 0, n = (n = n + Math.imul(N, z) | 0) + Math.imul(k, G) | 0, o = o + Math.imul(k, z) | 0, i = i + Math.imul(P, V) | 0, n = (n = n + Math.imul(P, J) | 0) + Math.imul(T, V) | 0, o = o + Math.imul(T, J) | 0, i = i + Math.imul(O, H) | 0, n = (n = n + Math.imul(O, K) | 0) + Math.imul(U, H) | 0, o = o + Math.imul(U, K) | 0, i = i + Math.imul(B, Q) | 0, n = (n = n + Math.imul(B, tt) | 0) + Math.imul(S, Q) | 0, o = o + Math.imul(S, tt) | 0, i = i + Math.imul(A, te) | 0, n = (n = n + Math.imul(A, ti) | 0) + Math.imul(_, te) | 0, o = o + Math.imul(_, ti) | 0, i = i + Math.imul(b, to) | 0, n = (n = n + Math.imul(b, tf) | 0) + Math.imul(M, to) | 0, o = o + Math.imul(M, tf) | 0, i = i + Math.imul(g, th) | 0, n = (n = n + Math.imul(g, tu) | 0) + Math.imul(v, th) | 0, o = o + Math.imul(v, tu) | 0, i = i + Math.imul(y, tl) | 0, n = (n = n + Math.imul(y, tp) | 0) + Math.imul(m, tl) | 0, o = o + Math.imul(m, tp) | 0, i = i + Math.imul(l, ty) | 0;
            var tE = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(l, tm) | 0) + Math.imul(p, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(p, tm) | 0) + (n >>> 13) | 0) + (tE >>> 26) | 0, tE &= 0x3ffffff, i = Math.imul(C, G), n = (n = Math.imul(C, z)) + Math.imul(F, G) | 0, o = Math.imul(F, z), i = i + Math.imul(N, V) | 0, n = (n = n + Math.imul(N, J) | 0) + Math.imul(k, V) | 0, o = o + Math.imul(k, J) | 0, i = i + Math.imul(P, H) | 0, n = (n = n + Math.imul(P, K) | 0) + Math.imul(T, H) | 0, o = o + Math.imul(T, K) | 0, i = i + Math.imul(O, Q) | 0, n = (n = n + Math.imul(O, tt) | 0) + Math.imul(U, Q) | 0, o = o + Math.imul(U, tt) | 0, i = i + Math.imul(B, te) | 0, n = (n = n + Math.imul(B, ti) | 0) + Math.imul(S, te) | 0, o = o + Math.imul(S, ti) | 0, i = i + Math.imul(A, to) | 0, n = (n = n + Math.imul(A, tf) | 0) + Math.imul(_, to) | 0, o = o + Math.imul(_, tf) | 0, i = i + Math.imul(b, th) | 0, n = (n = n + Math.imul(b, tu) | 0) + Math.imul(M, th) | 0, o = o + Math.imul(M, tu) | 0, i = i + Math.imul(g, tl) | 0, n = (n = n + Math.imul(g, tp) | 0) + Math.imul(v, tl) | 0, o = o + Math.imul(v, tp) | 0, i = i + Math.imul(y, ty) | 0;
            var tB = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(y, tm) | 0) + Math.imul(m, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(m, tm) | 0) + (n >>> 13) | 0) + (tB >>> 26) | 0, tB &= 0x3ffffff, i = Math.imul(C, V), n = (n = Math.imul(C, J)) + Math.imul(F, V) | 0, o = Math.imul(F, J), i = i + Math.imul(N, H) | 0, n = (n = n + Math.imul(N, K) | 0) + Math.imul(k, H) | 0, o = o + Math.imul(k, K) | 0, i = i + Math.imul(P, Q) | 0, n = (n = n + Math.imul(P, tt) | 0) + Math.imul(T, Q) | 0, o = o + Math.imul(T, tt) | 0, i = i + Math.imul(O, te) | 0, n = (n = n + Math.imul(O, ti) | 0) + Math.imul(U, te) | 0, o = o + Math.imul(U, ti) | 0, i = i + Math.imul(B, to) | 0, n = (n = n + Math.imul(B, tf) | 0) + Math.imul(S, to) | 0, o = o + Math.imul(S, tf) | 0, i = i + Math.imul(A, th) | 0, n = (n = n + Math.imul(A, tu) | 0) + Math.imul(_, th) | 0, o = o + Math.imul(_, tu) | 0, i = i + Math.imul(b, tl) | 0, n = (n = n + Math.imul(b, tp) | 0) + Math.imul(M, tl) | 0, o = o + Math.imul(M, tp) | 0, i = i + Math.imul(g, ty) | 0;
            var tS = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(g, tm) | 0) + Math.imul(v, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(v, tm) | 0) + (n >>> 13) | 0) + (tS >>> 26) | 0, tS &= 0x3ffffff, i = Math.imul(C, H), n = (n = Math.imul(C, K)) + Math.imul(F, H) | 0, o = Math.imul(F, K), i = i + Math.imul(N, Q) | 0, n = (n = n + Math.imul(N, tt) | 0) + Math.imul(k, Q) | 0, o = o + Math.imul(k, tt) | 0, i = i + Math.imul(P, te) | 0, n = (n = n + Math.imul(P, ti) | 0) + Math.imul(T, te) | 0, o = o + Math.imul(T, ti) | 0, i = i + Math.imul(O, to) | 0, n = (n = n + Math.imul(O, tf) | 0) + Math.imul(U, to) | 0, o = o + Math.imul(U, tf) | 0, i = i + Math.imul(B, th) | 0, n = (n = n + Math.imul(B, tu) | 0) + Math.imul(S, th) | 0, o = o + Math.imul(S, tu) | 0, i = i + Math.imul(A, tl) | 0, n = (n = n + Math.imul(A, tp) | 0) + Math.imul(_, tl) | 0, o = o + Math.imul(_, tp) | 0, i = i + Math.imul(b, ty) | 0;
            var tI = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(b, tm) | 0) + Math.imul(M, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(M, tm) | 0) + (n >>> 13) | 0) + (tI >>> 26) | 0, tI &= 0x3ffffff, i = Math.imul(C, Q), n = (n = Math.imul(C, tt)) + Math.imul(F, Q) | 0, o = Math.imul(F, tt), i = i + Math.imul(N, te) | 0, n = (n = n + Math.imul(N, ti) | 0) + Math.imul(k, te) | 0, o = o + Math.imul(k, ti) | 0, i = i + Math.imul(P, to) | 0, n = (n = n + Math.imul(P, tf) | 0) + Math.imul(T, to) | 0, o = o + Math.imul(T, tf) | 0, i = i + Math.imul(O, th) | 0, n = (n = n + Math.imul(O, tu) | 0) + Math.imul(U, th) | 0, o = o + Math.imul(U, tu) | 0, i = i + Math.imul(B, tl) | 0, n = (n = n + Math.imul(B, tp) | 0) + Math.imul(S, tl) | 0, o = o + Math.imul(S, tp) | 0, i = i + Math.imul(A, ty) | 0;
            var tO = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(A, tm) | 0) + Math.imul(_, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(_, tm) | 0) + (n >>> 13) | 0) + (tO >>> 26) | 0, tO &= 0x3ffffff, i = Math.imul(C, te), n = (n = Math.imul(C, ti)) + Math.imul(F, te) | 0, o = Math.imul(F, ti), i = i + Math.imul(N, to) | 0, n = (n = n + Math.imul(N, tf) | 0) + Math.imul(k, to) | 0, o = o + Math.imul(k, tf) | 0, i = i + Math.imul(P, th) | 0, n = (n = n + Math.imul(P, tu) | 0) + Math.imul(T, th) | 0, o = o + Math.imul(T, tu) | 0, i = i + Math.imul(O, tl) | 0, n = (n = n + Math.imul(O, tp) | 0) + Math.imul(U, tl) | 0, o = o + Math.imul(U, tp) | 0, i = i + Math.imul(B, ty) | 0;
            var tU = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(B, tm) | 0) + Math.imul(S, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(S, tm) | 0) + (n >>> 13) | 0) + (tU >>> 26) | 0, tU &= 0x3ffffff, i = Math.imul(C, to), n = (n = Math.imul(C, tf)) + Math.imul(F, to) | 0, o = Math.imul(F, tf), i = i + Math.imul(N, th) | 0, n = (n = n + Math.imul(N, tu) | 0) + Math.imul(k, th) | 0, o = o + Math.imul(k, tu) | 0, i = i + Math.imul(P, tl) | 0, n = (n = n + Math.imul(P, tp) | 0) + Math.imul(T, tl) | 0, o = o + Math.imul(T, tp) | 0, i = i + Math.imul(O, ty) | 0;
            var tR = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(O, tm) | 0) + Math.imul(U, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(U, tm) | 0) + (n >>> 13) | 0) + (tR >>> 26) | 0, tR &= 0x3ffffff, i = Math.imul(C, th), n = (n = Math.imul(C, tu)) + Math.imul(F, th) | 0, o = Math.imul(F, tu), i = i + Math.imul(N, tl) | 0, n = (n = n + Math.imul(N, tp) | 0) + Math.imul(k, tl) | 0, o = o + Math.imul(k, tp) | 0, i = i + Math.imul(P, ty) | 0;
            var tP = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(P, tm) | 0) + Math.imul(T, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(T, tm) | 0) + (n >>> 13) | 0) + (tP >>> 26) | 0, tP &= 0x3ffffff, i = Math.imul(C, tl), n = (n = Math.imul(C, tp)) + Math.imul(F, tl) | 0, o = Math.imul(F, tp), i = i + Math.imul(N, ty) | 0;
            var tT = (u + i | 0) + ((8191 & (n = (n = n + Math.imul(N, tm) | 0) + Math.imul(k, ty) | 0)) << 13) | 0;
            u = ((o = o + Math.imul(k, tm) | 0) + (n >>> 13) | 0) + (tT >>> 26) | 0, tT &= 0x3ffffff, i = Math.imul(C, ty);
            var tj = (u + i | 0) + ((8191 & (n = (n = Math.imul(C, tm)) + Math.imul(F, ty) | 0)) << 13) | 0;
            return u = ((o = Math.imul(F, tm)) + (n >>> 13) | 0) + (tj >>> 26) | 0, tj &= 0x3ffffff, h[0] = td, h[1] = tg, h[2] = tv, h[3] = tw, h[4] = tb, h[5] = tM, h[6] = tx, h[7] = tA, h[8] = t_, h[9] = tE, h[10] = tB, h[11] = tS, h[12] = tI, h[13] = tO, h[14] = tU, h[15] = tR, h[16] = tP, h[17] = tT, h[18] = tj, 0 !== u && (h[19] = u, e.length++), e
        };
        ...
        function d(t, r, e) {
            ...
            for (var i = 0, n = 0, o = 0; o < e.length - 1; o++) {
                var f = n;
                n = 0;
                for (var s = 0x3ffffff & i, h = Math.min(o, r.length - 1), u = Math.max(0, o - t.length + 1); u <= h; u++) {
                    var a = o - u,
                        l = (0 | t.words[a]) * (0 | r.words[u]),
                        p = 0x3ffffff & l;
                    f = f + (l / 0x4000000 | 0) | 0, s = 0x3ffffff & (p = p + s | 0), n += (f = f + (p >>> 26) | 0) >>> 26, f &= 0x3ffffff
                }
                e.words[o] = s, i = f, f = n
            }
        ...
        Math.imul || (m = y), n.prototype.mulTo = function(t, r) {
            var e, i = this.length + t.length;
            return 10 === this.length && 10 === t.length ? e = m(this, t, r) : i < 63 ? e = y(this, t, r) : e = d(this, t, r), e
        }, g.prototype.makeRBT = function(t) {
            for (var r = Array(t), e = n.prototype._countBits(t) - 1, i = 0; i < t; i++) r[i] = this.revBin(i, e, t);
            return r
            ...
            for (var f = 1; f < n; f <<= 1)
                for (var s = f << 1, h = Math.cos(2 * Math.PI / s), u = Math.sin(2 * Math.PI / s), a = 0; a < n; a += s)
                    for (var l = h, p = u, c = 0; c < f; c++) {
                        var y = e[a + c],
                            ...
                            g = i[a + c + f],
                            v = l * d - p * g;
                        g = l * g + p * d, d = v, e[a + c] = y + d, i[a + c] = m + g, e[a + c + f] = y - d, i[a + c + f] = m - g, c !== s && (v = h * l - u * p, p = h * p + u * l, l = v)
                    }
            ...
            for (var e = 0, i = 0; i < r / 2; i++) {
                ...
                t[i] = 0x3ffffff & n, e = n < 0x4000000 ? 0 : n / 0x4000000 | 0
            }
            return t
        }, g.prototype.convert13b = function(t, r, i, n) {
            for (var o = 0, f = 0; f < r; f++) o += 0 | t[f], i[2 * f] = 8191 & o, o >>>= 13, i[2 * f + 1] = 8191 & o, o >>>= 13;
            ...
            var i = 2 * this.guessLen13b(t.length, r.length),
                ...
                l = Array(i),
                p = e.words;
            p.length = i, this.convert13b(t.words, t.length, f, i), this.convert13b(r.words, r.length, u, i), this.transform(f, o, s, h, i, n), this.transform(u, o, a, l, i, n);
            for (var c = 0; c < i; c++) {
                var y = s[c] * a[c] - h[c] * l[c];
                h[c] = s[c] * l[c] + h[c] * a[c], s[c] = y
            }
            return this.conjugate(s, h, i), this.transform(s, h, p, o, i, n), this.conjugate(p, o, i), this.normalize13b(p, i), e.negative = t.negative ^ r.negative, e.length = t.length + r.length, e._strip()
            ...
            return 0 !== i && (this.words[n] = i, this.length++), this.length = 0 === t ? 1 : this.length, r ? this.ineg() : this
            ...
            if (++i < r.length)
                for (var o = e.sqr(); i < r.length; i++, o = o.sqr()) 0 !== r[i] && (e = e.mul(o));
            return e
            ...
            return i && 0 !== u && (i.words[i.length++] = u), 0 === this.length && (this.words[0] = 0, this.length = 1), this._strip()
            ...
            var r = t % 26,
                i = (t - r) / 26;
            return (e(0 === this.negative, "imaskn works only with positive numbers"), this.length <= i) ? this : (0 !== r && i++, this.length = Math.min(i, this.length), 0 !== r && (this.words[this.length - 1] &= 0x3ffffff ^ 0x3ffffff >>> r << r), this._strip())
        }, n.prototype.maskn = function(t) {
            return this.clone().imaskn(t)
        }, n.prototype.iaddn = function(t) {
            return (e("number" == typeof t), e(t < 0x4000000), t < 0) ? this.isubn(-t) : 0 !== this.negative ? (1 === this.length && (0 | this.words[0]) <= t ? (this.words[0] = t - (0 | this.words[0]), this.negative = 0) : (this.negative = 0, this.isubn(t), this.negative = 1), this) : this._iaddn(t)
        }, n.prototype._iaddn = function(t) {
            this.words[0] += t;
            for (var r = 0; r < this.length && this.words[r] >= 0x4000000; r++) this.words[r] -= 0x4000000, r === this.length - 1 ? this.words[r + 1] = 1 : this.words[r + 1]++;
            return this.length = Math.max(this.length, r + 1), this
        }, n.prototype.isubn = function(t) {
            if (e("number" == typeof t), e(t < 0x4000000), t < 0) return this.iaddn(-t);
            if (0 !== this.negative) return this.negative = 0, this.iaddn(t), this.negative = 1, this;
            if (this.words[0] -= t, 1 === this.length && this.words[0] < 0) this.words[0] = -this.words[0], this.negative = 1;
            else
                for (var r = 0; r < this.length && this.words[r] < 0; r++) this.words[r] += 0x4000000, this.words[r + 1] -= 1;
            return this._strip()
            ...
            var n, o, f = t.length + i;
            this._expand(f);
            var s = 0;
            for (n = 0; n < t.length; n++) {
                o = (0 | this.words[n + i]) + s;
                var h = (0 | t.words[n]) * r;
                o -= 0x3ffffff & h, s = (o >> 26) - (h / 0x4000000 | 0), this.words[n + i] = 0x3ffffff & o
            }
            for (; n < this.length - i; n++) s = (o = (0 | this.words[n + i]) + s) >> 26, this.words[n + i] = 0x3ffffff & o;
            if (0 === s) return this._strip();
            for (e(-1 === s), s = 0, n = 0; n < this.length; n++) s = (o = -(0 | this.words[n]) + s) >> 26, this.words[n] = 0x3ffffff & o;
            ...
            0 != (i = 26 - this._countBits(s)) && (f = f.ushln(i), o.iushln(i), s = 0 | f.words[f.length - 1]);
            ...
            for (var l = h - 1; l >= 0; l--) {
                var p = (0 | o.words[f.length + l]) * 0x4000000 + (0 | o.words[f.length + l - 1]);
                for (p = Math.min(p / s | 0, 0x3ffffff), o._ishlnsubmul(f, p, l); 0 !== o.negative;) p--, o.negative = 0, o._ishlnsubmul(f, 1, l), o.isZero() || (o.negative ^= 1);
                e && (e.words[l] = p)
            }
            return e && e._strip(), o._strip(), "div" !== r && 0 !== i && o.iushrn(i), {
                div: e || null,
                mod: o
            }
            ...
            return (e(!t.isZero()), this.isZero()) ? {
                div: new n(0),
                mod: new n(0)
            } : 0 !== this.negative && 0 === t.negative ? (s = this.neg().divmod(t, r), "mod" !== r && (o = s.div.neg()), "div" !== r && (f = s.mod.neg(), i && 0 !== f.negative && f.iadd(t)), {
                div: o,
                mod: f
            }) : 0 === this.negative && 0 !== t.negative ? (s = this.divmod(t.neg(), r), "mod" !== r && (o = s.div.neg()), {
                div: o,
                mod: s.mod
            }) : (this.negative & t.negative) != 0 ? (s = this.neg().divmod(t.neg(), r), "div" !== r && (f = s.mod.neg(), i && 0 !== f.negative && f.isub(t)), {
                div: s.div,
                mod: f
            ...
            for (var o = new n(1), f = new n(0), s = new n(0), h = new n(1), u = 0; r.isEven() && i.isEven();) r.iushrn(1), i.iushrn(1), ++u;
            for (var a = i.clone(), l = r.clone(); !r.isZero();) {
                for (var p = 0, c = 1;
                    (r.words[0] & c) == 0 && p < 26; ++p, c <<= 1);
                if (p > 0)
                    for (r.iushrn(p); p-- > 0;)(o.isOdd() || f.isOdd()) && (o.iadd(a), f.isub(l)), o.iushrn(1), f.iushrn(1);
                for (var y = 0, m = 1;
                    (i.words[0] & m) == 0 && y < 26; ++y, m <<= 1);
                if (y > 0)
                    for (i.iushrn(y); y-- > 0;)(s.isOdd() || h.isOdd()) && (s.iadd(a), h.isub(l)), s.iushrn(1), h.iushrn(1);
                r.cmp(i) >= 0 ? (r.isub(i), o.isub(s), f.isub(h)) : (i.isub(r), s.isub(o), h.isub(f))
            }
            return {
                a: s,
                b: h,
            ...
            for (var f = new n(1), s = new n(0), h = o.clone(); i.cmpn(1) > 0 && o.cmpn(1) > 0;) {
                for (var u = 0, a = 1;
                    (i.words[0] & a) == 0 && u < 26; ++u, a <<= 1);
                if (u > 0)
                    for (i.iushrn(u); u-- > 0;) f.isOdd() && f.iadd(h), f.iushrn(1);
                for (var l = 0, p = 1;
                    (o.words[0] & p) == 0 && l < 26; ++l, p <<= 1);
                if (l > 0)
        ...
        function w(t, r) {
            this.name = t, this.p = new n(r, 16), this.n = this.p.bitLength(), this.k = new n(1).iushln(this.n).isub(this.p), this.tmp = this._tmp()
        }
        ...
        w.prototype._tmp = function() {
            ...
            var r, e = t;
            do this.split(e, this.tmp), r = (e = (e = this.imulK(e)).iadd(this.tmp)).bitLength(); while (r > this.n) var i = r < this.n ? -1 : e.ucmp(this.p);
        ...
        }, i(b, w), b.prototype.split = function(t, r) {
            ...
            for (var r = 0, e = 0; e < t.length; e++) {
                var i = 0 | t.words[e];
                r += 977 * i, t.words[e] = 0x3ffffff & r, r = 64 * i + (r / 0x4000000 | 0)
            }
            return 0 === t.words[t.length - 1] && (t.length--, 0 === t.words[t.length - 1] && t.length--), t
        }, i(M, w), i(x, w), i(A, w), A.prototype.imulK = function(t) {
            for (var r = 0, e = 0; e < t.length; e++) {
            ...
            e((t.negative | r.negative) == 0, "red works only with positives"), e(t.red && t.red === r.red, "red works only with red numbers")
            ...
            var s = new n(1).toRed(this),
                ...
                a = this.m.bitLength();
            for (a = new n(2 * a * a).toRed(this); 0 !== this.pow(a, u).cmp(h);) a.redIAdd(h);
            for (var l = this.pow(a, o), p = this.pow(t, o.addn(1).iushrn(1)), c = this.pow(t, o), y = f; 0 !== c.cmp(s);) {
            ...
            for (0 === h && (h = 26), i = r.length - 1; i >= 0; i--) {
                for (var u = r.words[i], a = h - 1; a >= 0; a--) {
                    ...
                    f <<= 1, f |= l, (4 == ++s || 0 === i && 0 === a) && (o = this.mul(o, e[f]), s = 0, f = 0)
                }
                h = 26
            }
            return o
    ...
    n.from && n.alloc && n.allocUnsafe && n.allocUnsafeSlow ? r.exports = i : (o(i, e), e.Buffer = f), f.prototype = Object.create(n.prototype), o(n, f), f.from = function(t, r, e) {
        ...
        var i = n(t);
        return void 0 !== r ? "string" == typeof e ? i.fill(r, e) : i.fill(r) : i.fill(0), i
    ...
    var i = Object.prototype.toString,
        ...
        f = function(t, r) {
            for (var e = [], i = r || 0, n = 0; i < t.length; i += 1, n += 1) e[n] = t[i];
            return e
        },
        s = function(t, r) {
            for (var e = "", i = 0; i < t.length; i += 1) e += t[i], i + 1 < t.length && (e += r);
            return e
        };
    r.exports = function(t) {
        var r, e = this;
        if ("function" != typeof e || "[object Function]" !== i.apply(e)) throw TypeError("Function.prototype.bind called on incompatible " + e);
        for (var h = f(arguments, 1), u = n(0, e.length - h.length), a = [], l = 0; l < u; l++) a[l] = "$" + l;
        if (r = Function("binder", "return function (" + s(a, ",") + "){ return binder.apply(this,arguments); }")(function() {
    ...
    var f = !!i && o && o(Object.prototype, "__proto__"),
        s = Object,
        h = s.getPrototypeOf;
    r.exports = f && "function" == typeof f.get ? n([f.get]) : "function" == typeof h && function(t) {
    ...
    var i = t.r(608435),
        ...
        P = {
            ...
            "%MapIteratorPrototype%": "u" > typeof Map && _ && E ? E(new Map()[Symbol.iterator]()) : void 0,
            "%Math%": Math,
            "%Number%": Number,
            "%Object%": i,
            ...
            "%SetIteratorPrototype%": "u" > typeof Set && _ && E ? E(new Set()[Symbol.iterator]()) : void 0,
    ...
    var j = function t(r) {
            ...
            else if ("%AsyncGeneratorFunction%" === r) e = w("async function* () {}");
        ...
        W = function(t, r) {
            ...
            if (L(N, i) && (i = "%" + (e = N[i])[0] + "%"), L(P, i)) {
                var n = P[i];
                if (n === U && (n = j(i)), void 0 === n && !r) throw new u("intrinsic " + t + " exists, but is not available. Please file an issue!");
                return {
                    alias: e,
                    name: i,
                    value: n
    ...
    r.exports = function(t, r) {
        ...
        if (null === D(/^%?[^%]*%?$/, t)) throw new h("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        var e = z(t),
            i = e.length > 0 ? e[0] : "",
            n = W("%" + i + "%", r),
            o = n.name,
        ...
        for (var l = 1, p = !0; l < e.length; l += 1) {
            var c = e[l],
                y = q(c, 0, 1),
                m = q(c, -1);
            if (('"' === y || "'" === y || "`" === y || '"' === m || "'" === m || "`" === m) && y !== m) throw new h("property names with quotes must have matching quotes");
            if ("constructor" !== c && p || (s = !0), i += "." + c, L(P, o = "%" + i + "%")) f = P[o];
            else if (null != f) {
                if (!(c in f)) {
                ...
                if (b && l + 1 >= e.length) {
                    var d = b(f, c);
                    f = (p = !!d) && "get" in d && !("originalValue" in d.get) ? d.get : f[c]
                } else p = L(f, c), f = f[c];
                p && !s && (P[o] = f)
            }
        }
    ...
    "use strict";
    var i, n, o = Function.prototype.toString,
        f = "object" == typeof Reflect && null !== Reflect && Reflect.apply;
    if ("function" == typeof f && "function" == typeof Object.defineProperty) try {
    ...
    if ("object" == typeof document) {
        var y = document.all;
        a.call(y) === a.call(document.all) && (c = function(t) {
    ...
    var i = t.r(719972),
        ...
        f = function(t, r, e) {
            for (var i = 0, n = t.length; i < n; i++) o.call(t, i) && (null == e ? r(t[i], i, t) : r.call(e, t[i], i, t))
        },
        s = function(t, r, e) {
            for (var i = 0, n = t.length; i < n; i++) null == e ? r(t.charAt(i), i, t) : r.call(e, t.charAt(i), i, t)
        },
        h = function(t, r, e) {
            for (var i in t) o.call(t, i) && (null == e ? r(t[i], i, t) : r.call(e, t[i], i, t))
        };
    r.exports = function(t, r, e) {
        var o;
        if (!i(r)) throw TypeError("iterator must be a function");
        (arguments.length >= 3 && (o = e), "[object Array]" === n.call(t)) ? f(t, r, o): "string" == typeof t ? s(t, r, o) : h(t, r, o)
    }
}, 482913, (t, r, e) => {
    "use strict";
    ...
    r.exports = function() {
        for (var t = [], r = 0; r < i.length; r++) "function" == typeof n[i[r]] && (t[t.length] = i[r]);
        return t
    }
}, 900077, (t, r, e) => {
    "use strict";
    ...
    r.exports = function(t, r, e) {
        ...
        if ("string" != typeof r && "symbol" != typeof r) throw new o("`property` must be a string or a symbol`");
        ...
        else if (!a && (s || h || u)) throw new n("This environment does not support defining a property as non-configurable, non-writable, or non-enumerable.");
        else t[r] = e
    }
}, 982703, (t, r, e) => {
    "use strict";
    ...
    r.exports = function(t, r) {
        ...
        if ("number" != typeof r || r < 0 || r > 0xffffffff || h(r) !== r) throw new s("`length` must be a positive 32-bit integer");
        ...
        return (i || u || !e) && (o ? n(t, "length", r, !0, !0) : n(t, "length", r)), t
    }
}, 557735, (t, r, e) => {
    "use strict";
    var i = t.r(932672),
    ...
    var i = t.r(58871),
        ...
        y = f("Array.prototype.indexOf", !0) || function(t, r) {
    ...
    "function" == typeof Object.create ? r.exports = function(t, r) {
    ...
    n.from && n.alloc && n.allocUnsafe && n.allocUnsafeSlow ? r.exports = i : (o(i, e), e.Buffer = f), o(n, f), f.from = function(t, r, e) {
        if ("number" == typeof t) throw TypeError("Argument must not be a number");
        return n(t, r, e)
    }, f.alloc = function(t, r, e) {
        if ("number" != typeof t) throw TypeError("Argument must be a number");
    ...
    function o(t) {
        ...
        switch (this.encoding = function(t) {
            ...
            if ("string" != typeof r && (i.isEncoding === n || !n(t))) throw Error("Unknown encoding: " + t);
            return r || t
        }(t), this.encoding) {
            case "utf16le":
        ...
        var r = this.lastTotal - this.lastNeed,
            e = function(t, r, e) {
                ...
                if (t.lastNeed > 1 && r.length > 1) {
                    ...
                    if (t.lastNeed > 2 && r.length > 2 && (192 & r[2]) != 128) return t.lastNeed = 2, "�"
                }
            }(this, t, 0);
        return void 0 !== e ? e : this.lastNeed <= t.length ? (t.copy(this.lastChar, r, 0, this.lastNeed), this.lastChar.toString(this.encoding, 0, this.lastTotal)) : void(t.copy(this.lastChar, r, 0, t.length), this.lastNeed -= t.length)
    }
    ...
    function h(t, r) {
        if ((t.length - r) % 2 == 0) {
            ...
            if (e) {
                ...
                if (i >= 55296 && i <= 56319) return this.lastNeed = 2, this.lastTotal = 4, this.lastChar[0] = t[t.length - 2], this.lastChar[1] = t[t.length - 1], e.slice(0, -1)
            }
            return e
        }
        return this.lastNeed = 1, this.lastTotal = 2, this.lastChar[0] = t[t.length - 1], t.toString("utf16le", r, t.length - 1)
    }
    ...
    function a(t, r) {
        var e = (t.length - r) % 3;
        return 0 === e ? t.toString("base64", r) : (this.lastNeed = 3 - e, this.lastTotal = 3, 1 === e ? this.lastChar[0] = t[t.length - 1] : (this.lastChar[0] = t[t.length - 2], this.lastChar[1] = t[t.length - 1]), t.toString("base64", r, t.length - e))
    }
    ...
    e.StringDecoder = o, o.prototype.write = function(t) {
        ...
        var e = function(t, r, e) {
            ...
            if (i < e) return 0;
            var n = f(r[i]);
            return n >= 0 ? (n > 0 && (t.lastNeed = n - 1), n) : --i < e || -2 === n ? 0 : (n = f(r[i])) >= 0 ? (n > 0 && (t.lastNeed = n - 2), n) : --i < e || -2 === n ? 0 : (n = f(r[i])) >= 0 ? (n > 0 && (2 === n ? n = 0 : t.lastNeed = n - 3), n) : 0
        }(this, t, r);
