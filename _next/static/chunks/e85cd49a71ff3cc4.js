(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 595932, e => {
    "use strict";
    ...
    t.exports = function(e) {
        ...
        function d(e) {
            ...
            for (var s = (e.length - r) * c + 1 >>> 0, l = new Uint8Array(s); r < e.length;) {
                ...
                if (255 === h) return;
                for (var f = 0, p = s - 1;
                    (0 !== h || f < o) && -1 !== p; p--, f++) h += a * l[p] >>> 0, l[p] = h % 256 >>> 0, h = h / 256 >>> 0;
        ...
        return {
            encode: function(t) {
                ...
                for (var c = (s - o) * l + 1 >>> 0, d = new Uint8Array(c); o !== s;) {
                    for (var h = t[o], f = 0, p = c - 1;
                        (0 !== h || f < i) && -1 !== p; p--, f++) h += 256 * d[p] >>> 0, d[p] = h % a >>> 0, h = h / a >>> 0;
                    if (0 !== h) throw Error("Non-zero carry");
                    i = f, o++
                }
    ...
    t.exports = e.r(313227)("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz")
}, 217944, (e, t, r) => {
    "use strict";
    var n = e.r(242524).Buffer;
    t.exports = function(e) {
    ...
    t.exports = e.r(217944)("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz")
}, 572766, (e, t, r) => {
    "use strict";
    ...
    function u(e, t) {
        ...
        t = i(t), this._streaming = !1, this._BOMseen = !1, this._decoder = null, this._fatal = !!t.fatal, this._ignoreBOM = !!t.ignoreBOM, Object.defineProperty(this, "encoding", {
            value: "utf-8"
    ...
    function l(e) {
        ...
        this.handler = function(e, c) {
            ...
            if (0 === o) {
                ...
                else if (n(c, 224, 239)) 224 === c && (a = 160), 237 === c && (u = 159), o = 2, r = c - 224;
                else {
                    if (!n(c, 240, 244)) return s(t);
                    240 === c && (a = 144), 244 === c && (u = 143), o = 3, r = c - 240
                }
                return r <<= 6 * o, null
            }
            if (!n(c, a, u)) return r = o = i = 0, a = 128, u = 191, e.prepend(c), s(t);
            if (a = 128, u = 191, i += 1, r += c - 128 << 6 * (o - i), i !== o) return null;
            var l = r;
            return r = o = i = 0, l
        }
    }
    ...
    function d(e) {
        e.fatal, this.handler = function(e, t) {
            ...
            n(t, 128, 2047) ? (r = 1, i = 192) : n(t, 2048, 65535) ? (r = 2, i = 224) : n(t, 65536, 1114111) && (r = 3, i = 240);
    ...
    u.prototype = {
        decode: function(e, t) {
            r = "object" == typeof e && e instanceof ArrayBuffer ? new Uint8Array(e) : "object" == typeof e && "buffer" in e && e.buffer instanceof ArrayBuffer ? new Uint8Array(e.buffer, e.byteOffset, e.byteLength) : new Uint8Array(0), t = i(t), this._streaming || (this._decoder = new l({
                fatal: this._fatal
            }), this._BOMseen = !1), this._streaming = !!t.stream;
            for (var r, n, s = new o(r), a = []; !s.endOfStream() && -1 !== (n = this._decoder.handler(s, s.read()));) null !== n && (Array.isArray(n) ? a.push.apply(a, n) : a.push(n));
            if (!this._streaming) {
                do {
            ...
            for (var u = "", c = 0; c < a.length; ++c) {
                var d = a[c];
                d <= 65535 ? u += String.fromCharCode(d) : (d -= 65536, u += String.fromCharCode((d >> 10) + 55296, (1023 & d) + 56320))
            }
            return u
        }
    }, c.prototype = {
        encode: function(e, t) {
            e = e ? String(e) : "", t = i(t), this._streaming || (this._encoder = new d(this._options)), this._streaming = !!t.stream;
            for (var r, n = [], s = new o(function(e) {
                    ...
                    return i
                }(e)); !s.endOfStream() && -1 !== (r = this._encoder.handler(s, s.read()));) Array.isArray(r) ? n.push.apply(n, r) : n.push(r);
            if (!this._streaming) {
                for (; - 1 !== (r = this._encoder.handler(s, s.read()));) Array.isArray(r) ? n.push.apply(n, r) : n.push(r);
                this._encoder = null
            }
            return new Uint8Array(n)
        }
    }, r.TextEncoder = c, r.TextDecoder = u
}, 154119, (e, t, r) => {
    "use strict";
    var n = e.i(467034),
        i = e.e && e.e.__createBinding || (Object.create ? function(e, t, r, n) {
        ...
        o = e.e && e.e.__setModuleDefault || (Object.create ? function(e, t) {
        ...
        s = e.e && e.e.__decorate || function(e, t, r, n) {
        ...
        a = e.e && e.e.__importStar || function(e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e)
                for (var r in e) "default" !== r && Object.hasOwnProperty.call(e, r) && i(t, e, r);
            return o(t, e), t
        },
        u = e.e && e.e.__importDefault || function(e) {
    ...
    let c = u(e.r(910490)),
        l = u(e.r(701262)),
        d = a(e.r(572766)),
        h = new("function" != typeof TextDecoder ? d.TextDecoder : TextDecoder)("utf-8", {
            fatal: !0
        });
    r.baseEncode = function(e) {
        return "string" == typeof e && (e = n.Buffer.from(e, "utf8")), l.default.encode(n.Buffer.from(e))
    ...
    class p {
        ...
        maybeResize() {
            this.buf.length < 16 + this.length && (this.buf = n.Buffer.concat([this.buf, n.Buffer.alloc(1024)]))
        }
        writeU8(e) {
        ...
        writeU64(e) {
            this.maybeResize(), this.writeBuffer(n.Buffer.from(new c.default(e).toArray("le", 8)))
        }
        writeU128(e) {
            this.maybeResize(), this.writeBuffer(n.Buffer.from(new c.default(e).toArray("le", 16)))
        }
        writeU256(e) {
            this.maybeResize(), this.writeBuffer(n.Buffer.from(new c.default(e).toArray("le", 32)))
        }
        writeU512(e) {
            this.maybeResize(), this.writeBuffer(n.Buffer.from(new c.default(e).toArray("le", 64)))
        }
        writeBuffer(e) {
            this.buf = n.Buffer.concat([n.Buffer.from(this.buf.subarray(0, this.length)), e, n.Buffer.alloc(1024)]), this.length += e.length
        }
        writeString(e) {
            this.maybeResize();
        ...
        writeArray(e, t) {
            for (let r of (this.maybeResize(), this.writeU32(e.length), e)) this.maybeResize(), t(r)
        }
        toArray() {
    ...
    function g(e, t, r) {
        ...
        r.value = function(...e) {
            try {
                ...
                if (e instanceof RangeError && ["ERR_BUFFER_OUT_OF_BOUNDS", "ERR_OUT_OF_RANGE"].indexOf(e.code) >= 0) throw new f("Reached the end of buffer when deserializing");
                throw e
            }
        }
    }
    ...
    class y {
        ...
        readBuffer(e) {
            if (this.offset + e > this.buf.length) throw new f(`Expected buffer length ${e} isn't within bounds`);
        ...
        try {
            if ("string" == typeof n) i[`write${b(n)}`](r);
                ...
                if ("number" == typeof n[0]) {
                    if (r.length !== n[0]) throw new f(`Expecting byte array of length ${n[0]}, but got ${r.length} bytes`);
                    i.writeFixedArray(r)
                } else if (2 === n.length && "number" == typeof n[1]) {
                if (r.length !== n[1]) throw new f(`Expecting byte array of length ${n[1]}, but got ${r.length} bytes`);
    ...
    function w(e, t, r) {
        if ("function" == typeof t.borshSerialize) return void t.borshSerialize(r);
        ...
        } else throw new f(`Unexpected schema kind: ${n.kind} for ${t.constructor.name}`)
    }
        ...
        try {
            ...
            if (r instanceof Array)
                if ("number" == typeof r[0]) return n.readFixedArray(r[0]);
                    ...
                    if ("number" != typeof r[1]) return n.readArray(() => k(e, t, r[0], n));
                    let i = [];
    ...
    function S(e, t, r) {
        ...
        if ("enum" === n.kind) {
            let i = r.readU8();
            if (i >= n.values.length) throw new f(`Enum index: ${i} is out of range`);
            let [o, s] = n.values[i], a = k(e, o, s, r);
            return new t({
                [o]: a
            })
        }
        throw new f(`Unexpected schema kind: ${n.kind} for ${t.constructor.name}`)
    }
    s([g], y.prototype, "readU8", null), s([g], y.prototype, "readU16", null), s([g], y.prototype, "readU32", null), s([g], y.prototype, "readU64", null), s([g], y.prototype, "readU128", null), s([g], y.prototype, "readU256", null), s([g], y.prototype, "readU512", null), s([g], y.prototype, "readString", null), s([g], y.prototype, "readFixedArray", null), s([g], y.prototype, "readArray", null), r.BinaryReader = y, r.serialize = function(e, t, r = p) {
        let n = new r;
        return w(e, t, n), n.toArray()
    }, r.deserialize = function(e, t, r, n = y) {
        let i = new n(r),
            o = S(e, t, i);
        if (i.offset < r.length) throw new f(`Unexpected ${r.length-i.offset} bytes after deserialized data`);
        return o
    ...
    r.Layout = s, r.nameWithProperty = a, r.bindConstructorLayout = function(e, t) {
        if ("function" != typeof e) throw TypeError("Class must be constructor");
        if (Object.prototype.hasOwnProperty.call(e, "layout_")) throw Error("Class is already bound to a layout");
        if (!(t && t instanceof s)) throw TypeError("layout must be a Layout");
        if (Object.prototype.hasOwnProperty.call(t, "boundConstructor_")) throw Error("layout is already bound to a constructor");
    ...
    class c extends u {
        constructor(e = 1, t) {
            if (!Number.isInteger(e) || 0 >= e) throw TypeError("elementSpan must be a (positive) integer");
    ...
    class l extends u {
        constructor(e, t = 0, r) {
            ...
            if (!Number.isInteger(t)) throw TypeError("offset must be integer or undefined");
    ...
    class I extends s {
        constructor(e, t, r) {
            if (!(e instanceof s)) throw TypeError("elementLayout must be a Layout");
            if (!(t instanceof u && t.isCount() || Number.isInteger(t) && 0 <= t)) throw TypeError("count must be non-negative integer or an unsigned integer ExternalLayout");
            let n = -1;
            t instanceof u || !(0 < e.span) || (n = t * e.span), super(n, r), this.elementLayout = e, this.count = t
        }
        getSpan(e, t = 0) {
            if (0 <= this.span) return this.span;
            let r = 0,
                n = this.count;
            if (n instanceof u && (n = n.decode(e, t)), 0 < this.elementLayout.span) r = n * this.elementLayout.span;
            else {
                let i = 0;
        ...
        decode(e, t = 0) {
            let r = [],
                n = 0,
                i = this.count;
            for (i instanceof u && (i = i.decode(e, t)); n < i;) r.push(this.elementLayout.decode(e, t)), t += this.elementLayout.getSpan(e, t), n += 1;
            return r
        }
        encode(e, t, r = 0) {
    ...
    class A extends s {
        constructor(e, t, r) {
            if (!(Array.isArray(e) && e.reduce((e, t) => e && t instanceof s, !0))) throw TypeError("fields must be array of Layout instances");
            for (const n of ("boolean" == typeof t && void 0 === r && (r = t, t = void 0), e))
    ...
    class R extends x {
        constructor(e, t) {
            if (!(e instanceof u && e.isCount())) throw TypeError("layout must be an unsigned integer ExternalLayout");
    ...
    class P extends s {
        constructor(e, t, r) {
            ...
            if (void 0 === t && (t = null), !(null === t || t instanceof s)) throw TypeError("defaultLayout must be null or a Layout");
            if (null !== t) {
                if (0 > t.span) throw Error("defaultLayout must have constant span");
                void 0 === t.property && (t = t.replicate("content"))
            }
            let i = -1;
            t && 0 <= (i = t.span) && (e instanceof d || e instanceof h) && (i += n.layout.span), super(i, r), this.discriminator = n, this.usesPrefixDiscriminator = e instanceof d || e instanceof h, this.defaultLayout = t, this.registry = {};
        ...
        decode(e, t = 0) {
            let r, n = this.discriminator,
                i = n.decode(e, t),
                o = this.registry[i];
            if (void 0 === o) {
                let o = this.defaultLayout,
                    s = 0;
                this.usesPrefixDiscriminator && (s = n.layout.span), (r = this.makeDestinationObject())[n.property] = i, r[o.property] = o.decode(e, t + s)
            } else r = o.decode(e, t);
            return r
        }
        encode(e, t, r = 0) {
    ...
    class B extends s {
        constructor(e, t, r, n) {
            ...
            let i = e.span;
            0 > e.span && 0 <= (i = r ? r.span : 0) && e.usesPrefixDiscriminator && (i += e.discriminator.layout.span), super(i, n), this.union = e, this.variant = t, this.layout = r || null
        }
        getSpan(e, t = 0) {
            if (0 <= this.span) return this.span;
            let r = 0;
        ...
        decode(e, t = 0) {
            let r = this.makeDestinationObject();
            if (this !== this.union.getVariant(e, t)) throw Error("variant mismatch");
            let n = 0;
        ...
        encode(e, t, r = 0) {
            let n = 0;
            if (this.union.usesPrefixDiscriminator && (n = this.union.discriminator.layout.span), this.layout && !Object.prototype.hasOwnProperty.call(e, this.property)) throw TypeError("variant lacks property " + this.property);
    ...
    class O extends s {
        constructor(e, t, r) {
            if (!(e instanceof d || e instanceof h)) throw TypeError("word must be a UInt or UIntBE layout");
            if ("string" == typeof t && void 0 === r && (r = t, t = !1), 4 < e.span) throw RangeError("word cannot exceed 32 bits");
        ...
        decode(e, t = 0) {
            ...
            for (let t of (this._packedSetValue(n), this.fields)) void 0 !== t.property && (r[t.property] = t.decode(e));
            return r
        }
        encode(e, t, r = 0) {
    ...
    class C {
        constructor(e, t, r) {
            if (!(e instanceof O)) throw TypeError("container must be a BitStructure");
            ...
            this.container = e, this.bits = t, this.valueMask = (1 << t) - 1, 32 === t && (this.valueMask = 0xffffffff), this.start = i, this.container.msb && (this.start = n - i - t), this.wordMask = T(this.valueMask << this.start), this.property = r
        }
        decode(e, t) {
            return T(this.container._packedGetValue() & this.wordMask) >>> this.start
        }
        encode(e) {
            if ("number" != typeof e || !Number.isInteger(e) || e !== T(e & this.valueMask)) throw TypeError(a("BitField.encode", this) + " value must be integer not exceeding " + this.valueMask);
    ...
    class N extends s {
        constructor(e, t) {
            if (!(e instanceof u && e.isCount() || Number.isInteger(e) && 0 <= e)) throw TypeError("length must be positive integer or an unsigned integer ExternalLayout");
            let r = -1;
        ...
        encode(e, t, r) {
            let n = this.length;
            if (this.length instanceof u && (n = e.length), !(e instanceof Uint8Array && n === e.length)) throw TypeError(a("Blob.encode", this) + " requires (length " + n + ") Uint8Array as src");
            if (r + n > t.length) throw RangeError("encoding overruns Uint8Array");
            let i = o(e);
            return o(t).write(i.toString("hex"), r, n, "hex"), this.length instanceof u && this.length.encode(n, t, r), n
        }
    }
    r.Blob = N;
    class U extends s {
        ...
        decode(e, t = 0) {
            ...
            return o(e).slice(t, t + r - 1).toString("utf-8")
        }
        encode(e, t, r = 0) {
    ...
    class M extends s {
        ...
        decode(e, t = 0) {
            ...
            return o(e).slice(t, t + r).toString("utf-8")
        }
        encode(e, t, r = 0) {
            "string" != typeof e && (e = String(e));
            let i = n.Buffer.from(e, "utf8"),
    ...
    r.Constant = z, r.greedy = (e, t) => new c(e, t), r.offset = (e, t, r) => new l(e, t, r), r.u8 = e => new d(1, e), r.u16 = e => new d(2, e), r.u24 = e => new d(3, e), r.u32 = e => new d(4, e), r.u40 = e => new d(5, e), r.u48 = e => new d(6, e), r.nu64 = e => new b(e), r.u16be = e => new h(2, e), r.u24be = e => new h(3, e), r.u32be = e => new h(4, e), r.u40be = e => new h(5, e), r.u48be = e => new h(6, e), r.nu64be = e => new m(e), r.s8 = e => new f(1, e), r.s16 = e => new f(2, e), r.s24 = e => new f(3, e), r.s32 = e => new f(4, e), r.s40 = e => new f(5, e), r.s48 = e => new f(6, e), r.ns64 = e => new w(e), r.s16be = e => new p(2, e), r.s24be = e => new p(3, e), r.s32be = e => new p(4, e), r.s40be = e => new p(5, e), r.s48be = e => new p(6, e), r.ns64be = e => new k(e), r.f32 = e => new S(e), r.f32be = e => new v(e), r.f64 = e => new _(e), r.f64be = e => new E(e), r.struct = (e, t, r) => new A(e, t, r), r.bits = (e, t, r) => new O(e, t, r), r.seq = (e, t, r) => new I(e, t, r), r.union = (e, t, r) => new P(e, t, r), r.unionLayoutDiscriminator = (e, t) => new R(e, t), r.blob = (e, t) => new N(e, t), r.cstr = e => new U(e), r.utf8 = (e, t) => new M(e, t), r.constant = (e, t) => new z(e, t)
}, 214303, 640512, 770134, e => {
    "use strict";
    var t, r = e.i(44314),
        n = e.i(470525),
        i = e.i(810588),
    ...
    let f = BigInt(0),
        ...
        b = BigInt(5),
        m = BigInt(8),
        w = BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffed"),
        k = {
            p: w,
    ...
    function v(e, t) {
        var r;
        let n, i, o, a, u, c, l, d, h, f, y, m, k, v, _ = (0, s.mod)(t * t * t, w),
            E = (r = e * (0, s.mod)(_ * _ * t, w), n = BigInt(10), i = BigInt(20), o = BigInt(40), a = BigInt(80), u = r * r % w * r % w, c = (0, s.pow2)(u, g, w) * u % w, l = (0, s.pow2)(c, p, w) * r % w, d = (0, s.pow2)(l, b, w) * l % w, h = (0, s.pow2)(d, n, w) * d % w, f = (0, s.pow2)(h, i, w) * h % w, y = (0, s.pow2)(f, o, w) * f % w, m = (0, s.pow2)(y, a, w) * y % w, k = (0, s.pow2)(m, a, w) * y % w, v = (0, s.pow2)(k, n, w) * d % w, {
                pow_p_5_8: (0, s.pow2)(v, g, w) * r % w,
                b2: u
            }).pow_p_5_8,
            I = (0, s.mod)(e * _ * E, w),
            A = (0, s.mod)(t * I * I, w),
            ...
            B = A === (0, s.mod)(-e, w),
            T = A === (0, s.mod)(-e * S, w);
        return P && (I = x), (B || T) && (I = R), (0, s.isNegativeLE)(I, w) && (I = (0, s.mod)(-I, w)), {
            isValid: P || B,
            value: I
        }
    }
            ...
            let t, r, d, h, {
                ...
                b = function(e, t, r = {}) {
                    ...
                    let {
                        ...
                        Fp: a,
                        Fn: c
                    } = e, l = r.randomBytes || n.randomBytes, d = r.adjustScalarBytes || (e => e), h = r.domain || ((e, t, r) => {
                        if ((0, o._abool2)(r, "phflag"), t.length || r) throw Error("Contexts/pre-hash are not supported");
                        return e
                    });
                    ...
                    function p(e) {
                        ...
                        let n, i, a, u, c, {
                                ...
                                prefix: h,
                                scalar: p
                            } = (r = e, n = w.secretKey, r = (0, o.ensureBytes)("private key", r, n), a = d((i = (0, o.ensureBytes)("hashed private key", t(r), 2 * n)).slice(0, n)), u = i.slice(n, 2 * n), c = f(a), {
                                head: a,
                                prefix: u,
                                scalar: c
                            }),
                    ...
                    function y(e = Uint8Array.of(), ...r) {
                        return f(t(h((0, n.concatBytes)(...r), (0, o.ensureBytes)("context", e), !!i)))
                    }
                    let b = {
                            zip215: !0
                        },
                    ...
                    let S = {
                        ...
                        toMontgomery(t) {
                            let {
                                y: r
                            } = e.fromBytes(t), n = w.publicKey, i = 32 === n;
                        ...
                        toMontgomerySecret(e) {
                            let r = w.secretKey;
                            return (0, o._abytes2)(e, r), d(t(e.subarray(0, r))).subarray(0, r)
                        },
                        randomPrivateKey: k,
                    ...
                    return Object.freeze({
                        ...
                        sign: function(e, t, r = {}) {
                            ...
                            let {
                                ...
                                scalar: u,
                                pointBytes: l
                            } = p(t), d = y(r.context, a, e), h = s.multiply(d).toBytes(), f = y(r.context, h, l, e), g = c.create(d + f * u);
                        ...
                        verify: function(t, r, n, a = b) {
                            let u, c, l, {
                                ...
                                f = w.signature;
                            t = (0, o.ensureBytes)("signature", t, f), r = (0, o.ensureBytes)("message", r), n = (0, o.ensureBytes)("publicKey", n, w.publicKey), void 0 !== h && (0, o._abool2)(h, "zip215"), i && (r = i(r));
                            let p = f / 2,
                                g = t.subarray(0, p),
                                m = (0, o.bytesToNumberLE)(t.subarray(p, f));
                            try {
                                u = e.fromBytes(n, h), c = e.fromBytes(g, h), l = s.multiplyUnsafe(m)
                            } catch (e) {
                                return !1
                            }
                            if (!h && u.isSmallOrder()) return !1;
                            let k = y(d, c.toBytes(), u.toBytes(), r);
                            return c.add(u.multiplyUnsafe(k)).subtract(l).clearCofactor().is0()
                        },
                        utils: S,
                        Point: e,
                        lengths: w
                    ...
                    var r, s;
                    let d, h, f, p, g, y = (0, i._createCurveFields)("edwards", e, t, t.FpFnLE),
                        {
                            Fp: b,
                            Fn: m
                        } = y,
                    ...
                    if (r = w.Gx, s = w.Gy, d = b.sqr(r), h = b.sqr(s), f = b.add(b.mul(w.a, d), h), p = b.add(b.ONE, b.mul(w.d, b.mul(d, h))), !b.eql(f, p)) throw Error("bad curve params: generator point");
                    ...
                    let I = (0, o.memoized)((e, t) => {
                        ...
                        A = (0, o.memoized)(e => {
                            ...
                            let {
                                ...
                                Z: m,
                                T: k
                            } = e, S = (t = g * g, b.create(t)), v = (r = y * y, b.create(r)), _ = (n = m * m, b.create(n)), E = (i = _ * _, b.create(i));
                            if (a = _ * (o = S * f, s = b.create(o) + v, b.create(s)), b.create(a) !== (l = E + (c = p * (u = S * v, b.create(u)), b.create(c)), b.create(l))) throw Error("bad point: equation left != right (1)");
                            if (d = g * y, b.create(d) !== (h = m * k, b.create(h))) throw Error("bad point: equation left != right (2)");
                            return !0
                        });
                    class x {
                        constructor(e, t, r, n) {
                            this.X = _("x", e), this.Y = _("y", t), this.Z = _("z", r, !0), this.T = _("t", n), Object.freeze(this)
                        }
                        static CURVE() {
                            return w
                        }
                        static fromAffine(e) {
                            ...
                            return _("x", r), _("y", n), new x(r, n, u, (t = r * n, b.create(t)))
                        }
                        static fromBytes(e, t = !1) {
                            let r, n, i, s, c = b.BYTES,
                                {
                                    a: l,
                                    d
                                } = w;
                            e = (0, o.copyBytes)((0, o._abytes2)(e, c, "point")), (0, o._abool2)(t, "zip215");
                            ...
                            let y = (r = p * p, b.create(r)),
                                {
                                    isValid: m,
                                    value: k
                                } = v((n = y - u, b.create(n)), (i = d * y - l, b.create(i)));
                            if (!m) throw Error("bad point: invalid y coordinate");
                            let _ = (k & u) === u,
                                E = (128 & f) != 0;
                            if (!t && k === a && E) throw Error("bad point: x=0 and x_0=1");
                            return E !== _ && (s = -k, k = b.create(s)), x.fromAffine({
                                x: k,
                                y: p
                            })
                        }
                        ...
                        equals(e) {
                            ...
                            let {
                                ...
                                Y: c,
                                Z: l
                            } = e, d = (t = o * l, b.create(t)), h = (r = u * a, b.create(r)), f = (n = s * l, b.create(n)), p = (i = c * a, b.create(i));
                            return d === h && f === p
                        }
                        is0() {
                        ...
                        negate() {
                            let e, t;
                            return new x((e = -this.X, b.create(e)), this.Y, this.Z, (t = -this.T, b.create(t)))
                        }
                        double() {
                            let e, t, r, n, i, o, s, a, u, l, d, {
                                    a: h
                                } = w,
                                {
                                    X: f,
                        ...
                        add(e) {
                            ...
                            let {
                                ...
                                Z: S,
                                T: v
                            } = e, _ = (t = f * m, b.create(t)), I = (r = p * k, b.create(r)), A = (n = y * h * v, b.create(n)), R = (i = g * S, b.create(i)), P = (o = (f + p) * (m + k) - _ - I, b.create(o)), B = R - A, T = R + A, O = (s = I - d * _, b.create(s)), C = (a = P * B, b.create(a)), L = (u = T * O, b.create(u)), N = (c = P * O, b.create(c));
                        ...
                        multiply(e) {
                            if (!m.isValidNot0(e)) throw Error("invalid scalar: expected 1 <= sc < curve.n");
                            let {
                                p: t,
                                f: r
                            } = R.cached(this, e, e => (0, i.normalizeZ)(x, e));
                            return (0, i.normalizeZ)(x, [t, r])[0]
                        }
                        multiplyUnsafe(e, t = x.ZERO) {
                            if (!m.isValid(e)) throw Error("invalid scalar: expected 0 <= sc < curve.n");
                            return e === a ? x.ZERO : this.is0() || e === u ? this : R.unsafe(this, e, e => (0, i.normalizeZ)(x, e), t)
                        }
                        isSmallOrder() {
                    ...
                    x.BASE = new x(w.Gx, w.Gy, u, (g = w.Gx * w.Gy, b.create(g))), x.ZERO = new x(a, u, u, a), x.Fp = b, x.Fn = m;
                    let R = new i.wNAF(x, m.BITS);
                    return x.BASE.precompute(8), x
                }(f, p), g, y);
            return h = b.Point, Object.assign({}, b, {
                ExtendedPoint: h,
                CURVE: e,
    ...
    (0, h.createHasher)(I.Point, e => (function(e) {
        let t, r, n, i, o, a, u, c, l, d, h, f, y, k, S, v, E, I, A, B, T, O, C, {
                xMn: L,
                xMd: N,
                yMn: U,
                yMd: M
            } = (t = (w - b) / m, r = BigInt(486662), n = _.sqr(e), n = _.mul(n, g), i = _.add(n, _.ONE), o = _.neg(r), a = _.sqr(i), u = _.mul(a, i), c = _.mul(n, r), c = _.mul(c, o), c = _.add(c, a), c = _.mul(c, o), l = _.sqr(u), a = _.sqr(l), l = _.mul(l, u), l = _.mul(l, c), a = _.mul(a, l), d = _.pow(a, t), d = _.mul(d, l), h = _.mul(d, R), a = _.sqr(d), a = _.mul(a, u), f = _.eql(a, c), y = _.cmov(h, d, f), k = _.mul(o, n), S = _.mul(d, e), S = _.mul(S, x), v = _.mul(S, R), E = _.mul(c, n), a = _.sqr(S), a = _.mul(a, u), I = _.eql(a, E), A = _.cmov(v, S, I), a = _.sqr(y), a = _.mul(a, u), B = _.eql(a, c), T = _.cmov(k, o, B), O = _.cmov(A, y, B), C = _.isOdd(O), {
                xMn: T,
                xMd: i,
        ...
        let W = _.mul(N, U),
            ...
            K = _.mul(W, D),
            q = _.eql(K, _.ZERO);
        z = _.cmov(z, _.ZERO, q), W = _.cmov(W, _.ONE, q), j = _.cmov(j, _.ONE, q), D = _.cmov(D, _.ONE, q);
    ...
    let B = BigInt("25063068953384623474111414158702152701244531502492656460079210482610430750235"),
        T = BigInt("54469307008909316920995813868745141605393597292927456921205312896311721017578"),
        O = BigInt("1159843021668779879193775521855586647937357759715417654439879720876111806838"),
        C = BigInt("40440834346308536858101042469323190826248399146238708352240133220865137265952"),
        L = BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"),
        N = e => I.Point.Fp.create((0, o.bytesToNumberLE)(e) & L);

    function U(e) {
        let t, r, n, i, o, a, u, c, l, d, h, f, g, y, b, {
                d: m
            } = k,
            ...
            L = (o = T * e, _.create(o));
        (0, s.isNegativeLE)(L, w) || (a = -L, L = _.create(a)), P || (T = L), P || (x = E);
        let N = (u = x * (E - p) * C - R, _.create(u)),
            ...
            W = (d = p - U, _.create(d)),
            j = (h = p + U, _.create(h));
        return new I.Point((f = M * j, _.create(f)), (g = W * z, _.create(g)), (y = z * j, _.create(y)), (b = M * W, _.create(b)))
    }
    class M extends d {
        constructor(e) {
            super(e)
        ...
        static hashToCurve(e) {
            var t;
            let r, i;
            return t = (0, o.ensureBytes)("ristrettoHash", e, 64), (0, n.abytes)(t, 64), r = U(N(t.subarray(0, 32))), i = U(N(t.subarray(32, 64))), new M(r.add(i))
        }
        static fromBytes(e) {
            ...
            if (!(0, o.equalBytes)(_.toBytes(A), e) || (0, s.isNegativeLE)(A, w)) throw Error("invalid ristretto255 encoding 1");
            ...
            let j = (b = R * z, _.create(b)),
                D = (m = W * j, _.create(m));
            if (!C || (0, s.isNegativeLE)(D, w) || j === f) throw Error("invalid ristretto255 encoding 2");
        ...
        toBytes() {
            let e, t, r, n, i, o, a, u, c, l, d, h, f, {
                    X: g,
                    Y: y,
                    Z: b,
                    T: m
                } = this.ep,
                k = (e = b + y, r = _.create(e) * (t = b - y, _.create(t)), _.create(r)),
                E = (n = g * y, _.create(n)),
                {
                    value: I
        ...
        equals(e) {
            ...
            let {
                ...
                X: a,
                Y: u
            } = e.ep, c = (t = o * u, _.create(t) === (r = s * a, _.create(r))), l = (n = s * u, _.create(n) === (i = o * a, _.create(i)));
            return c || l
        }
        is0() {
    ...
    function z([e, t]) {
        return `${e}=${function e(t){return Array.isArray(t)?"%5B"+t.map(e).join("%2C%20")+"%5D":"bigint"==typeof t?`${t}n`:encodeURIComponent(String(null!=t&&null===Object.getPrototypeOf(t)?{...t}:t))}(t)}`
    }
    M.BASE = new M(I.Point.BASE), M.ZERO = new M(I.Point.ZERO), M.Fp = _, M.Fn = E, e.s(["ed25519", 0, I], 214303), e.i(247167);
            ...
            super(function(e, t = {}) {
                {
                    ...
                    return Object.keys(t).length && (r += ` '${btoa(Object.entries(t).map(z).join("&"))}'`), `${r}\``
                }
            }(e, r), n), this.context = {
                __code: e,
                ...r
    ...
    var D = ((t = D || {})[t.Little = 0] = "Little", t[t.Big = 1] = "Big", t);
    ...
    var q = (e = {}) => {
            ...
            return Object.freeze({ ...r = {
                    ...
                    write(e, r, n) {
                        t.range && function(e, t, r, n) {
                            if (n < t || n > r) throw new W(8078011, {
                                codecDescription: e,
                                max: r,
                                min: t,
                                value: n
                        ...
                        return t.set(new DataView(i), e, K(t.config)), r.set(new Uint8Array(i), n), n + t.size
                    }
                },
                encode: e => {
                    let t = new Uint8Array("fixedSize" in r ? r.fixedSize : r.getSizeFromValue(e));
        ...
        F = (e = {}) => (function(e, t) {
            ...
            if (j(e) && j(t) && e.fixedSize !== t.fixedSize) throw new W(8078005, {
                decoderFixedSize: t.fixedSize,
                encoderFixedSize: e.fixedSize
            });
            if (!j(e) && !j(t) && e.maxSize !== t.maxSize) throw new W(8078006, {
            ...
            return Object.freeze({ ...r = {
                    ...
                    read(e, r = 0) {
                        ...
                        let s, a;
                        ! function(e, t, r = 0) {
                            if (t.length - r <= 0) throw new W(8078e3, {
                                codecDescription: e
                            })
                        }(t.name, e, r),
                        function(e, t, r, n = 0) {
                            let i = r.length - n;
                            if (i < t) throw new W(8078001, {
                                bytesLength: i,
                                codecDescription: e,
                                expected: t
                            })
                        }(t.name, t.size, e, r);
                        let u = new DataView((n = e, i = r, o = t.size, s = n.byteOffset + (i ? ? 0), a = o ? ? n.byteLength, n.buffer.slice(s, s + a)));
    ...
    function* J(e, t, r, n) {
        var i;
        for (let o of ($(i = e) && "function" == typeof i[Symbol.iterator] || (e = [e]), e)) {
            let e = function(e, t, r, n) {
                ...
                let {
                    ...
                    refinement: a,
                    message: u = `Expected a value of type \`${s}\`${a?` with refinement \`${a}\``:""}, but received: \`${G(n)}\``
                } = e;
                return {
                    value: n,
                    type: s,
    ...
    function* Y(e, t, r = {}) {
        ...
        o && (e = t.coercer(e, a));
        let u = "valid";
        for (let n of t.validator(e, a)) n.explanation = r.message, u = "not_valid", yield [n, void 0];
        for (let [c, l, d] of t.entries(e, a))
            for (let t of Y(l, d, {
                    ...
                    mask: s,
                    message: r.message
                })) t[0] ? (u = null != t[0].refinement ? "not_refined" : "not_valid", yield [t[0], void 0]) : o && (l = t[1], void 0 === c ? e = l : e instanceof Map ? e.set(c, l) : e instanceof Set ? e.add(l) : $(e) && (void 0 !== l || c in e) && (e[c] = l));
        if ("not_valid" !== u)
            for (let n of t.refiner(e, a)) n.explanation = r.message, u = "not_refined", yield [n, void 0];
    ...
    class X {
        constructor(e) {
            ...
            this.type = t, this.schema = r, this.entries = s, this.coercer = o, n ? this.validator = (e, t) => J(n(e, t), t, this, e) : this.validator = () => [], i ? this.refiner = (e, t) => J(i(e, t), t, this, e) : this.refiner = () => []
        }
        assert(e, t) {
            return Z(e, this, t)
        }
    ...
    function en(e) {
        return new X({
            ...
            * entries(t) {
            ...
            validator: e => Array.isArray(e) || `Expected an array value, but received: ${G(e)}`
        })
    }
    ...
    function eo(e) {
        return et("instance", t => t instanceof e || `Expected a \`${e.name}\` instance, but received: ${G(t)}`)
    }
    ...
    function es(e) {
        ...
        return new X({
            ...
            validator: r => r === e || `Expected the literal \`${t}\`, but received: ${G(r)}`
        })
    }
    ...
    function eu() {
        return et("number", e => "number" == typeof e && !isNaN(e) || `Expected a number, but received: ${G(e)}`)
    }
    ...
    function ed() {
        return et("string", e => "string" == typeof e || `Expected a string, but received: ${G(e)}`)
    }
    ...
    function eh(e) {
        ...
        return new X({
            ...
            * entries(r) {
            ...
            validator: e => Array.isArray(e) || `Expected an array, but received: ${G(e)}`,
            coercer: e => Array.isArray(e) ? e.slice() : e
        })
    }
    ...
    function ep(e) {
        ...
        return new X({
            ...
            validator(r, n) {
                ...
                return [`Expected the value to satisfy a union of \`${t}\`, but received: ${G(r)}`, ...i]
            }
        })
    }
    ...
    function ey(e, t, r) {
        return new X({ ...e,
            coercer: (n, i) => ee(n, t)[0] ? e.coercer(n, i) : e.coercer(r(n, i), i)
        })
    }
    e.s(["any", () => er, "array", () => en, "assert", () => Z, "boolean", () => ei, "coerce", () => ey, "create", () => Q, "instance", () => eo, "literal", () => es, "nullable", () => ea, "number", () => eu, "optional", () => ec, "record", () => el, "string", () => ed, "tuple", () => eh, "type", () => ef, "union", () => ep, "unknown", () => eg], 770134)
}, 637342, e => {
    "use strict";
    e.s([], 748636), e.i(748636);
    var t, r, n = e.i(565274),
        i = e.i(165704),
        o = 0,
        s = 0,
        a = e.i(663110);
    let u = function(e) {
        ...
        return r[0] = (t = parseInt(e.slice(0, 8), 16)) >>> 24, r[1] = t >>> 16 & 255, r[2] = t >>> 8 & 255, r[3] = 255 & t, r[4] = (t = parseInt(e.slice(9, 13), 16)) >>> 8, r[5] = 255 & t, r[6] = (t = parseInt(e.slice(14, 18), 16)) >>> 8, r[7] = 255 & t, r[8] = (t = parseInt(e.slice(19, 23), 16)) >>> 8, r[9] = 255 & t, r[10] = (t = parseInt(e.slice(24, 36), 16)) / 0x10000000000 & 255, r[11] = t / 0x100000000 & 255, r[12] = t >>> 24 & 255, r[13] = t >>> 16 & 255, r[14] = t >>> 8 & 255, r[15] = 255 & t, r
    };
    ...
    function c(e, t, r) {
        function n(e, n, o, s) {
            if ("string" == typeof e && (e = function(e) {
                    ...
                    return t
                }(e)), "string" == typeof n && (n = u(n)), 16 !== n.length) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
    ...
    var b = c("v3", 48, function(e) {
            ...
            return function(e) {
                ...
                for (var r = 0x67452301, n = -0x10325477, i = -0x67452302, o = 0x10325476, s = 0; s < e.length; s += 16) {
                    var a = r,
                        u = n,
                        c = i,
                        h = o;
                    r = f(r, n, i, o, e[s], 7, -0x28955b88), o = f(o, r, n, i, e[s + 1], 12, -0x173848aa), i = f(i, o, r, n, e[s + 2], 17, 0x242070db), n = f(n, i, o, r, e[s + 3], 22, -0x3e423112), r = f(r, n, i, o, e[s + 4], 7, -0xa83f051), o = f(o, r, n, i, e[s + 5], 12, 0x4787c62a), i = f(i, o, r, n, e[s + 6], 17, -0x57cfb9ed), n = f(n, i, o, r, e[s + 7], 22, -0x2b96aff), r = f(r, n, i, o, e[s + 8], 7, 0x698098d8), o = f(o, r, n, i, e[s + 9], 12, -0x74bb0851), i = f(i, o, r, n, e[s + 10], 17, -42063), n = f(n, i, o, r, e[s + 11], 22, -0x76a32842), r = f(r, n, i, o, e[s + 12], 7, 0x6b901122), o = f(o, r, n, i, e[s + 13], 12, -0x2678e6d), i = f(i, o, r, n, e[s + 14], 17, -0x5986bc72), n = f(n, i, o, r, e[s + 15], 22, 0x49b40821), r = p(r, n, i, o, e[s + 1], 5, -0x9e1da9e), o = p(o, r, n, i, e[s + 6], 9, -0x3fbf4cc0), i = p(i, o, r, n, e[s + 11], 14, 0x265e5a51), n = p(n, i, o, r, e[s], 20, -0x16493856), r = p(r, n, i, o, e[s + 5], 5, -0x29d0efa3), o = p(o, r, n, i, e[s + 10], 9, 0x2441453), i = p(i, o, r, n, e[s + 15], 14, -0x275e197f), n = p(n, i, o, r, e[s + 4], 20, -0x182c0438), r = p(r, n, i, o, e[s + 9], 5, 0x21e1cde6), o = p(o, r, n, i, e[s + 14], 9, -0x3cc8f82a), i = p(i, o, r, n, e[s + 3], 14, -0xb2af279), n = p(n, i, o, r, e[s + 8], 20, 0x455a14ed), r = p(r, n, i, o, e[s + 13], 5, -0x561c16fb), o = p(o, r, n, i, e[s + 2], 9, -0x3105c08), i = p(i, o, r, n, e[s + 7], 14, 0x676f02d9), n = p(n, i, o, r, e[s + 12], 20, -0x72d5b376), r = g(r, n, i, o, e[s + 5], 4, -378558), o = g(o, r, n, i, e[s + 8], 11, -0x788e097f), i = g(i, o, r, n, e[s + 11], 16, 0x6d9d6122), n = g(n, i, o, r, e[s + 14], 23, -0x21ac7f4), r = g(r, n, i, o, e[s + 1], 4, -0x5b4115bc), o = g(o, r, n, i, e[s + 4], 11, 0x4bdecfa9), i = g(i, o, r, n, e[s + 7], 16, -0x944b4a0), n = g(n, i, o, r, e[s + 10], 23, -0x41404390), r = g(r, n, i, o, e[s + 13], 4, 0x289b7ec6), o = g(o, r, n, i, e[s], 11, -0x155ed806), i = g(i, o, r, n, e[s + 3], 16, -0x2b10cf7b), n = g(n, i, o, r, e[s + 6], 23, 0x4881d05), r = g(r, n, i, o, e[s + 9], 4, -0x262b2fc7), o = g(o, r, n, i, e[s + 12], 11, -0x1924661b), i = g(i, o, r, n, e[s + 15], 16, 0x1fa27cf8), n = g(n, i, o, r, e[s + 2], 23, -0x3b53a99b), r = y(r, n, i, o, e[s], 6, -0xbd6ddbc), o = y(o, r, n, i, e[s + 7], 10, 0x432aff97), i = y(i, o, r, n, e[s + 14], 15, -0x546bdc59), n = y(n, i, o, r, e[s + 5], 21, -0x36c5fc7), r = y(r, n, i, o, e[s + 12], 6, 0x655b59c3), o = y(o, r, n, i, e[s + 3], 10, -0x70f3336e), i = y(i, o, r, n, e[s + 10], 15, -1051523), n = y(n, i, o, r, e[s + 1], 21, -0x7a7ba22f), r = y(r, n, i, o, e[s + 8], 6, 0x6fa87e4f), o = y(o, r, n, i, e[s + 15], 10, -0x1d31920), i = y(i, o, r, n, e[s + 6], 15, -0x5cfebcec), n = y(n, i, o, r, e[s + 13], 21, 0x4e0811a1), r = y(r, n, i, o, e[s + 4], 6, -0x8ac817e), o = y(o, r, n, i, e[s + 11], 10, -0x42c50dcb), i = y(i, o, r, n, e[s + 2], 15, 0x2ad7d2bb), n = y(n, i, o, r, e[s + 9], 21, -0x14792c6f), r = d(r, a), n = d(n, u), i = d(i, c), o = d(o, h)
                }
                return [r, n, i, o]
            }(function(e) {
                if (0 === e.length) return [];
                for (var t = 8 * e.length, r = new Uint32Array(l(t)), n = 0; n < t; n += 8) r[n >> 5] |= (255 & e[n / 8]) << n % 32;
                return r
            }(e), 8 * e.length))
        }),
        m = e.i(535825);
    ...
    var k = c("v5", 80, function(e) {
        ...
        for (var o = Math.ceil((e.length / 4 + 2) / 16), s = Array(o), a = 0; a < o; ++a) {
            for (var u = new Uint32Array(16), c = 0; c < 16; ++c) u[c] = e[64 * a + 4 * c] << 24 | e[64 * a + 4 * c + 1] << 16 | e[64 * a + 4 * c + 2] << 8 | e[64 * a + 4 * c + 3];
            s[a] = u
        }
        s[o - 1][14] = (e.length - 1) * 8 / 0x100000000, s[o - 1][14] = Math.floor(s[o - 1][14]), s[o - 1][15] = (e.length - 1) * 8 | 0;
        for (var l = 0; l < o; ++l) {
            for (var d = new Uint32Array(80), h = 0; h < 16; ++h) d[h] = s[l][h];
            for (var f = 16; f < 80; ++f) d[f] = w(d[f - 3] ^ d[f - 8] ^ d[f - 14] ^ d[f - 16], 1);
            for (var p = r[0], g = r[1], y = r[2], b = r[3], m = r[4], k = 0; k < 80; ++k) {
                var S = Math.floor(k / 20),
                    v = w(p, 5) + function(e, t, r, n) {
                        switch (e) {
                            case 0:
                                return t & r ^ ~t & n;
                            case 1:
            ...
            r[0] = r[0] + p >>> 0, r[1] = r[1] + g >>> 0, r[2] = r[2] + y >>> 0, r[3] = r[3] + b >>> 0, r[4] = r[4] + m >>> 0
        }
    ...
    e.s(["NIL", 0, "00000000-0000-0000-0000-000000000000", "parse", 0, u, "stringify", () => i.default, "v1", 0, function(e, a, u) {
        var c = a && u || 0,
            l = a || Array(16),
            d = (e = e || {}).node || t,
        ...
        if (null == d || null == h) {
            ...
            null == d && (d = t = [1 | f[0], f[1], f[2], f[3], f[4], f[5]]), null == h && (h = r = (f[6] << 8 | f[7]) & 16383)
        }
        var p = void 0 !== e.msecs ? e.msecs : Date.now(),
            g = void 0 !== e.nsecs ? e.nsecs : s + 1,
            y = p - o + (g - s) / 1e4;
        if (y < 0 && void 0 === e.clockseq && (h = h + 1 & 16383), (y < 0 || p > o) && void 0 === e.nsecs && (g = 0), g >= 1e4) throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
        o = p, s = g, r = h;
        ...
        l[c++] = m >>> 8 & 255, l[c++] = 255 & m, l[c++] = m >>> 24 & 15 | 16, l[c++] = m >>> 16 & 255, l[c++] = h >>> 8 | 128, l[c++] = 255 & h;
        for (var w = 0; w < 6; ++w) l[c + w] = d[w];
        return a || (0, i.default)(l)
    }, "v3", 0, b, "v4", () => m.default, "v5", 0, k, "validate", () => a.default, "version", 0, function(e) {
        if (!(0, a.default)(e)) throw TypeError("Invalid UUID");
    ...
    t.exports = function(e, t, r, i) {
        ...
        return void 0 === r ? s.id = ("function" == typeof i.generator ? i.generator : function() {
            return n()
        })(s, i) : 2 === o && null === r ? i.notificationIdNull && (s.id = null) : s.id = r, s
    }
}, 578217, (e, t, r) => {
    "use strict";
    let n = e.r(637342).v4,
    ...
    t.exports = o, o.prototype.request = function(e, t, r, n) {
        let o, s = this,
            a = null,
        ...
        if (3 === r.length)
            if (!Array.isArray(n)) return void r(null, n.error, n.result);
                ...
                r(null, n.filter(e), n.filter(function(t) {
                    return !e(t)
                }));
                return
            }
    ...
    var g = e.i(87246),
        y = class extends g.EventEmitter {
            socket;
            constructor(e, t) {
                super(), this.socket = new window.WebSocket(e, t.protocols), this.socket.onopen = () => this.emit("open"), this.socket.onmessage = e => this.emit("message", e.data), this.socket.onerror = e => this.emit("error", e), this.socket.onclose = e => {
        ...
        m = class extends g.EventEmitter {
            ...
            async subscribe(e) {
                ...
                if ("string" == typeof e && "ok" !== t[e]) throw Error("Failed subscribing to an event '" + e + "' with: " + t[e]);
                return t
            }
            async unsubscribe(e) {
                "string" == typeof e && (e = [e]);
                let t = await this.call("rpc.off", e);
                if ("string" == typeof e && "ok" !== t[e]) throw Error("Failed unsubscribing from an event with: " + t);
                return t
            }
            close(e, t) {
            ...
            _connect(e, t) {
                clearTimeout(this.reconnect_timer_id), this.socket = this.webSocketFactory(e, t), this.socket.addEventListener("open", () => {
                    ...
                    "error" in e == "result" in e && this.queue[e.id].promise[1](Error('Server response malformed. Response must include either "result" or "error", but not both.')), this.queue[e.id].timeout && clearTimeout(this.queue[e.id].timeout), e.error ? this.queue[e.id].promise[1](e.error) : this.queue[e.id].promise[0](e.result), delete this.queue[e.id]
                }), this.socket.addEventListener("error", e => this.emit("error", e)), this.socket.addEventListener("close", ({
                    code: r,
                    reason: n
                }) => {
    ...
    let I = (e, t) => s.ed25519.sign(e, t.slice(0, 32)),
        A = s.ed25519.verify,
        x = e => o.Buffer.isBuffer(e) ? e : e instanceof Uint8Array ? o.Buffer.from(e.buffer, e.byteOffset, e.byteLength) : o.Buffer.from(e);
    class R {
        constructor(e) {
    ...
    O.default = new O("11111111111111111111111111111111"), B.set(O, {
        kind: "struct",
        fields: [
            ["_bn", "u256"]
        ]
    ...
    class C {
        constructor(e) {
            ...
            } else this._secretKey = x(S()), this._publicKey = x(_(this._secretKey))
        }
        get publicKey() {
    ...
    let W = (e = "publicKey") => d.blob(32, e),
        j = (e = "string") => {
            let t = d.struct([d.u32("length"), d.u32("lengthPadding"), d.blob(d.offset(d.u32(), -8), "chars")], e),
                r = t.decode.bind(t),
                n = t.encode.bind(t);
            return t.decode = (e, t) => r(e, t).chars.toString(), t.encode = (e, t, r) => n({
                chars: o.Buffer.from(e, "utf8")
            }, t, r), t.alloc = e => d.u32().span + d.u32().span + o.Buffer.from(e, "utf8").length, t
        };
    ...
    class F {
        ...
        getMessageComponents() {
            ...
            let t = e.filter(([, e]) => e.isSigner && e.isWritable),
                ...
                let [e] = t[0];
                q(e === this.payer.toBase58(), "Expected first writable signer key to be the fee payer")
            }
            return [o, [...t.map(([e]) => new O(e)), ...r.map(([e]) => new O(e)), ...n.map(([e]) => new O(e)), ...i.map(([e]) => new O(e))]]
        }
        ...
        drainKeysFoundInLookupTable(e, t) {
            ...
            for (let [i, o] of this.keyMetaMap.entries())
                if (t(o)) {
                    ...
                    o >= 0 && (q(o < 256, "Max lookup table index exceeded"), r.push(o), n.push(t), this.keyMetaMap.delete(i))
                }
            return [r, n]
        }
    }
    ...
    function H(e, ...t) {
        let [r] = t;
        if (2 === t.length ? r + (t[1] ? ? 0) > e.length : r >= e.length) throw Error(V);
        return e.splice(...t)
    }
    class G {
        constructor(e) {
            this.header = void 0, this.accountKeys = void 0, this.recentBlockhash = void 0, this.instructions = void 0, this.indexToProgramIds = new Map, this.header = e.header, this.accountKeys = e.accountKeys.map(e => new O(e)), this.recentBlockhash = e.recentBlockhash, this.instructions = e.instructions, this.instructions.forEach(e => this.indexToProgramIds.set(e.programIdIndex, this.accountKeys[e.programIdIndex]))
        }
        get version() {
            return "legacy"
        }
        ...
        static compile(e) {
            let [t, r] = F.compile(e.instructions, e.payerKey).getMessageComponents(), n = new z(r).compileInstructions(e.instructions).map(e => ({
                programIdIndex: e.programIdIndex,
        ...
        serialize() {
            ...
            let r = this.instructions.map(e => {
                    let {
                        accounts: t,
                        programIdIndex: r
                    } = e, n = Array.from(u.default.decode(e.data)), i = [];
                    K(i, t.length);
                    let s = [];
                    return K(s, n.length), {
                        programIdIndex: r,
            ...
            let s = n.length;
            r.forEach(e => {
                let t = d.struct([d.u8("programIdIndex"), d.blob(e.keyIndicesCount.length, "keyIndicesCount"), d.seq(d.u8("keyIndex"), e.keyIndices.length, "keyIndices"), d.blob(e.dataLength.length, "dataLength"), d.seq(d.u8("userdatum"), e.data.length, "data")]).encode(e, i, s);
                s += t
            }), i = i.slice(0, s);
            let a = d.struct([d.blob(1, "numRequiredSignatures"), d.blob(1, "numReadonlySignedAccounts"), d.blob(1, "numReadonlyUnsignedAccounts"), d.blob(t.length, "keyCount"), d.seq(W("key"), e, "keys"), W("recentBlockhash")]),
                c = {
    ...
    class J {
        ...
        static compile(e) {
            ...
            let [i, o] = t.getMessageComponents(), s = new z(o, n).compileInstructions(e.instructions);
            return new J({
                header: i,
                staticAccountKeys: o,
                recentBlockhash: e.recentBlockhash,
        ...
        serializeInstructions() {
            ...
            for (let r of this.compiledInstructions) {
                ...
                let i = [];
                K(i, r.data.length);
                let o = d.struct([d.u8("programIdIndex"), d.blob(n.length, "encodedAccountKeyIndexesLength"), d.seq(d.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"), d.blob(i.length, "encodedDataLength"), d.blob(r.data.length, "data")]);
                e += o.encode({
        ...
        serializeAddressTableLookups() {
            ...
            for (let r of this.addressTableLookups) {
                ...
                let o = d.struct([W("accountKey"), d.blob(n.length, "encodedWritableIndexesLength"), d.seq(d.u8(), r.writableIndexes.length, "writableIndexes"), d.blob(i.length, "encodedReadonlyIndexesLength"), d.seq(d.u8(), r.readonlyIndexes.length, "readonlyIndexes")]);
                e += o.encode({
        ...
        static deserialize(e) {
            let t = [...e],
                r = $(t),
                n = 127 & r;
            q(r !== n, "Expected versioned message but received legacy message"), q(0 === n, `Expected versioned message with version 0 but found version ${n}`);
            let i = {
    ...
    let Y = {
        ...
        X = ((t = {})[t.BLOCKHEIGHT_EXCEEDED = 0] = "BLOCKHEIGHT_EXCEEDED", t[t.PROCESSED = 1] = "PROCESSED", t[t.TIMED_OUT = 2] = "TIMED_OUT", t[t.NONCE_INVALID = 3] = "NONCE_INVALID", t),
    ...
    class ee {
        ...
        add(...e) {
            ...
            return e.forEach(e => {
                "instructions" in e ? this.instructions = this.instructions.concat(e.instructions) : "data" in e && "programId" in e && "keys" in e ? this.instructions.push(e) : this.instructions.push(new Q(e))
            }), this
        }
        compileMessage() {
            let e, t, r;
            ...
            i.forEach(e => {
                ...
                r > -1 ? (o[r].isWritable = o[r].isWritable || e.isWritable, o[r].isSigner = o[r].isSigner || e.isSigner) : o.push(e)
            }), o.sort(function(e, t) {
            ...
            for (let e of this.signatures) {
                ...
                if (t > -1) o[t].isSigner || (o[t].isSigner = !0, console.warn("Transaction references a signature that is unnecessary, only the fee payer and instruction signer accounts should sign a transaction. This behavior is deprecated and will throw an error in the next major version release."));
        ...
        _getMessageSignednessErrors(e, t) {
            ...
            for (let {
                    signature: n,
                    publicKey: i
                } of this.signatures) null === n ? t && (r.missing || = []).push(i) : A(n, e, i.toBytes()) || (r.invalid || = []).push(i);
...
Missing signature for public key${1===e.missing.length?"":"(s)"} [\`${e.missing.map(e=>e.toBase58()).join("`, `")}\`].`), Error(t)
        ...
        _serialize(e) {
            ...
            let n = r.length + 64 * t.length + e.length,
                i = o.Buffer.alloc(n);
            return q(t.length < 256), o.Buffer.from(r).copy(i, 0), t.forEach(({
                signature: e
            }, t) => {
                null !== e && (q(64 === e.length, "signature has invalid length"), o.Buffer.from(e).copy(i, r.length + 64 * t))
            }), e.copy(i, r.length + 64 * t.length), q(i.length <= 1232, `Transaction too large: ${i.length} > 1232`), i
        }
        get keys() {
            return q(1 === this.instructions.length), this.instructions[0].keys.map(e => e.pubkey)
        }
        get programId() {
            return q(1 === this.instructions.length), this.instructions[0].programId
        }
        get data() {
        ...
        static decompile(e, t) {
            ...
            for (let e of n) {
                ...
                for (let n of e.accountKeyIndexes) {
                    let e, i = l.get(n);
                    if (void 0 === i) throw Error(`Failed to find key for account key index ${n}`);
                    e = n < o ? n < u : n < l.staticAccountKeys.length ? n - o < c : n - l.staticAccountKeys.length < l.accountKeysFromLookups.writable.length, t.push({
                        pubkey: i,
                ...
                if (void 0 === n) throw Error(`Failed to find program id for program id index ${e.programIdIndex}`);
                h.push(new Q({
                    programId: n,
                    data: x(e.data),
                    keys: t
    ...
    class er {
        ...
        constructor(e, t) {
            if (this.signatures = void 0, this.message = void 0, void 0 !== t) q(t.length === e.header.numRequiredSignatures, "Expected signatures length to be equal to the number of required signatures"), this.signatures = t;
            else {
                const t = [];
        ...
        serialize() {
            ...
            let r = d.struct([d.blob(t.length, "encodedSignaturesLength"), d.seq(((e = "signature") => d.blob(64, e))(), this.signatures.length, "signatures"), d.blob(e.length, "serializedMessage")]),
        ...
        sign(e) {
            ...
            for (let n of e) {
                ...
                q(e >= 0, `Cannot sign with non signer key ${n.publicKey.toBase58()}`), this.signatures[e] = I(t, n.secretKey)
            }
        }
        addSignature(e, t) {
            ...
            q(r >= 0, `Can not add signature; \`${e.toBase58()}\` is not required to sign this transaction`), this.signatures[r] = t
        }
    }
...
${JSON.stringify(n.slice(-10),null,2)}. ` : "",
            ...
            switch (e) {
                case "send":
                    i = `Transaction ${t} resulted in an error. 
${r}. ` + o + s;
                    break;
                case "simulate":
                    i = `Simulation failed. 
...
` + o + s;
            ...
            super(i), this.signature = void 0, this.transactionMessage = void 0, this.transactionLogs = void 0, this.signature = t, this.transactionMessage = r, this.transactionLogs = n || void 0
        }
    ...
    let ew = d.nu64("lamportsPerSignature"),
        ek = d.struct([d.u32("version"), d.u32("state"), W("authorizedPubkey"), W("nonce"), d.struct([ew], "feeCalculator")]),
        eS = ek.span;
    class ev {
        constructor(e) {
    ...
    function e_(e) {
        ...
        return t.decode = (e, t) => {
            let n = r(e, t);
            return i.decode(n)
        }, t.encode = (e, t, r) => n(i.encode(e), t, r), t
    }
    class eE {
        ...
        static decodeNonceInitialize(e) {
            ...
            let {
                authorized: t
            } = em(eI.InitializeNonceAccount, e.data);
            return {
                noncePubkey: e.keys[0].pubkey,
                authorizedPubkey: new O(t)
            }
        }
        static decodeNonceAdvance(e) {
            return this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3), em(eI.AdvanceNonceAccount, e.data), {
                noncePubkey: e.keys[0].pubkey,
        ...
        static decodeNonceWithdraw(e) {
            ...
            let {
                lamports: t
            } = em(eI.WithdrawNonceAccount, e.data);
            return {
                noncePubkey: e.keys[0].pubkey,
                toPubkey: e.keys[1].pubkey,
        ...
        static decodeNonceAuthorize(e) {
            ...
            let {
                authorized: t
            } = em(eI.AuthorizeNonceAccount, e.data);
            return {
                noncePubkey: e.keys[0].pubkey,
        ...
        static checkProgramId(e) {
            if (!e.equals(eA.programId)) throw Error("invalid instruction; programId is not SystemProgram")
        }
    ...
    let eI = Object.freeze({
        Create: {
            index: 0,
            layout: d.struct([d.u32("instruction"), d.ns64("lamports"), d.ns64("space"), W("programId")])
        },
        Assign: {
            index: 1,
        ...
        CreateWithSeed: {
            index: 3,
            layout: d.struct([d.u32("instruction"), W("base"), j("seed"), d.ns64("lamports"), d.ns64("space"), W("programId")])
        },
        AdvanceNonceAccount: {
            index: 4,
        ...
        AllocateWithSeed: {
            index: 9,
            layout: d.struct([d.u32("instruction"), W("base"), j("seed"), d.ns64("space"), W("programId")])
        },
        AssignWithSeed: {
            index: 10,
            layout: d.struct([d.u32("instruction"), W("base"), j("seed"), W("programId")])
        },
        TransferWithSeed: {
            index: 11,
            layout: d.struct([d.u32("instruction"), e_("lamports"), j("seed"), W("programId")])
        },
        UpgradeNonceAccount: {
            index: 12,
            layout: d.struct([d.u32("instruction")])
    ...
    class eA {
        ...
        static transfer(e) {
            let t, r;
            return "basePubkey" in e ? (t = eb(eI.TransferWithSeed, {
        ...
        static assign(e) {
            let t, r;
            return "basePubkey" in e ? (t = eb(eI.AssignWithSeed, {
        ...
        static createNonceAccount(e) {
            let t = new ee;
            "basePubkey" in e && "seed" in e ? t.add(eA.createAccountWithSeed({
        ...
        static nonceWithdraw(e) {
            let t = eb(eI.WithdrawNonceAccount, {
                lamports: e.lamports
            });
            return new Q({
                keys: [{
        ...
        static allocate(e) {
            let t, r;
            return "basePubkey" in e ? (t = eb(eI.AllocateWithSeed, {
                base: x(e.basePubkey.toBuffer()),
                seed: e.seed,
                space: e.space,
                programId: x(e.programId.toBuffer())
        ...
        static async load(e, t, r, n, i) {
            {
                ...
                if (null !== s) {
                    ...
                    s.data.length !== i.length && (a = a || new ee).add(eA.allocate({
                        accountPubkey: r.publicKey,
                        space: i.length
                    })), s.owner.equals(n) || (a = a || new ee).add(eA.assign({
                        accountPubkey: r.publicKey,
                        programId: n
                    })), s.lamports < o && (a = a || new ee).add(eA.transfer({
                        fromPubkey: t.publicKey,
                        toPubkey: r.publicKey,
                        lamports: o - s.lamports
                    }))
                } else a = new ee().add(eA.createAccount({
                    fromPubkey: t.publicKey,
                ...
                null !== a && await eg(e, a, [t, r], {
                    commitment: "confirmed"
                })
            }
            let s = d.struct([d.u32("instruction"), d.u32("offset"), d.u32("bytesLength"), d.u32("bytesLengthPadding"), d.seq(d.u8("byte"), d.offset(d.u32(), -8), "bytes")]),
                a = ex.chunkSize,
                u = 0,
                c = i,
                l = [];
            for (; c.length > 0;) {
                ...
                l.push(eg(e, h, [t, r], {
                    commitment: "confirmed"
                })), e._rpcEndpoint.includes("solana.com") && await ey(250), u += a, c = c.slice(a)
            }
            await Promise.all(l); {
                ...
                let a = new ee().add({
                    ...
                    u = "processed",
                    c = await e.sendTransaction(a, [t, r], {
                ...
                if (h.err) throw Error(`Transaction ${c} failed (${JSON.stringify(h)})`);
                for (;;) {
                    try {
                        if (await e.getSlot({
                                commitment: u
                ...
                switch (typeof n) {
                    case "object":
                        ...
                        if ("[object Array]" === (d = e.call(n))) {
                            for (o = 0, a = "[", s = n.length - 1; o < s; o++) a += r(n[o], !0) + ",";
                            return s > -1 && (a += r(n[o], !0)), a + "]"
                        }
                        if ("[object Object]" !== d) return JSON.stringify(n);
                        for (s = (u = t(n).sort()).length, a = "", o = 0; o < s;) void 0 !== (l = r(n[c = u[o]], !1)) && (a && (a += ","), a += JSON.stringify(c) + ":" + l), o++;
                        return "{" + a + "}";
                    case "function":
                    case "undefined":
    ...
    }()) && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
    ...
    class eO {
        ...
        getEpochAndSlotIndex(e) {
            if (e < this.firstNormalSlot) {
                var t;
                let r = eT(0 === (t = e + 32 + 1) ? 1 : (t--, t |= t >> 1, t |= t >> 2, t |= t >> 4, t |= t >> 8, t |= t >> 16, (t |= t >> 32) + 1)) - eT(32) - 1,
        ...
        getSlotsInEpoch(e) {
            return e < this.firstNormalEpoch ? Math.pow(2, e + eT(32)) : this.slotsPerEpoch
        }
    }
    ...
    class eN {
        ...
        static deserialize(e) {
            let t = function(e, t) {
                ...
                r = e.length - 56;
            q(r >= 0, "lookup table is invalid"), q(r % 32 == 0, "lookup table is invalid");
            let {
                addresses: n
            } = d.struct([d.seq(W(), r / 32, "addresses")]).decode(e.slice(56));
            return {
    ...
    let eU = {
            index: 1,
            layout: d.struct([d.u32("typeIndex"), e_("deactivationSlot"), d.nu64("lastExtendedSlot"), d.u8("lastExtendedStartIndex"), d.u8(), d.seq(W(), d.offset(d.u8(), -1), "authority")])
        },
        eM = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
        ez = (0, f.coerce)((0, f.instance)(O), (0, f.string)(), e => new O(e)),
        eW = (0, f.tuple)([(0, f.string)(), (0, f.literal)("base64")]),
        ej = (0, f.coerce)((0, f.instance)(o.Buffer), eW, e => o.Buffer.from(e[0], "base64"));
    ...
    function eV(e) {
        return (0, f.coerce)(eq(e), eF, t => "error" in t ? t : { ...t,
            result: (0, f.create)(t.result, e)
        })
    }
    ...
    let eJ = (0, f.type)({
        ...
        eY = eV((0, f.array)((0, f.nullable)((0, f.type)({
            epoch: (0, f.number)(),
        ...
        e7 = e$((0, f.type)({
            err: (0, f.nullable)((0, f.union)([(0, f.type)({}), (0, f.string)()])),
            logs: (0, f.nullable)((0, f.array)((0, f.string)())),
            accounts: (0, f.optional)((0, f.nullable)((0, f.array)((0, f.nullable)((0, f.type)({
            ...
            returnData: (0, f.optional)((0, f.nullable)((0, f.type)({
                programId: (0, f.string)(),
                data: (0, f.tuple)([(0, f.string)(), (0, f.literal)("base64")])
            }))),
            innerInstructions: (0, f.optional)((0, f.nullable)((0, f.array)((0, f.type)({
                index: (0, f.number)(),
                instructions: (0, f.array)((0, f.union)([e4, e8]))
            }))))
        })),
        e9 = e$((0, f.type)({
            byIdentity: (0, f.record)((0, f.string)(), (0, f.array)((0, f.number)())),
            range: (0, f.type)({
        ...
        ty = (0, f.coerce)((0, f.union)([(0, f.instance)(o.Buffer), td]), (0, f.union)([eW, td]), e => Array.isArray(e) ? (0, f.create)(e, ej) : e),
        tb = (0, f.type)({
            executable: (0, f.boolean)(),
            owner: ez,
            lamports: (0, f.number)(),
        ...
        tw = (0, f.type)({
            state: (0, f.union)([(0, f.literal)("active"), (0, f.literal)("inactive"), (0, f.literal)("activating"), (0, f.literal)("deactivating")]),
            active: (0, f.number)(),
            inactive: (0, f.number)()
        }),
        tk = eV((0, f.array)((0, f.type)({
        ...
        tx = (0, f.union)([(0, f.type)({
            type: (0, f.union)([(0, f.literal)("firstShredReceived"), (0, f.literal)("completed"), (0, f.literal)("optimisticConfirmation"), (0, f.literal)("root")]),
            slot: (0, f.number)(),
        ...
        tO = (0, f.type)({
            ...
            epochCredits: (0, f.array)((0, f.tuple)([(0, f.number)(), (0, f.number)(), (0, f.number)()])),
            commission: (0, f.number)(),
            lastVote: (0, f.number)(),
            rootSlot: (0, f.nullable)((0, f.number)())
        }),
        tC = eV((0, f.type)({
            current: (0, f.array)(tO),
            delinquent: (0, f.array)(tO)
        })),
        tL = (0, f.union)([(0, f.literal)("processed"), (0, f.literal)("confirmed"), (0, f.literal)("finalized")]),
        tN = (0, f.type)({
            slot: (0, f.number)(),
        ...
        tW = (0, f.type)({
            ...
            message: (0, f.type)({
                ...
                instructions: (0, f.array)((0, f.type)({
        ...
        tj = (0, f.type)({
            ...
            source: (0, f.optional)((0, f.union)([(0, f.literal)("transaction"), (0, f.literal)("lookupTable")]))
        }),
        tD = (0, f.type)({
        ...
        t$ = (0, f.coerce)(tF, tV, e => "accounts" in e ? (0, f.create)(e, tq) : (0, f.create)(e, tK)),
        tH = (0, f.type)({
            signatures: (0, f.array)((0, f.string)()),
            message: (0, f.type)({
                accountKeys: (0, f.array)(tj),
                ...
                recentBlockhash: (0, f.string)(),
                addressTableLookups: (0, f.optional)((0, f.nullable)((0, f.array)(tz)))
            })
        }),
        tG = (0, f.type)({
        ...
        tY = (0, f.type)({
            ...
            logMessages: (0, f.optional)((0, f.nullable)((0, f.array)((0, f.string)()))),
    ...
    class rl {
        constructor(e, t) {
            ...
            this._commitment = void 0, this._confirmTransactionInitialTimeout = void 0, this._rpcEndpoint = void 0, this._rpcWsEndpoint = void 0, this._rpcClient = void 0, this._rpcRequest = void 0, this._rpcBatchRequest = void 0, this._rpcWebSocket = void 0, this._rpcWebSocketConnected = !1, this._rpcWebSocketHeartbeat = null, this._rpcWebSocketIdleTimeout = null, this._rpcWebSocketGeneration = 0, this._disableBlockhashCaching = !1, this._pollingBlockhash = !1, this._blockhashInfo = {
                ...
                return async t => {
                    let {
                        commitment: r,
                        config: n
                    } = eD(t), i = this._buildArgs([], r, void 0, n), o = eB(i);
                    return e[o] = e[o] ? ? (async () => {
                        try {
                            let e = await this._rpcRequest("getBlockHeight", i),
                                t = (0, f.create)(e, eV((0, f.number)()));
                            if ("error" in t) throw new ep(t.error, "failed to get block height information");
                            return t.result
                        } finally {
                            delete e[o]
                        }
            ...
            })(), t && "string" == typeof t ? this._commitment = t : t && (this._commitment = t.commitment, this._confirmTransactionInitialTimeout = t.confirmTransactionInitialTimeout, r = t.wsEndpoint, n = t.httpHeaders, i = t.fetch, o = t.fetchMiddleware, s = t.disableRetryOnRateLimit, a = t.httpAgent), this._rpcEndpoint = function(e) {
                ...
                let [r, n, i, o] = t, s = e.startsWith("https:") ? "wss:" : "ws:", a = null == i ? null : parseInt(i.slice(1), 10), u = null == a ? "" : `:${a+1}`;
                return `${s}//${n}${u}${o}`
            }(e), this._rpcClient = function(e, t, r, n, i, o) {
                let s, a, u = r || eC;
                return null != o && console.warn("You have supplied an `httpAgent` when creating a `Connection` in a browser environment.It has been ignored; `httpAgent` is only used in Node environments."), n && (a = async (e, t) => {
                    ...
                    try {
                        let t, r = 5,
                            s = 500;
                        for (;
                            (t = a ? await a(e, o) : await u(e, o), 429 === t.status && !0 !== i) && (r -= 1, 0 !== r);) {;
                            console.error(`Server responded with ${t.status} ${t.statusText}.  Retrying after ${s}ms delay...`), await ey(s), s *= 2
                        }
                        let c = await t.text();
                        t.ok ? n(null, c) : n(Error(`${t.status} ${t.statusText}: ${c}`))
                    } catch (e) {
                        e instanceof Error && n(e)
                    }
                }, {})
            }(e, n, i, o, s, a), this._rpcRequest = function(e) {
                return (t, r) => new Promise((n, i) => {
                    e.request(t, r, (e, t) => {
                        e ? i(e) : n(t)
                    })
                })
            }(this._rpcClient), this._rpcBatchRequest = function(e) {
            ...
            }(this._rpcClient), this._rpcWebSocket = new eL(this._rpcWsEndpoint, {
                autoconnect: !1,
                max_reconnects: 1 / 0
        ...
        async getBalanceAndContext(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgs([e.toBase58()], r, void 0, n), o = await this._rpcRequest("getBalance", i), s = (0, f.create)(o, e$((0, f.number)()));
            if ("error" in s) throw new ep(s.error, `failed to get balance for ${e.toBase58()}`);
            return s.result
        }
        ...
        async getBlockTime(e) {
            ...
            if ("error" in r) throw new ep(r.error, `failed to get block time for slot ${e}`);
            return r.result
        }
        async getMinimumLedgerSlot() {
            let e = await this._rpcRequest("minimumLedgerSlot", []),
                t = (0, f.create)(e, eV((0, f.number)()));
            if ("error" in t) throw new ep(t.error, "failed to get minimum ledger slot");
            return t.result
        }
        async getFirstAvailableBlock() {
            let e = await this._rpcRequest("getFirstAvailableBlock", []),
                t = (0, f.create)(e, ts);
            if ("error" in t) throw new ep(t.error, "failed to get first available block");
            return t.result
        }
        async getSupply(e) {
            let t = {};
        ...
        async getTokenAccountBalance(e, t) {
            let r = this._buildArgs([e.toBase58()], t),
                ...
                i = (0, f.create)(n, e$(tu));
            if ("error" in i) throw new ep(i.error, "failed to get token account balance");
            return i.result
        }
        async getTokenAccountsByOwner(e, t, r) {
            ...
            let s = this._buildArgs(o, n, "base64", i),
                ...
                u = (0, f.create)(a, tl);
            if ("error" in u) throw new ep(u.error, `failed to get token accounts owned by account ${e.toBase58()}`);
            return u.result
        }
        async getParsedTokenAccountsByOwner(e, t, r) {
            ...
            let i = this._buildArgs(n, r, "jsonParsed"),
                ...
                s = (0, f.create)(o, th);
            if ("error" in s) throw new ep(s.error, `failed to get token accounts owned by account ${e.toBase58()}`);
            return s.result
        }
        async getLargestAccounts(e) {
            let t = { ...e,
                ...
                i = (0, f.create)(n, tf);
            if ("error" in i) throw new ep(i.error, "failed to get largest accounts");
            return i.result
        }
        async getTokenLargestAccounts(e, t) {
            let r = this._buildArgs([e.toBase58()], t),
                ...
                i = (0, f.create)(n, tc);
            if ("error" in i) throw new ep(i.error, "failed to get token largest accounts");
            return i.result
        }
        async getAccountInfoAndContext(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgs([e.toBase58()], r, "base64", n), o = await this._rpcRequest("getAccountInfo", i), s = (0, f.create)(o, e$((0, f.nullable)(tp)));
            if ("error" in s) throw new ep(s.error, `failed to get info about account ${e.toBase58()}`);
            return s.result
        }
        async getParsedAccountInfo(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgs([e.toBase58()], r, "jsonParsed", n), o = await this._rpcRequest("getAccountInfo", i), s = (0, f.create)(o, e$((0, f.nullable)(tb)));
            if ("error" in s) throw new ep(s.error, `failed to get info about account ${e.toBase58()}`);
            return s.result
        }
        ...
        async getMultipleParsedAccounts(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = e.map(e => e.toBase58()), o = this._buildArgs([i], r, "jsonParsed", n), s = await this._rpcRequest("getMultipleAccounts", o), a = (0, f.create)(s, e$((0, f.array)((0, f.nullable)(tb))));
            if ("error" in a) throw new ep(a.error, `failed to get info for accounts ${i}`);
            return a.result
        }
        async getMultipleAccountsInfoAndContext(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = e.map(e => e.toBase58()), o = this._buildArgs([i], r, "base64", n), s = await this._rpcRequest("getMultipleAccounts", o), a = (0, f.create)(s, e$((0, f.array)((0, f.nullable)(tp))));
            if ("error" in a) throw new ep(a.error, `failed to get info for accounts ${i}`);
            return a.result
        }
        ...
        async getStakeActivation(e, t, r) {
            let {
                commitment: n,
                config: i
            } = eD(t), o = this._buildArgs([e.toBase58()], n, void 0, { ...i,
                epoch: null != r ? r : i ? .epoch
            }), s = await this._rpcRequest("getStakeActivation", o), a = (0, f.create)(s, eV(tw));
            if ("error" in a) throw new ep(a.error, `failed to get Stake Activation ${e.toBase58()}`);
            return a.result
        }
        async getProgramAccounts(e, t) {
            let {
                ...
                encoding: i,
                ...o
            } = n || {}, s = this._buildArgs([e.toBase58()], r, i || "base64", { ...o,
                ...o.filters ? {
                    filters: eK(o.filters)
                } : null
            }), a = await this._rpcRequest("getProgramAccounts", s), u = (0, f.array)(tg), c = !0 === o.withContext ? (0, f.create)(a, e$(u)) : (0, f.create)(a, eV(u));
            if ("error" in c) throw new ep(c.error, `failed to get accounts owned by program ${e.toBase58()}`);
            return c.result
        }
        async getParsedProgramAccounts(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgs([e.toBase58()], r, "jsonParsed", n), o = await this._rpcRequest("getProgramAccounts", i), s = (0, f.create)(o, eV((0, f.array)(tm)));
            if ("error" in s) throw new ep(s.error, `failed to get accounts owned by program ${e.toBase58()}`);
            return s.result
        }
        async confirmTransaction(e, t) {
            ...
            return (q(64 === n.length, "signature has invalid length"), "string" == typeof e) ? await this.confirmTransactionUsingLegacyTimeoutStrategy({
                ...
                if (t.__type === X.PROCESSED) s = t.response;
                    ...
                    if (n ? .value) {
                        ...
                        switch (t) {
                            case "processed":
                            case "recent":
                                if ("processed" !== r && "confirmed" !== r && "finalized" !== r) throw new M(o);
                                break;
                            case "confirmed":
                            case "single":
                            case "singleGossip":
        ...
        async getSlot(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, void 0, r), i = await this._rpcRequest("getSlot", n), o = (0, f.create)(i, eV((0, f.number)()));
        ...
        async getSlotLeader(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, void 0, r), i = await this._rpcRequest("getSlotLeader", n), o = (0, f.create)(i, eV((0, f.string)()));
        ...
        async getSignatureStatuses(e, t) {
            ...
            let n = await this._rpcRequest("getSignatureStatuses", r),
                i = (0, f.create)(n, tU);
            if ("error" in i) throw new ep(i.error, "failed to get signature status");
            return i.result
        }
        async getTransactionCount(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, void 0, r), i = await this._rpcRequest("getTransactionCount", n), o = (0, f.create)(i, eV((0, f.number)()));
            if ("error" in o) throw new ep(o.error, "failed to get transaction count");
            return o.result
        }
        ...
        async getInflationReward(e, t, r) {
            let {
                commitment: n,
                config: i
            } = eD(r), o = this._buildArgs([e.map(e => e.toBase58())], n, void 0, { ...i,
                epoch: null != t ? t : i ? .epoch
            }), s = await this._rpcRequest("getInflationReward", o), a = (0, f.create)(s, eY);
            if ("error" in a) throw new ep(a.error, "failed to get inflation reward");
            return a.result
        }
        ...
        async getEpochInfo(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, void 0, r), i = await this._rpcRequest("getEpochInfo", n), o = (0, f.create)(i, tn);
        ...
        async getEpochSchedule() {
            ...
            let r = t.result;
            return new eO(r.slotsPerEpoch, r.leaderScheduleSlotOffset, r.warmup, r.firstNormalEpoch, r.firstNormalSlot)
        }
        async getLeaderSchedule() {
            let e = await this._rpcRequest("getLeaderSchedule", []),
                t = (0, f.create)(e, to);
            if ("error" in t) throw new ep(t.error, "failed to get leader schedule");
            return t.result
        }
        ...
        async getRecentPerformanceSamples(e) {
            let t = await this._rpcRequest("getRecentPerformanceSamples", e ? [e] : []),
                r = (0, f.create)(t, rn);
            if ("error" in r) throw new ep(r.error, "failed to get recent performance samples");
            return r.result
        }
        ...
        async getFeeForMessage(e, t) {
            ...
            if ("error" in o) throw new ep(o.error, "failed to get fee for message");
        ...
        async getRecentPrioritizationFees(e) {
            let t = e ? .lockedWritableAccounts ? .map(e => e.toBase58()),
                ...
                i = (0, f.create)(n, tr);
            if ("error" in i) throw new ep(i.error, "failed to get recent prioritization fees");
            return i.result
        }
        ...
        async getLatestBlockhashAndContext(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, void 0, r), i = await this._rpcRequest("getLatestBlockhash", n), o = (0, f.create)(i, re);
            if ("error" in o) throw new ep(o.error, "failed to get latest blockhash");
            return o.result
        }
        async isBlockhashValid(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgs([e], r, void 0, n), o = await this._rpcRequest("isBlockhashValid", i), s = (0, f.create)(o, rt);
            if ("error" in s) throw new ep(s.error, "failed to determine if the blockhash `" + e + "`is valid");
            return s.result
        }
        async getVersion() {
        ...
        async getBlock(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgsAtLeastConfirmed([e], r, void 0, n), o = await this._rpcRequest("getBlock", i);
            try {
        ...
        async getParsedBlock(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", n), o = await this._rpcRequest("getBlock", i);
            try {
                switch (n ? .transactionDetails) {
                    case "accounts":
                        {
        ...
        async getBlockProduction(e) {
            ...
            let n = this._buildArgs([], r, "base64", t),
                ...
                o = (0, f.create)(i, e9);
            if ("error" in o) throw new ep(o.error, "failed to get block production information");
            return o.result
        }
        async getTransaction(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgsAtLeastConfirmed([e], r, void 0, n), o = await this._rpcRequest("getTransaction", i), s = (0, f.create)(o, t7);
        ...
        async getParsedTransaction(e, t) {
            let {
                commitment: r,
                config: n
            } = eD(t), i = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", n), o = await this._rpcRequest("getTransaction", i), s = (0, f.create)(o, t9);
            if ("error" in s) throw new ep(s.error, "failed to get transaction");
            return s.result
        }
        ...
        async getConfirmedBlock(e, t) {
            let r = this._buildArgsAtLeastConfirmed([e], t),
                ...
                i = (0, f.create)(n, t4);
            if ("error" in i) throw new ep(i.error, "failed to get confirmed block");
            let o = i.result;
        ...
        async getParsedConfirmedTransaction(e, t) {
            let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
                n = await this._rpcRequest("getTransaction", r),
                i = (0, f.create)(n, t9);
            if ("error" in i) throw new ep(i.error, "failed to get confirmed transaction");
            return i.result
        }
        async getParsedConfirmedTransactions(e, t) {
            ...
            return (await this._rpcBatchRequest(r)).map(e => {
                let t = (0, f.create)(e, t9);
                if ("error" in t) throw new ep(t.error, "failed to get confirmed transactions");
                return t.result
            })
        }
        ...
        async getConfirmedSignaturesForAddress2(e, t, r) {
            let n = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
                ...
                o = (0, f.create)(i, tk);
            if ("error" in o) throw new ep(o.error, "failed to get confirmed signatures for address");
            return o.result
        }
        async getSignaturesForAddress(e, t, r) {
            let n = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
                ...
                o = (0, f.create)(i, tS);
            if ("error" in o) throw new ep(o.error, "failed to get signatures for address");
            return o.result
        }
        async getAddressLookupTable(e, t) {
            ...
            return null !== n && (i = new eN({
                key: e,
                state: eN.deserialize(n.data)
            })), {
                context: r,
                value: i
            }
        ...
        async getNonceAndContext(e, t) {
            ...
            return null !== n && (i = ev.fromAccountData(n.data)), {
                context: r,
                value: i
            }
        }
        ...
        async requestAirdrop(e, t) {
            let r = await this._rpcRequest("requestAirdrop", [e.toBase58(), t]),
                n = (0, f.create)(r, ro);
            if ("error" in n) throw new ep(n.error, `airdrop to ${e.toBase58()} failed`);
            return n.result
        }
        ...
        async getStakeMinimumDelegation(e) {
            let {
                commitment: t,
                config: r
            } = eD(e), n = this._buildArgs([], t, "base64", r), i = await this._rpcRequest("getStakeMinimumDelegation", n), o = (0, f.create)(i, e$((0, f.number)()));
            if ("error" in o) throw new ep(o.error, "failed to get stake minimum delegation");
            return o.result
        }
        async simulateTransaction(e, t, r) {
            ...
            if ("message" in e) {
                ...
                let s = t || {};
                s.encoding = "base64", "commitment" in s || (s.commitment = this.commitment), t && "object" == typeof t && "innerInstructions" in t && (s.innerInstructions = t.innerInstructions);
                let a = [i, s],
            ...
            if (e instanceof ee ? ((n = new ee).feePayer = e.feePayer, n.instructions = e.instructions, n.nonceInfo = e.nonceInfo, n.signatures = e.signatures) : (n = ee.populate(e))._message = n._json = void 0, void 0 !== t && !Array.isArray(t)) throw Error("Invalid arguments");
            ...
            r && (u.accounts = {
                encoding: "base64",
                addresses: (Array.isArray(r) ? r : i.nonProgramIds()).map(e => e.toBase58())
            }), t && (u.sigVerify = !0), t && "object" == typeof t && "innerInstructions" in t && (u.innerInstructions = t.innerInstructions);
            let c = [a, u],
        ...
        async sendEncodedTransaction(e, t) {
            let r = {
                ...
                n = t && t.skipPreflight,
                i = !0 === n ? "processed" : t && t.preflightCommitment || this.commitment;
            ...
            if ("error" in a) {
                let e;
                throw "data" in a.error && (e = a.error.data.logs), new eh({
        ...
        _onSubscriptionStateChange(e, t) {
            ...
            return n.add(t), () => {
                n.delete(t), 0 === n.size && delete this._subscriptionStateChangeCallbacksByHash[r]
            }
        }
                        ...
                        0 === r.callbacks.size && await (async () => {
                            ...
                            if (this._subscriptionsAutoDisposedByRpc.has(n)) this._subscriptionsAutoDisposedByRpc.delete(n);
                                ...
                                try {
                                    ...
                                    if (n instanceof Error && console.error(`${i} error:`, n.message), !t()) return;
                                    this._setSubscription(e, { ...r,
                                        state: "subscribed"
                                    }), await this._updateSubscriptions();
                                    return
        ...
        _makeSubscription(e, t) {
            ...
            return void 0 === i ? this._subscriptionsByHash[n] = { ...e,
                ...
                q(void 0 !== t, `Could not find a \`Subscription\` when tearing down client subscription #${r}`), t.callbacks.delete(e.callback), await this._updateSubscriptions()
        ...
        onAccountChange(e, t, r) {
            let {
                commitment: n,
                config: i
            } = eD(r), o = this._buildArgs([e.toBase58()], n || this._commitment || "finalized", "base64", i);
        ...
        onProgramAccountChange(e, t, r, n) {
            let {
                commitment: i,
                config: o
            } = eD(r), s = this._buildArgs([e.toBase58()], i || this._commitment || "finalized", "base64", o || (n ? {
                filters: eK(n)
            } : void 0));
            return this._makeSubscription({
                callback: t,
        ...
        onSignatureWithOptions(e, t, r) {
            ...
            }, o = this._buildArgs([e], n, void 0, i), s = this._makeSubscription({
                callback: (e, r) => {
                    t(e, r);
                    try {
    ...
    class rd {
        ...
        static fromSeed(e) {
            let t = _(e),
                r = new Uint8Array(64);
            return r.set(e), r.set(t, 32), new rd({
                publicKey: t,
                secretKey: r
            })
        }
    ...
    let rh = Object.freeze({
        CreateLookupTable: {
            index: 0,
            layout: d.struct([d.u32("instruction"), e_("recentSlot"), d.u8("bumpSeed")])
        },
        FreezeLookupTable: {
            index: 1,
            layout: d.struct([d.u32("instruction")])
        ...
        ExtendLookupTable: {
            index: 2,
            layout: d.struct([d.u32("instruction"), e_(), d.seq(W(), d.offset(d.u32(), -8), "addresses")])
        },
    ...
    class rf {
        ...
        static decodeCreateLookupTable(e) {
            ...
            let {
                recentSlot: t
            } = em(rh.CreateLookupTable, e.data);
            return {
        ...
        static decodeExtendLookupTable(e) {
            ...
            let {
                addresses: t
            } = em(rh.ExtendLookupTable, e.data);
            return {
        ...
        static checkProgramId(e) {
            if (!e.equals(rp.programId)) throw Error("invalid instruction; programId is not AddressLookupTable Program")
        }
    ...
    class rp {
        static createLookupTable(e) {
            let [t, r] = O.findProgramAddressSync([e.authority.toBuffer(), (0, h.getU64Encoder)().encode(e.recentSlot)], this.programId), n = eb(rh.CreateLookupTable, {
    ...
    class rg {
        ...
        static decodeSetComputeUnitLimit(e) {
            ...
            let {
                units: t
            } = em(ry.SetComputeUnitLimit, e.data);
            return {
                units: t
            }
        }
        static decodeSetComputeUnitPrice(e) {
            ...
            let {
                microLamports: t
            } = em(ry.SetComputeUnitPrice, e.data);
            return {
                microLamports: t
            }
        }
        static checkProgramId(e) {
            if (!e.equals(rb.programId)) throw Error("invalid instruction; programId is not ComputeBudgetProgram")
        }
    }
    ...
    let rm = d.struct([d.u8("numSignatures"), d.u8("padding"), d.u16("signatureOffset"), d.u16("signatureInstructionIndex"), d.u16("publicKeyOffset"), d.u16("publicKeyInstructionIndex"), d.u16("messageDataOffset"), d.u16("messageDataSize"), d.u16("messageInstructionIndex")]);
    class rw {
        static createInstructionWithPublicKey(e) {
            ...
            q(32 === t.length, `Public Key must be 32 bytes but received ${t.length} bytes`), q(64 === n.length, `Signature must be 64 bytes but received ${n.length} bytes`);
            let s = rm.span,
                a = s + t.length,
                u = a + n.length,
            ...
            }, c), c.fill(t, s), c.fill(n, a), c.fill(r, u), new Q({
                keys: [],
        ...
        static createInstructionWithPrivateKey(e) {
            ...
            q(64 === t.length, `Private key must be 64 bytes but received ${t.length} bytes`);
            try {
    ...
    rw.programId = new O("Ed25519SigVerify111111111111111111111111111"), k.secp256k1.utils.isValidPrivateKey;
    let rk = k.secp256k1.getPublicKey,
        rS = d.struct([d.u8("numSignatures"), d.u16("signatureOffset"), d.u8("signatureInstructionIndex"), d.u16("ethAddressOffset"), d.u8("ethAddressInstructionIndex"), d.u16("messageDataOffset"), d.u16("messageDataSize"), d.u8("messageInstructionIndex"), d.blob(20, "ethAddress"), d.blob(64, "signature"), d.u8("recoveryId")]);
    class rv {
        static publicKeyToEthAddress(e) {
            q(64 === e.length, `Public key must be 64 bytes but received ${e.length} bytes`);
            try {
        ...
        static createInstructionWithEthAddress(e) {
            ...
            q(20 === (t = "string" == typeof r ? r.startsWith("0x") ? o.Buffer.from(r.substr(2), "hex") : o.Buffer.from(r, "hex") : r).length, `Address must be 20 bytes but received ${t.length} bytes`);
            let u = 12 + t.length,
                c = u + i.length + 1,
        ...
        static createInstructionWithPrivateKey(e) {
            ...
            q(32 === t.length, `Private key must be 32 bytes but received ${t.length} bytes`);
            try {
                var i;
                let e, s = x(t),
                    a = rk(s, !1).slice(1),
                    [u, c] = (i = o.Buffer.from((0, w.keccak_256)(x(r))), [(e = k.secp256k1.sign(i, s)).toCompactRawBytes(), e.recovery]);
                return this.createInstructionWithPublicKey({
                    publicKey: a,
                    message: r,
                    signature: u,
    ...
    class rA {
        ...
        static decodeDelegate(e) {
            return this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 6), em(rx.Delegate, e.data), {
                stakePubkey: e.keys[0].pubkey,
        ...
        static decodeAuthorizeWithSeed(e) {
            ...
            let {
                ...
                authoritySeed: n,
                authorityOwner: i
            } = em(rx.AuthorizeWithSeed, e.data), o = {
                stakePubkey: e.keys[0].pubkey,
        ...
        static decodeMerge(e) {
            return this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3), em(rx.Merge, e.data), {
                stakePubkey: e.keys[0].pubkey,
        ...
        static decodeDeactivate(e) {
            return this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3), em(rx.Deactivate, e.data), {
                stakePubkey: e.keys[0].pubkey,
                authorizedPubkey: e.keys[2].pubkey
            }
        }
        static checkProgramId(e) {
            if (!e.equals(rP.programId)) throw Error("invalid instruction; programId is not StakeProgram")
        }
        static checkKeyLength(e, t) {
            if (e.length < t) throw Error(`invalid instruction; found ${e.length} keys, expected at least ${t}`)
        }
    ...
    let rx = Object.freeze({
            Initialize: {
                index: 0,
                layout: d.struct([d.u32("instruction"), ((e = "authorized") => d.struct([W("staker"), W("withdrawer")], e))(), ((e = "lockup") => d.struct([d.ns64("unixTimestamp"), d.ns64("epoch"), W("custodian")], e))()])
            },
            Authorize: {
                index: 1,
                layout: d.struct([d.u32("instruction"), W("newAuthorized"), d.u32("stakeAuthorizationType")])
            },
            Delegate: {
                index: 2,
                layout: d.struct([d.u32("instruction")])
            ...
            AuthorizeWithSeed: {
                index: 8,
                layout: d.struct([d.u32("instruction"), W("newAuthorized"), d.u32("stakeAuthorizationType"), j("authoritySeed"), W("authorityOwner")])
            }
        }),
        rR = Object.freeze({
            Staker: {
    ...
    class rP {
        static initialize(e) {
            let {
                ...
                authorized: r,
                lockup: n
            } = e, i = n || rI.default, o = eb(rx.Initialize, {
                authorized: {
        ...
        static createAccountWithSeed(e) {
            let t = new ee;
            t.add(eA.createAccountWithSeed({
                fromPubkey: e.fromPubkey,
        ...
        static splitWithSeed(e, t) {
            ...
            return u.add(eA.allocate({
                accountPubkey: i,
                basePubkey: o,
                seed: s,
                space: this.space,
                programId: this.programId
            })), t && t > 0 && u.add(eA.transfer({
                fromPubkey: e.authorizedPubkey,
                toPubkey: i,
                lamports: t
    ...
    rP.programId = new O("Stake11111111111111111111111111111111111111"), rP.space = 200;
    class rB {
        constructor(e, t, r, n) {
    ...
    class rT {
        ...
        static decodeInitializeAccount(e) {
            ...
            let {
                voteInit: t
            } = em(rO.InitializeAccount, e.data);
            return {
                votePubkey: e.keys[0].pubkey,
                nodePubkey: e.keys[3].pubkey,
                voteInit: new rB(new O(t.nodePubkey), new O(t.authorizedVoter), new O(t.authorizedWithdrawer), t.commission)
            }
        }
        static decodeAuthorize(e) {
            this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
        ...
        static checkProgramId(e) {
            if (!e.equals(rL.programId)) throw Error("invalid instruction; programId is not VoteProgram")
        }
        static checkKeyLength(e, t) {
            if (e.length < t) throw Error(`invalid instruction; found ${e.length} keys, expected at least ${t}`)
        }
    ...
    let rO = Object.freeze({
            InitializeAccount: {
                index: 0,
                layout: d.struct([d.u32("instruction"), ((e = "voteInit") => d.struct([W("nodePubkey"), W("authorizedVoter"), W("authorizedWithdrawer"), d.u8("commission")], e))()])
            },
            Authorize: {
                index: 1,
                layout: d.struct([d.u32("instruction"), W("newAuthorized"), d.u32("voteAuthorizationType")])
            },
            Withdraw: {
                index: 3,
                layout: d.struct([d.u32("instruction"), d.ns64("lamports")])
            ...
            AuthorizeWithSeed: {
                index: 10,
                layout: d.struct([d.u32("instruction"), ((e = "voteAuthorizeWithSeedArgs") => d.struct([d.u32("voteAuthorizationType"), W("currentAuthorityDerivedKeyOwnerPubkey"), j("currentAuthorityDerivedKeySeed"), W("newAuthorized")], e))()])
            }
        }),
        rC = Object.freeze({
            Voter: {
    ...
    class rL {
        ...
        static updateValidatorIdentity(e) {
            let {
                ...
                authorizedWithdrawerPubkey: r,
                nodePubkey: n
            } = e, i = eb(rO.UpdateValidatorIdentity);
            return new ee().add({
                keys: [{
                    pubkey: t,
                    isSigner: !1,
    ...
    rL.programId = new O("Vote111111111111111111111111111111111111111"), rL.space = 3762;
    ...
    let rz = new O("Vote111111111111111111111111111111111111111"),
        rW = d.struct([W("nodePubkey"), W("authorizedWithdrawer"), d.u8("commission"), d.nu64(), d.seq(d.struct([d.nu64("slot"), d.u32("confirmationCount")]), d.offset(d.u32(), -8), "votes"), d.u8("rootSlotValid"), d.nu64("rootSlot"), d.nu64(), d.seq(d.struct([d.nu64("epoch"), W("authorizedVoter")]), d.offset(d.u32(), -8), "authorizedVoters"), d.struct([d.seq(d.struct([W("authorizedPubkey"), d.nu64("epochOfLastAuthorizedSwitch"), d.nu64("targetEpoch")]), 32, "buf"), d.nu64("idx"), d.u8("isEmpty")], "priorVoters"), d.nu64(), d.seq(d.struct([d.nu64("epoch"), d.nu64("credits"), d.nu64("prevCredits")]), d.offset(d.u32(), -8), "epochCredits"), d.struct([d.nu64("slot"), d.nu64("timestamp")], "lastTimestamp")]);
    class rj {
        constructor(e) {
        ...
        static fromAccountData(e) {
            let t = rW.decode(x(e), 4),
                r = t.rootSlot;
            return t.rootSlotValid || (r = null), new rj({
                ...
                priorVoters: function({
                    ...
                    return r ? [] : [...e.slice(t + 1).map(rK), ...e.slice(0, t).map(rK)]
                }(t.priorVoters),
    ...
    async function rV(e, t, r, n) {
        let i, o;
        r && Object.prototype.hasOwnProperty.call(r, "lastValidBlockHeight") || r && Object.prototype.hasOwnProperty.call(r, "nonceValue") ? (i = r, o = n) : o = r;
        let s = o && {
    ...
    e.s(["Account", () => C, "AddressLookupTableAccount", () => eN, "AddressLookupTableInstruction", () => rf, "AddressLookupTableProgram", () => rp, "Authorized", () => rE, "BLOCKHASH_CACHE_TIMEOUT_MS", () => 3e4, "BPF_LOADER_DEPRECATED_PROGRAM_ID", () => L, "BPF_LOADER_PROGRAM_ID", () => eR, "BpfLoader", () => eP, "COMPUTE_BUDGET_INSTRUCTION_LAYOUTS", () => ry, "ComputeBudgetInstruction", () => rg, "ComputeBudgetProgram", () => rb, "Connection", () => rl, "Ed25519Program", () => rw, "Enum", () => P, "EpochSchedule", () => eO, "FeeCalculatorLayout", () => ew, "Keypair", () => rd, "LAMPORTS_PER_SOL", () => 1e9, "LOOKUP_TABLE_INSTRUCTION_LAYOUTS", () => rh, "Loader", () => ex, "Lockup", () => rI, "MAX_SEED_LENGTH", () => 32, "Message", () => G, "MessageAccountKeys", () => z, "MessageV0", () => J, "NONCE_ACCOUNT_LENGTH", () => eS, "NonceAccount", () => ev, "PACKET_DATA_SIZE", () => 1232, "PUBLIC_KEY_LENGTH", () => 32, "PublicKey", () => O, "SIGNATURE_LENGTH_IN_BYTES", () => 64, "SOLANA_SCHEMA", () => B, "STAKE_CONFIG_ID", () => r_, "STAKE_INSTRUCTION_LAYOUTS", () => rx, "SYSTEM_INSTRUCTION_LAYOUTS", () => eI, "SYSVAR_CLOCK_PUBKEY", () => en, "SYSVAR_EPOCH_SCHEDULE_PUBKEY", () => ei, "SYSVAR_INSTRUCTIONS_PUBKEY", () => eo, "SYSVAR_RECENT_BLOCKHASHES_PUBKEY", () => es, "SYSVAR_RENT_PUBKEY", () => ea, "SYSVAR_REWARDS_PUBKEY", () => eu, "SYSVAR_SLOT_HASHES_PUBKEY", () => ec, "SYSVAR_SLOT_HISTORY_PUBKEY", () => el, "SYSVAR_STAKE_HISTORY_PUBKEY", () => ed, "Secp256k1Program", () => rv, "SendTransactionError", () => eh, "SolanaJSONRPCError", () => ep, "SolanaJSONRPCErrorCode", () => ef, "StakeAuthorizationLayout", () => rR, "StakeInstruction", () => rA, "StakeProgram", () => rP, "Struct", () => R, "SystemInstruction", () => eE, "SystemProgram", () => eA, "Transaction", () => ee, "TransactionExpiredBlockheightExceededError", () => N, "TransactionExpiredNonceInvalidError", () => M, "TransactionExpiredTimeoutError", () => U, "TransactionInstruction", () => Q, "TransactionMessage", () => et, "TransactionStatus", () => X, "VALIDATOR_INFO_KEY", () => rN, "VERSION_PREFIX_MASK", () => 127, "VOTE_PROGRAM_ID", () => rz, "ValidatorInfo", () => rM, "VersionedMessage", () => Y, "VersionedTransaction", () => er, "VoteAccount", () => rj, "VoteAuthorizationLayout", () => rC, "VoteInit", () => rB, "VoteInstruction", () => rT, "VoteProgram", () => rL, "clusterApiUrl", () => rF, "sendAndConfirmRawTransaction", () => rV, "sendAndConfirmTransaction", () => eg], 127261)
}, 403011, 875353, e => {
    "use strict";
    var t, r, n, i;
    let o = !1,
    ...
    class h {
        ...
        _log(e, t) {
            let r = e.toLowerCase();
            null == a[r] && this.throwArgumentError("invalid log level name", "logLevel", e), u > a[r] || console.log.apply(console, t)
        }
        debug(...e) {
        ...
        checkSafeUint53(e, t) {
            "number" == typeof e && (null == t && (t = "value not safe"), (e < 0 || e >= 0x1fffffffffffff) && this.throwError(t, h.errors.NUMERIC_FAULT, {
    ...
    function w(e, t) {
        ...
        if (t.allowMissingPrefix && "string" == typeof e && "0x" !== e.substring(0, 2) && (e = "0x" + e), p(e) && (e = e.toHexString()), _(e)) {
            let r = e.substring(2);
            r.length % 2 && ("left" === t.hexPad ? r = "0" + r : "right" === t.hexPad ? r += "0" : f.throwArgumentError("hex data is odd-length", "value", e));
            let n = [];
            for (let e = 0; e < r.length; e += 2) n.push(parseInt(r.substring(e, e + 2), 16));
            return g(new Uint8Array(n))
        }
        return m(e) ? g(new Uint8Array(e)) : f.throwArgumentError("invalid arrayify value", "value", e)
    }
    ...
    function v(e, t) {
        (e = w(e)).length > t && f.throwArgumentError("value out of range", "value", arguments[0]);
    ...
    function I(e, t) {
        ...
        if (t.allowMissingPrefix && "string" == typeof e && "0x" !== e.substring(0, 2) && (e = "0x" + e), p(e)) return e.toHexString();
        if (_(e)) return e.length % 2 && ("left" === t.hexPad ? e = "0x0" + e.substring(2) : "right" === t.hexPad ? e += "0" : f.throwArgumentError("hex data is odd-length", "value", e)), e.toLowerCase();
        if (m(e)) {
            let t = "0x";
    ...
    function x(e, t, r) {
        return ("string" != typeof e ? e = I(e) : (!_(e) || e.length % 2) && f.throwArgumentError("invalid hexData", "value", e), t = 2 + 2 * t, null != r) ? "0x" + e.substring(t, 2 + 2 * r) : "0x" + e.substring(t)
    }
    ...
    function P(e) {
        let t = function(e) {
            "string" != typeof e && (e = I(e)), _(e) || f.throwArgumentError("invalid hex string", "value", e), e = e.substring(2);
            let t = 0;
    ...
    function B(e, t) {
        for ("string" != typeof e ? e = I(e) : _(e) || f.throwArgumentError("invalid hex string", "value", e), e.length > 2 * t + 2 && f.throwArgumentError("value out of range", "value", arguments[1]); e.length < 2 * t + 2;) e = "0x0" + e.substring(2);
        return e
    }
    ...
    function T(e) {
        ...
        if (y(e)) {
            let r = w(e);
            64 === r.length ? (t.v = 27 + (r[32] >> 7), r[32] &= 127, t.r = I(r.slice(0, 32)), t.s = I(r.slice(32, 64))) : 65 === r.length ? (t.r = I(r.slice(0, 32)), t.s = I(r.slice(32, 64)), t.v = r[64]) : f.throwArgumentError("invalid signature string", "signature", e), t.v < 27 && (0 === t.v || 1 === t.v ? t.v += 27 : f.throwArgumentError("signature invalid v byte", "signature", e)), t.recoveryParam = 1 - t.v % 2, t.recoveryParam && (r[32] |= 128), t._vs = I(r.slice(32, 64))
        } else {
            if (t.r = e.r, t.s = e.s, t.v = e.v, t.recoveryParam = e.recoveryParam, t._vs = e._vs, null != t._vs) {
                let r = v(w(t._vs), 32);
                t._vs = I(r);
                let n = +(r[0] >= 128);
                null == t.recoveryParam ? t.recoveryParam = n : t.recoveryParam !== n && f.throwArgumentError("signature recoveryParam mismatch _vs", "signature", e), r[0] &= 127;
                let i = I(r);
                null == t.s ? t.s = i : t.s !== i && f.throwArgumentError("signature v mismatch _vs", "signature", e)
            }
            if (null == t.recoveryParam) null == t.v ? f.throwArgumentError("signature missing v and recoveryParam", "signature", e) : 0 === t.v || 1 === t.v ? t.recoveryParam = t.v : t.recoveryParam = 1 - t.v % 2;
            else if (null == t.v) t.v = 27 + t.recoveryParam;
            else {
                let r = 0 === t.v || 1 === t.v ? t.v : 1 - t.v % 2;
                t.recoveryParam !== r && f.throwArgumentError("signature recoveryParam mismatch v", "signature", e)
            }
            null != t.r && _(t.r) ? t.r = B(t.r, 32) : f.throwArgumentError("signature missing or invalid r", "signature", e), null != t.s && _(t.s) ? t.s = B(t.s, 32) : f.throwArgumentError("signature missing or invalid s", "signature", e);
            let r = w(t.s);
            r[0] >= 128 && f.throwArgumentError("signature s out of range", "signature", e), t.recoveryParam && (r[0] |= 128);
            let n = I(r);
            t._vs && (_(t._vs) || f.throwArgumentError("signature invalid _vs", "signature", e), t._vs = B(t._vs, 32)), null == t._vs ? t._vs = n : t._vs !== n && f.throwArgumentError("signature _vs mismatch v and s", "signature", e)
        }
        return t.yParityAndS = t._vs, t.compact = t.r + t.yParityAndS.substring(2), t
    }
    e.s(["arrayify", () => w, "concat", () => k, "hexConcat", () => R, "hexDataLength", () => A, "hexDataSlice", () => x, "hexValue", () => P, "hexZeroPad", () => B, "hexlify", () => I, "isBytes", () => m, "isBytesLike", () => y, "isHexString", () => _, "splitSignature", () => T, "stripZeros", () => S, "zeroPad", () => v], 403011)
}, 677319, (e, t, r) => {
    "use strict";
    var n = e.r(619655)(),
    ...
    if (o) {
        ...
        "symbol" == typeof Symbol.toPrimitive && (d[Symbol.toPrimitive] = l), n = function(e) {
    ...
    function v(e) {
        return !("u" < typeof ArrayBuffer) && (S.working ? S(e) : e instanceof ArrayBuffer)
    }
    ...
    function E(e) {
        return !("u" < typeof DataView) && (_.working ? _(e) : e instanceof DataView)
    }
    r.isArgumentsObject = n, r.isGeneratorFunction = i, r.isTypedArray = s, r.isPromise = function(e) {
        ...
        return "u" > typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(e) : s(e) || E(e)
    ...
    }, b.working = "u" > typeof Map && b(new Map), r.isMap = function(e) {
        return !("u" < typeof Map) && (b.working ? b(e) : e instanceof Map)
    }, m.working = "u" > typeof Set && m(new Set), r.isSet = function(e) {
        return !("u" < typeof Set) && (m.working ? m(e) : e instanceof Set)
    }, w.working = "u" > typeof WeakMap && w(new WeakMap), r.isWeakMap = function(e) {
        return !("u" < typeof WeakMap) && (w.working ? w(e) : e instanceof WeakMap)
    }, k.working = "u" > typeof WeakSet && k(new WeakSet), r.isWeakSet = function(e) {
        return k(e)
    }, S.working = "u" > typeof ArrayBuffer && S(new ArrayBuffer), r.isArrayBuffer = v, _.working = "u" > typeof ArrayBuffer && "u" > typeof DataView && _(new DataView(new ArrayBuffer(1), 0, 1)), r.isDataView = E;
    ...
    function x(e) {
        return void 0 !== I && (void 0 === A.working && (A.working = A(new I)), A.working ? A(e) : e instanceof I)
    }
    ...
    r.isSharedArrayBuffer = x, r.isAsyncFunction = function(e) {
    ...
    }, r.isNumberObject = R, r.isStringObject = P, r.isBooleanObject = B, r.isBigIntObject = T, r.isSymbolObject = O, r.isBoxedPrimitive = function(e) {
    ...
    r.format = function(e) {
        ...
        for (var r = 1, n = arguments, i = n.length, s = String(e).replace(o, function(e) {
            ...
            }), a = n[r]; r < i; a = n[++r]) b(a) || !v(a) ? s += " " + a : s += " " + c(a);
        return s
        ...
        return function() {
            if (!i) {
                ...
                n.default.traceDeprecation ? console.trace(t) : console.error(t), i = !0
            }
    ...
    function c(e, t) {
        ...
        return arguments.length >= 3 && (n.depth = arguments[2]), arguments.length >= 4 && (n.colors = arguments[3]), y(t) ? n.showHidden = t : t && r._extend(n, t), k(n.showHidden) && (n.showHidden = !1), k(n.depth) && (n.depth = 2), k(n.colors) && (n.colors = !1), k(n.customInspect) && (n.customInspect = !0), n.colors && (n.stylize = l), h(n, e, n.depth)
    }
    ...
    function h(e, t, n) {
        if (e.customInspect && t && I(t.inspect) && t.inspect !== r.inspect && !(t.constructor && t.constructor.prototype === t)) {
            var i, o, s, a, u, c, l = t.inspect(n, e);
        ...
        var d = function(e, t) {
            ...
            return m(t) ? e.stylize("" + t, "number") : y(t) ? e.stylize("" + t, "boolean") : b(t) ? e.stylize("null", "null") : void 0
        }(e, t);
        if (d) return d;
        var v = Object.keys(t),
            A = (u = {}, v.forEach(function(e, t) {
                u[e] = !0
            }), u);
        if (e.showHidden && (v = Object.getOwnPropertyNames(t)), E(t) && (v.indexOf("message") >= 0 || v.indexOf("description") >= 0)) return f(t);
        if (0 === v.length) {
            if (I(t)) {
                var x = t.name ? ": " + t.name : "";
        ...
        var R = "",
            B = !1,
            T = ["{", "}"];
        if (g(t) && (B = !0, T = ["[", "]"]), I(t) && (R = " [Function" + (t.name ? ": " + t.name : "") + "]"), S(t) && (R = " " + RegExp.prototype.toString.call(t)), _(t) && (R = " " + Date.prototype.toUTCString.call(t)), E(t) && (R = " " + f(t)), 0 === v.length && (!B || 0 == t.length)) return T[0] + R + T[1];
        if (n < 0)
            if (S(t)) return e.stylize(RegExp.prototype.toString.call(t), "regexp");
            else return e.stylize("[Object]", "special");
        return e.seen.push(t), c = B ? function(e, t, r, n, i) {
            for (var o = [], s = 0, a = t.length; s < a; ++s) P(t, String(s)) ? o.push(p(e, t, r, n, String(s), !0)) : o.push("");
            return i.forEach(function(i) {
                i.match(/^\d+$/) || o.push(p(e, t, r, n, i, !0))
            }), o
        }(e, t, n, A, v) : v.map(function(r) {
            return p(e, t, n, A, r, B)
        }), e.seen.pop(), i = c, o = R, s = T, a = 0, i.reduce(function(e, t) {
            return a++, t.indexOf("\n") >= 0 && a++, e + t.replace(/\u001b\[\d\d?m/g, "").length + 1
        }, 0) > 60 ? s[0] + ("" === o ? "" : o + "\n ") + " " + i.join(",\n  ") + " " + s[1] : s[0] + o + " " + i.join(", ") + " " + s[1]
    }
    ...
    function p(e, t, r, n, i, o) {
        ...
        if ((u = Object.getOwnPropertyDescriptor(t, i) || {
                value: t[i]
            }).get ? a = u.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : u.set && (a = e.stylize("[Setter]", "special")), P(n, i) || (s = "[" + i + "]"), !a && (0 > e.seen.indexOf(u.value) ? (a = b(r) ? h(e, u.value, null) : h(e, u.value, r - 1)).indexOf("\n") > -1 && (a = o ? a.split("\n").map(function(e) {
                return "  " + e
            }).join("\n").slice(2) : "\n" + a.split("\n").map(function(e) {
                return "   " + e
    ...
    r.debuglog = function(e) {
        ...
        date: "magenta",
        regexp: "red"
    }, r.types = e.r(20992), r.isArray = g, r.isBoolean = y, r.isNull = b, r.isNullOrUndefined = function(e) {
        return null == e
    }, r.isNumber = m, r.isString = w, r.isSymbol = function(e) {
        return "symbol" == typeof e
    }, r.isUndefined = k, r.isRegExp = S, r.types.isRegExp = S, r.isObject = v, r.isDate = _, r.types.isDate = _, r.isError = E, r.types.isNativeError = E, r.isFunction = I, r.isPrimitive = function(e) {
    ...
    r.log = function() {
        var e, t;
        console.log("%s - %s", (t = [x((e = new Date).getHours()), x(e.getMinutes()), x(e.getSeconds())].join(":"), [e.getDate(), R[e.getMonth()], t].join(" ")), r.format.apply(r, arguments))
    }, r.inherits = e.r(988935), r._extend = function(e, t) {
        if (!t || !v(t)) return e;
    ...
    }, r.promisify.custom = B, r.callbackify = function(e) {
        if ("function" != typeof e) throw TypeError('The "original" argument must be of type Function');
        ...
        i = {
            ...
            646: function(e) {
                ...
                r("ERR_INVALID_OPT_VALUE", function(e, t) {
                    ...
                    var i, o, s, a;
                    let u, c;
                    if ("string" == typeof t && (i = "not ", t.substr(0, i.length) === i) ? (u = "must not be", t = t.replace(/^not /, "")) : u = "must be", o = " argument", (void 0 === s || s > e.length) && (s = e.length), e.substring(s - o.length, s) === o) c = `The ${e} ${u} ${n(t,"type")}`;
                    else {
            ...
            709: function(t, r, i) {
                ...
                function A(e) {
                    ...
                    this._readableState = new I(e, this, t), this.readable = !0, e && ("function" == typeof e.read && (this._read = e.read), "function" == typeof e.destroy && (this._destroy = e.destroy)), d.call(this)
                }

                function x(e, t, r, n, i) {
                    s("readableAddChunk", t);
                    var o, a, u = e._readableState;
                    if (null === t) u.reading = !1,
                        function(e, t) {
                            if (s("onEofChunk"), !t.ended) {
                                ...
                                t.ended = !0, t.sync ? B(e) : (t.needReadable = !1, t.emittedReadable || (t.emittedReadable = !0, T(e)))
                            }
                        }(e, u);
                    else if (i || (a = function(e, t) {
                            var r;
                            return h.isBuffer(t) || t instanceof f || "string" == typeof t || void 0 === t || e.objectMode || (r = new w("chunk", ["string", "Buffer", "Uint8Array"], t)), r
                        }(u, t)), a) _(e, a);
                    else if (u.objectMode || t && t.length > 0)
                        if ("string" == typeof t || u.objectMode || Object.getPrototypeOf(t) === h.prototype || (o = t, t = h.from(o)), n) u.endEmitted ? _(e, new v) : R(e, u, t, !0);
                        else if (u.ended) _(e, new k);
                    else {
                        if (u.destroyed) return !1;
                        u.reading = !1, u.decoder && !r ? (t = u.decoder.write(t), u.objectMode || 0 !== t.length ? R(e, u, t, !1) : O(e, u)) : R(e, u, t, !1)
                ...
                function P(e, t) {
                    ...
                    return (e > t.highWaterMark && ((r = e) >= 0x40000000 ? r = 0x40000000 : (r--, r |= r >>> 1, r |= r >>> 2, r |= r >>> 4, r |= r >>> 8, r |= r >>> 16, r++), t.highWaterMark = r), e <= t.length) ? e : t.ended ? t.length : (t.needReadable = !0, 0)
                }

                function B(e) {
                    var t = e._readableState;
                    s("emitReadable", t.needReadable, t.emittedReadable), t.needReadable = !1, t.emittedReadable || (s("emitReadable", t.flowing), t.emittedReadable = !0, n.default.nextTick(T, e))
                }

                function T(e) {
                    var t = e._readableState;
                    s("emitReadable_", t.destroyed, t.length, t.ended), !t.destroyed && (t.length || t.ended) && (e.emit("readable"), t.emittedReadable = !1), t.needReadable = !t.flowing && !t.ended && t.length <= t.highWaterMark, M(e)
                }

                function O(e, t) {
                    t.readingMore || (t.readingMore = !0, n.default.nextTick(C, e, t))
                }
                ...
                function U(e, t) {
                    s("resume", t.reading), t.reading || e.read(0), t.resumeScheduled = !1, e.emit("resume"), M(e), t.flowing && !t.reading && e.read(0)
                }
                ...
                function W(e) {
                    var t = e._readableState;
                    s("endReadable", t.endEmitted), t.endEmitted || (t.ended = !0, n.default.nextTick(j, t, e))
                }
                ...
                Object.defineProperty(A.prototype, "destroyed", {
                    ...
                    return n.objectMode ? r = !0 : "string" == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = h.from(e, t), t = ""), r = !0), x(this, e, t, !1, r)
                    ...
                    var t, r = this._readableState,
                        n = e;
                    if (0 !== e && (r.emittedReadable = !1), 0 === e && r.needReadable && ((0 !== r.highWaterMark ? r.length >= r.highWaterMark : r.length > 0) || r.ended)) return s("read: emitReadable", r.length, r.ended), 0 === r.length && r.ended ? W(this) : B(this), null;
                    if (0 === (e = P(e, r)) && r.ended) return 0 === r.length && W(this), null;
                    var i = r.needReadable;
                    return s("need readable", i), (0 === r.length || r.length - e < r.highWaterMark) && s("length less than watermark", i = !0), r.ended || r.reading ? s("reading or ended", i = !1) : i && (s("do read"), r.reading = !0, r.sync = !0, 0 === r.length && (r.needReadable = !0), this._read(r.highWaterMark), r.sync = !1, r.reading || (e = P(n, r))), null === (t = e > 0 ? z(e, r) : null) ? (r.needReadable = r.length <= r.highWaterMark, e = 0) : (r.length -= e, r.awaitDrain = 0), 0 === r.length && (r.ended || (r.needReadable = !0), n !== e && r.ended && W(this)), null !== t && this.emit("data", t), t
                    ...
                    var a = t && !1 === t.end || e === n.default.stdout || e === n.default.stderr ? y : u;

                    function u() {
                        s("onend"), e.end()
                    }
                    o.endEmitted ? n.default.nextTick(a) : i.once("end", a), e.on("unpipe", function t(r, n) {
                        s("onunpipe"), r === i && n && !1 === n.hasUnpiped && (n.hasUnpiped = !0, s("cleanup"), e.removeListener("close", p), e.removeListener("finish", g), e.removeListener("drain", c), e.removeListener("error", f), e.removeListener("unpipe", t), i.removeListener("end", u), i.removeListener("end", y), i.removeListener("data", h), d = !0, o.awaitDrain && (!e._writableState || e._writableState.needDrain) && c())
                    });
                    var c = (r = i, function() {
                        var e = r._readableState;
                        s("pipeOnDrain", e.awaitDrain), e.awaitDrain && e.awaitDrain--, 0 === e.awaitDrain && l(r, "data") && (e.flowing = !0, M(r))
                    });
                    e.on("drain", c);
                    var d = !1;
                    ...
                    function h(t) {
                        s("ondata");
                        var r = e.write(t);
                        s("dest.write", r), !1 === r && ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== D(o.pipes, e)) && !d && (s("false write response, pause", o.awaitDrain), o.awaitDrain++), i.pause())
                    }

                    function f(t) {
                        s("onerror", t), y(), e.removeListener("error", f), 0 === l(e, "error") && _(e, t)
                    }
                    ...
                    }(e, "error", f), e.once("close", p), e.once("finish", g), e.emit("pipe", i), o.flowing || (s("pipe resume"), i.resume()), e
                    ...
                    return "data" === e ? (i.readableListening = this.listenerCount("readable") > 0, !1 !== i.flowing && this.resume()) : "readable" !== e || i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, s("on readable", i.length, i.reading), i.length ? B(this) : i.reading || n.default.nextTick(N, this)), r
                    ...
                    return ("readable" === e || void 0 === e) && n.default.nextTick(L, this), t
                }, A.prototype.resume = function() {
                    var e, t, r = this._readableState;
                    return r.flowing || (s("resume"), r.flowing = !r.readableListening, e = this, (t = r).resumeScheduled || (t.resumeScheduled = !0, n.default.nextTick(U, e, t))), r.paused = !1, this
                ...
                }), A._fromList = z, Object.defineProperty(A.prototype, "readableLength", {
                    enumerable: !1,
                    get: function() {
            ...
            337: function(t, r, i) {
                ...
                function I(e, t, r) {
                    s = s || i(403), e = e || {}, "boolean" != typeof r && (r = t instanceof s), this.objectMode = !!e.objectMode, r && (this.objectMode = this.objectMode || !!e.writableObjectMode), this.highWaterMark = f(this, e, "writableHighWaterMark", r), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                    ...
                    this.decodeStrings = !a, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
                        ! function(e, t) {
                            ...
                            if (r.writing = !1, r.writecb = null, r.length -= r.writelen, r.writelen = 0, t) --r.pendingcb, i ? (n.default.nextTick(o, t), n.default.nextTick(O, e, r), e._writableState.errorEmitted = !0, _(e, t)) : (o(t), e._writableState.errorEmitted = !0, _(e, t), O(e, r));
                            else {
                                var s = B(r) || e.destroyed;
                                s || r.corked || r.bufferProcessing || !r.bufferedRequest || P(e, r), i ? n.default.nextTick(R, e, r, s, o) : R(e, r, s, o)
                            }
                        }(t, e)
                ...
                i(782)(A, c), I.prototype.getBuffer = function() {
                ...
                function R(e, t, r, n) {
                    var i, o;
                    r || (i = e, 0 === (o = t).length && o.needDrain && (o.needDrain = !1, i.emit("drain"))), t.pendingcb--, n(), O(e, t)
                }
                ...
                function P(e, t) {
                    ...
                    if (e._writev && r && r.next) {
                        ...
                        n.allBuffers = a, x(e, t, !0, t.length, n, "", i.finish), t.pendingcb++, t.lastBufferedRequest = null, i.next ? (t.corkedRequestsFree = i.next, i.next = null) : t.corkedRequestsFree = new o(t), t.bufferedRequestCount = 0
                    } else {
                        for (; r;) {
                            var u = r.chunk,
                                c = r.encoding,
                            ...
                            if (x(e, t, !1, d, u, c, l), r = r.next, t.bufferedRequestCount--, t.writing) break
                        }
                ...
                function O(e, t) {
                    var r = B(t);
                    if (r && (t.prefinished || t.finalCalled || ("function" != typeof e._final || t.destroyed ? (t.prefinished = !0, e.emit("prefinish")) : (t.pendingcb++, t.finalCalled = !0, n.default.nextTick(T, e, t))), 0 === t.pendingcb && (t.finished = !0, e.emit("finish"), t.autoDestroy))) {
                ...
                "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (a = Function.prototype[Symbol.hasInstance], Object.defineProperty(A, Symbol.hasInstance, {
                    value: function(e) {
                        return !!a.call(this, e) || this === A && e && e._writableState instanceof I
                    }
                })) : a = function(e) {
                    ...
                    var i, o, s, a, u, c, h, f = this._writableState,
                        p = !1,
                        y = !f.objectMode && (i = e, l.isBuffer(i) || i instanceof d);
                    return (y && !l.isBuffer(e) && (o = e, e = l.from(o)), "function" == typeof t && (r = t, t = null), y ? t = "buffer" : t || (t = f.defaultEncoding), "function" != typeof r && (r = E), f.ending) ? (s = r, _(this, a = new S), n.default.nextTick(s, a)) : (y || (u = e, c = r, null === u ? h = new k : "string" == typeof u || f.objectMode || (h = new g("chunk", ["string", "Buffer"], u)), !h || (_(this, h), n.default.nextTick(c, h), 0))) && (f.pendingcb++, p = function(e, t, r, n, i, o) {
                        if (!r) {
                    ...
                    var i, o, s, a = this._writableState;
                    return "function" == typeof e ? (r = e, e = null, t = null) : "function" == typeof t && (r = t, t = null), null != e && this.write(e, t), a.corked && (a.corked = 1, this.uncork()), a.ending || (i = this, o = a, s = r, o.ending = !0, O(i, o), s && (o.finished ? n.default.nextTick(s) : i.once("finish", s)), o.ended = !0, i.writable = !1), this
            ...
            871: function(e, t, r) {
                ...
                function g(e) {
                    ...
                    if (null !== t) {
                        var r = e[f].read();
                        null !== r && (e[d] = null, e[a] = null, e[u] = null, t(p(r, !1)))
                    }
                }
                ...
                e.exports = function(e) {
                    var t, r = Object.create(m, (i(t = {}, f, {
                        ...
                        value: function(e, t) {
                            var n = r[f].read();
                            n ? (r[d] = null, r[a] = null, r[u] = null, e(p(n, !1))) : (r[a] = e, r[u] = t)
                        },
                        writable: !0
                    }), t));
                    return r[d] = null, s(e, function(e) {
                        if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                            var t = r[u];
                            null !== t && (r[d] = null, r[a] = null, r[u] = null, t(e)), r[c] = e;
                            return
                        }
                        var n = r[a];
                        null !== n && (r[d] = null, r[a] = null, r[u] = null, n(p(void 0, !0))), r[l] = !0
                ...
                e.exports = function() {
                    ...
                    return e = [{
                            ...
                            value: function(e) {
                                ...
                                for (var t, r, n = i.allocUnsafe(e >>> 0), o = this.head, s = 0; o;) t = o.data, r = s, i.prototype.copy.call(t, n, r), s += o.data.length, o = o.next;
                                return n
                            }
                        }, {
                            key: "consume",
            ...
            25: function(e) {
                ...
                e.exports = {
                    destroy: function(e, o) {
                        ...
                        return a || u ? o ? o(e) : e && (this._writableState ? this._writableState.errorEmitted || (this._writableState.errorEmitted = !0, n.default.nextTick(i, this, e)) : n.default.nextTick(i, this, e)) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(e || null, function(e) {
                            !o && e ? s._writableState ? s._writableState.errorEmitted ? n.default.nextTick(r, s) : (s._writableState.errorEmitted = !0, n.default.nextTick(t, s, e)) : n.default.nextTick(t, s, e) : o ? (n.default.nextTick(r, s), o(e)) : n.default.nextTick(r, s)
                        })), this
                    },
                    undestroy: function() {
            ...
            698: function(e, t, r) {
                ...
                e.exports = function e(t, r, o) {
                    ...
                    var s, a, u = r.readable || !1 !== r.readable && t.readable,
                        ...
                        y = function() {
                            var e;
                            return u && !f ? (t._readableState && t._readableState.ended || (e = new n), o.call(t, e)) : c && !d ? (t._writableState && t._writableState.ended || (e = new n), o.call(t, e)) : void 0
                        },
                        b = function() {
                            t.req.on("finish", h)
                        };
                    return t.setHeader && "function" == typeof t.abort ? (t.on("complete", h), t.on("abort", y), t.req ? b() : t.on("request", b)) : c && !t._writableState && (t.on("end", l), t.on("close", l)), t.on("end", p), t.on("finish", h), !1 !== r.error && t.on("error", g), t.on("close", y),
                        function() {
                            t.removeListener("complete", h), t.removeListener("abort", y), t.removeListener("request", b), t.req && t.req.removeListener("finish", h), t.removeListener("end", l), t.removeListener("close", l), t.removeListener("finish", h), t.removeListener("end", p), t.removeListener("error", g), t.removeListener("close", y)
                        }
                }
            },
            727: function(e, t, r) {
            ...
            442: function(e, t, r) {
                ...
                e.exports = function() {
                    ...
                    var h = (e = l).length && "function" == typeof e[e.length - 1] ? e.pop() : a;
                    if (Array.isArray(l[0]) && (l = l[0]), l.length < 2) throw new o("streams");
                    var f = l.map(function(e, i) {
                        var o, a, c, d, p, g, y = i < l.length - 1;
                        return o = i > 0, c = a = function(e) {
            ...
            173: function(e, t, r) {
                ...
                r(782)(i, n), i.Readable = r(709), i.Writable = r(337), i.Duplex = r(403), i.Transform = r(170), i.PassThrough = r(889), i.finished = r(698), i.pipeline = r(442), i.Stream = i, i.prototype.pipe = function(e, t) {
                    ...
                    function l() {
                        r.removeListener("data", i), e.removeListener("drain", o), r.removeListener("end", a), r.removeListener("close", u), r.removeListener("error", c), e.removeListener("error", c), r.removeListener("end", l), r.removeListener("close", l), e.removeListener("close", l)
                    }
    ...
    s.ab = "/ROOT/node_modules/next/dist/compiled/stream-browserify/", t.exports = s(173)
}]);